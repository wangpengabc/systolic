...
#ifndef VERILATED_VLFSRRESETTESTER_H_
#define VERILATED_VLFSRRESETTESTER_H_  // guard
...
class VLFSRResetTester_VerilatedVcd;
...
VL_MODULE(VLFSRResetTester) {
  public:
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(VLFSRResetTester);  ///< Copying not allowed
  public:
    /// Construct the model; called by application code
    /// If contextp is null, then the model will use the default global context
    /// If name is "", then makes a wrapper with a
    /// single model invisible with respect to DPI scope names.
    VLFSRResetTester(VerilatedContext* contextp, const char* name = "TOP");
    VLFSRResetTester(const char* name = "TOP")
      : VLFSRResetTester(nullptr, name) {}
  ...
  private:
    ...
    static QData _change_request_1(VLFSRResetTester__Syms* __restrict vlSymsp);
    static void _ctor_var_reset(VLFSRResetTester* self) VL_ATTR_COLD;
  public:
...
#endif  // VL_DEBUG
  public:
    static void _eval_initial(VLFSRResetTester__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _eval_settle(VLFSRResetTester__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _sequent__TOP__1(VLFSRResetTester__Syms* __restrict vlSymsp);
    static void _settle__TOP__2(VLFSRResetTester__Syms* __restrict vlSymsp) VL_ATTR_COLD;
  private:
