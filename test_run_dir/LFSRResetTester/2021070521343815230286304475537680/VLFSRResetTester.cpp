...
void VLFSRResetTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/LFSRResetTester/2021070521343815230286304475537680/LFSRResetTester.v", 62, "",
...
VL_INLINE_OPT void VLFSRResetTester::_sequent__TOP__1(VLFSRResetTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((2U == (IData)(vlTOPp->LFSRResetTester__DOT__count)) 
                         & (~ ((~ (IData)(vlTOPp->LFSRResetTester__DOT__lfsr__DOT__state_0)) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: LFSRResetTester.v:113: Assertion failed in %NLFSRResetTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/LFSRResetTester/2021070521343815230286304475537680/LFSRResetTester.v", 113, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((4U == (IData)(vlTOPp->LFSRResetTester__DOT__count)) 
                         & (~ ((IData)(vlTOPp->LFSRResetTester__DOT__lfsr__DOT__state_0) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: LFSRResetTester.v:137: Assertion failed in %NLFSRResetTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/LFSRResetTester/2021070521343815230286304475537680/LFSRResetTester.v", 137, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((4U == (IData)(vlTOPp->LFSRResetTester__DOT__count)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/LFSRResetTester/2021070521343815230286304475537680/LFSRResetTester.v", 148, "");
        }
    }
