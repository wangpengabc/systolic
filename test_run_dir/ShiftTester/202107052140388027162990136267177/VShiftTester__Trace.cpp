...
void VShiftTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgBit(oldp+1,((3U == (IData)(vlTOPp->ShiftTester__DOT__cntVal))));
            tracep->chgCData(oldp+2,(vlTOPp->ShiftTester__DOT__sr_r),5);
            tracep->chgCData(oldp+3,(vlTOPp->ShiftTester__DOT__sr_r_1),5);
            tracep->chgCData(oldp+4,(vlTOPp->ShiftTester__DOT__sr_r_2),5);
            tracep->chgCData(oldp+5,(vlTOPp->ShiftTester__DOT__sr),5);
        }
