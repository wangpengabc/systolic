...
void VShiftTester::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+7,"ShiftTester clock", false,-1);
        tracep->declBit(c+8,"ShiftTester reset", false,-1);
        ...
        tracep->declBus(c+5,"ShiftTester sr_r_2", false,-1, 4,0);
        tracep->declBus(c+6,"ShiftTester sr", false,-1, 4,0);
    }
}
...
void VShiftTester::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+2,((3U == (IData)(vlTOPp->ShiftTester__DOT__cntVal))));
        tracep->fullCData(oldp+3,(vlTOPp->ShiftTester__DOT__sr_r),5);
        tracep->fullCData(oldp+4,(vlTOPp->ShiftTester__DOT__sr_r_1),5);
        tracep->fullCData(oldp+5,(vlTOPp->ShiftTester__DOT__sr_r_2),5);
        tracep->fullCData(oldp+6,(vlTOPp->ShiftTester__DOT__sr),5);
