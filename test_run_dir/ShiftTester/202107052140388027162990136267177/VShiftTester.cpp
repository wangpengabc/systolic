...
void VShiftTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftTester/202107052140388027162990136267177/ShiftTester.v", 1, "",
...
VL_INLINE_OPT void VShiftTester::_sequent__TOP__1(VShiftTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((3U == (IData)(vlTOPp->ShiftTester__DOT__cntVal)) 
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((3U == (IData)(vlTOPp->ShiftTester__DOT__cntVal)) 
                         & (~ ((0x17U == (IData)(vlTOPp->ShiftTester__DOT__sr)) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: ShiftTester.v:46: Assertion failed in %NShiftTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftTester/202107052140388027162990136267177/ShiftTester.v", 46, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((3U == (IData)(vlTOPp->ShiftTester__DOT__cntVal)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftTester/202107052140388027162990136267177/ShiftTester.v", 57, "");
        }
    }
    vlTOPp->ShiftTester__DOT__sr = vlTOPp->ShiftTester__DOT__sr_r_2;
    vlTOPp->ShiftTester__DOT__sr_r_2 = vlTOPp->ShiftTester__DOT__sr_r_1;
    ...
    vlTOPp->ShiftTester__DOT__cntVal = ((IData)(vlTOPp->reset)
                                         ? 0U : (IData)(vlTOPp->ShiftTester__DOT___wrap_value_T_1));
