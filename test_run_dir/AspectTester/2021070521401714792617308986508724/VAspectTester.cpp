...
void VAspectTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/AspectTester/2021070521401714792617308986508724/AspectTester.v", 1, "",
...
VL_INLINE_OPT void VAspectTester::_sequent__TOP__1(VAspectTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((3U <= (IData)(vlTOPp->AspectTester__DOT__counter)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/AspectTester/2021070521401714792617308986508724/AspectTester.v", 26, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((((3U > (IData)(vlTOPp->AspectTester__DOT__counter)) 
                         ...
                         & (~ (((IData)(vlTOPp->AspectTester__DOT__counter) 
                                == ((2U == (3U & (IData)(vlTOPp->AspectTester__DOT__counter)))
                                     ? 3U : ((1U == 
                                              (3U & (IData)(vlTOPp->AspectTester__DOT__counter)))
                                              ? 2U : 1U))) 
                               | (IData)(vlTOPp->reset)))))) {
                         ...
                         & (~ (((IData)(vlTOPp->AspectTester__DOT__counter) 
                                == ((2U == (3U & (IData)(vlTOPp->AspectTester__DOT__counter)))
                                     ? 3U : ((1U == 
                                              ...
                                              ? 2U : 1U))) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: AspectTester.v:48: Assertion failed in %NAspectTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/AspectTester/2021070521401714792617308986508724/AspectTester.v", 48, "");
        }
    }
