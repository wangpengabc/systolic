...
void VAspectTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/AspectTester/202107052140152731000140980210252/AspectTester.v", 1, "",
...
VL_INLINE_OPT void VAspectTester::_sequent__TOP__1(VAspectTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((3U <= (IData)(vlTOPp->AspectTester__DOT__counter)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/AspectTester/202107052140152731000140980210252/AspectTester.v", 26, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((((3U > (IData)(vlTOPp->AspectTester__DOT__counter)) 
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((((3U > (IData)(vlTOPp->AspectTester__DOT__counter)) 
            ...
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/AspectTester/202107052140152731000140980210252/AspectTester.v", 48, "");
        }
    }
