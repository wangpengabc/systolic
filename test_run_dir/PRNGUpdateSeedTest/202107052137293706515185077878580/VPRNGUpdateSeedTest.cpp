...
void VPRNGUpdateSeedTest::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/PRNGUpdateSeedTest/202107052137293706515185077878580/PRNGUpdateSeedTest.v", 255, "",
...
VL_INLINE_OPT void VPRNGUpdateSeedTest::_sequent__TOP__1(VPRNGUpdateSeedTest__Syms* __restrict vlSymsp) {
    ...
    VPRNGUpdateSeedTest* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    CData/*0:0*/ __Vdly__PRNGUpdateSeedTest__DOT__a__DOT__state_4;
    // Body
    __Vdly__PRNGUpdateSeedTest__DOT__a__DOT__state_4 
        = vlTOPp->PRNGUpdateSeedTest__DOT__a__DOT__state_4;
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((3U == (IData)(vlTOPp->PRNGUpdateSeedTest__DOT__count)) 
                         & (~ ((6U == (((IData)(vlTOPp->PRNGUpdateSeedTest__DOT__a__DOT__state_15) 
                                        << 0xfU) | 
                                                                    ...
                                                                    | (((IData)(vlTOPp->PRNGUpdateSeedTest__DOT__a__DOT__state_3) 
                                                                       ...
                                                                       | (((IData)(vlTOPp->PRNGUpdateSeedTest__DOT__a__DOT__state_2) 
                                                                          ...
                                                                          | (((IData)(vlTOPp->PRNGUpdateSeedTest__DOT__a__DOT__state_1) 
                                                                             ...
                                                                             | (IData)(vlTOPp->PRNGUpdateSeedTest__DOT__a__DOT__state_0))))))))))))))))) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: PRNGUpdateSeedTest.v:334: Assertion failed in %NPRNGUpdateSeedTest\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/PRNGUpdateSeedTest/202107052137293706515185077878580/PRNGUpdateSeedTest.v", 334, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((3U == (IData)(vlTOPp->PRNGUpdateSeedTest__DOT__count)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/PRNGUpdateSeedTest/202107052137293706515185077878580/PRNGUpdateSeedTest.v", 345, "");
        }
    }
    __Vdly__PRNGUpdateSeedTest__DOT__a__DOT__state_4 
