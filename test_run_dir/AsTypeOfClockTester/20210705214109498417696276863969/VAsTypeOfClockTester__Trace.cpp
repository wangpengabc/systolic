...
void VAsTypeOfClockTester::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VAsTypeOfClockTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VAsTypeOfClockTester__Syms* __restrict vlSymsp = static_cast<VAsTypeOfClockTester__Syms*>(userp);
    VAsTypeOfClockTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VAsTypeOfClockTester::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VAsTypeOfClockTester__Syms* __restrict vlSymsp = static_cast<VAsTypeOfClockTester__Syms*>(userp);
    VAsTypeOfClockTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
