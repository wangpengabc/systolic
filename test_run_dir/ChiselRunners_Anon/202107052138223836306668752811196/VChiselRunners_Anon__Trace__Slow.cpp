...
void VChiselRunners_Anon::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+3,"ChiselRunners_Anon x", false,-1, 3,0);
        tracep->declBit(c+4,"ChiselRunners_Anon done_value", false,-1);
    }
}
...
void VChiselRunners_Anon::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+3,(vlTOPp->ChiselRunners_Anon__DOT__x),4);
        tracep->fullBit(oldp+4,(vlTOPp->ChiselRunners_Anon__DOT__done_value));
    }
}
