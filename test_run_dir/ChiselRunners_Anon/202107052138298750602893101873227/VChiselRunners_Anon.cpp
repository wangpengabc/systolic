...
void VChiselRunners_Anon::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/ChiselRunners_Anon/202107052138298750602893101873227/ChiselRunners_Anon.v", 1, "",
...
VL_INLINE_OPT void VChiselRunners_Anon::_sequent__TOP__1(VChiselRunners_Anon__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ChiselRunners_Anon__DOT__done_value) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/ChiselRunners_Anon/202107052138298750602893101873227/ChiselRunners_Anon.v", 21, "");
        }
    }
