...
void VAsTypeOfTruncationTester::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VAsTypeOfTruncationTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VAsTypeOfTruncationTester__Syms* __restrict vlSymsp = static_cast<VAsTypeOfTruncationTester__Syms*>(userp);
    VAsTypeOfTruncationTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VAsTypeOfTruncationTester::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VAsTypeOfTruncationTester__Syms* __restrict vlSymsp = static_cast<VAsTypeOfTruncationTester__Syms*>(userp);
    VAsTypeOfTruncationTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
