...
VMixedVecUIntDynamicIndexTester__Syms::VMixedVecUIntDynamicIndexTester__Syms(VerilatedContext* contextp, VMixedVecUIntDynamicIndexTester* topp, const char* namep)
    // Setup locals
