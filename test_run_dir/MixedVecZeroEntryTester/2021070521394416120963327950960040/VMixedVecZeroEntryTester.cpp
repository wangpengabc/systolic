...
VerilatedContext* VMixedVecZeroEntryTester::contextp() {
...
void VMixedVecZeroEntryTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/MixedVecZeroEntryTester/2021070521394416120963327950960040/MixedVecZeroEntryTester.v", 1, "",
...
VL_INLINE_OPT void VMixedVecZeroEntryTester::_sequent__TOP__1(VMixedVecZeroEntryTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/MixedVecZeroEntryTester/2021070521394416120963327950960040/MixedVecZeroEntryTester.v", 11, "");
        }
    }
}
...
VL_INLINE_OPT QData VMixedVecZeroEntryTester::_change_request_1(VMixedVecZeroEntryTester__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMixedVecZeroEntryTester::_change_request_1\n"); );
    VMixedVecZeroEntryTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
