...
void VIntervalSetBinaryPointTester::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VIntervalSetBinaryPointTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VIntervalSetBinaryPointTester__Syms* __restrict vlSymsp = static_cast<VIntervalSetBinaryPointTester__Syms*>(userp);
    VIntervalSetBinaryPointTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VIntervalSetBinaryPointTester::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VIntervalSetBinaryPointTester__Syms* __restrict vlSymsp = static_cast<VIntervalSetBinaryPointTester__Syms*>(userp);
    VIntervalSetBinaryPointTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
