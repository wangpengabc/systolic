...
VerilatedContext* VRecordSerializationTest::contextp() {
...
void VRecordSerializationTest::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/RecordSerializationTest/202107052144391310502701652531797/RecordSerializationTest.v", 1, "",
...
VL_INLINE_OPT void VRecordSerializationTest::_sequent__TOP__1(VRecordSerializationTest__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/RecordSerializationTest/202107052144391310502701652531797/RecordSerializationTest.v", 11, "");
        }
    }
}
...
VL_INLINE_OPT QData VRecordSerializationTest::_change_request_1(VRecordSerializationTest__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VRecordSerializationTest::_change_request_1\n"); );
    VRecordSerializationTest* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
