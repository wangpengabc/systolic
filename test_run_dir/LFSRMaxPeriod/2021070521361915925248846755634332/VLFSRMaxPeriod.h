...
VL_MODULE(VLFSRMaxPeriod) {
  public:
    ...
    CData/*6:0*/ LFSRMaxPeriod__DOT__rv;
    CData/*0:0*/ LFSRMaxPeriod__DOT__started;
    CData/*6:0*/ LFSRMaxPeriod__DOT__seed;
    CData/*6:0*/ LFSRMaxPeriod__DOT__wrap_value;
    CData/*0:0*/ LFSRMaxPeriod__DOT__wrap_wrap_wrap;
    CData/*6:0*/ LFSRMaxPeriod__DOT___wrap_wrap_value_T_1;
    CData/*6:0*/ LFSRMaxPeriod__DOT__last;
