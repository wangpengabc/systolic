...
void VLFSRMaxPeriod::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+9,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_3) 
            ...
            tracep->chgCData(oldp+10,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_8) 
            ...
            tracep->chgSData(oldp+11,(vlTOPp->LFSRMaxPeriod__DOT__rv),9);
            tracep->chgBit(oldp+12,(vlTOPp->LFSRMaxPeriod__DOT__started));
            tracep->chgSData(oldp+13,(vlTOPp->LFSRMaxPeriod__DOT__seed),9);
            tracep->chgSData(oldp+14,(vlTOPp->LFSRMaxPeriod__DOT__wrap_value),9);
            tracep->chgBit(oldp+15,((0x1feU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value))));
            tracep->chgBit(oldp+16,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
                                     & (0x1feU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value)))));
            tracep->chgSData(oldp+17,(vlTOPp->LFSRMaxPeriod__DOT__last),9);
        }
        tracep->chgBit(oldp+18,(vlTOPp->clock));
