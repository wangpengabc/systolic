...
void VLFSRMaxPeriod::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+13,(vlTOPp->LFSRMaxPeriod__DOT__rv_lo),6);
            tracep->chgCData(oldp+14,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_12) 
            ...
            tracep->chgSData(oldp+15,(vlTOPp->LFSRMaxPeriod__DOT__rv),13);
            tracep->chgBit(oldp+16,(vlTOPp->LFSRMaxPeriod__DOT__started));
            tracep->chgSData(oldp+17,(vlTOPp->LFSRMaxPeriod__DOT__seed),13);
            tracep->chgSData(oldp+18,(vlTOPp->LFSRMaxPeriod__DOT__wrap_value),13);
            tracep->chgBit(oldp+19,((0x1ffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value))));
            tracep->chgBit(oldp+20,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
                                     & (0x1ffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value)))));
            tracep->chgSData(oldp+21,(vlTOPp->LFSRMaxPeriod__DOT__last),13);
        }
