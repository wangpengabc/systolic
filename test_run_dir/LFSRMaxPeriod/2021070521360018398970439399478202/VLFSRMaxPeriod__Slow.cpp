...
void VLFSRMaxPeriod::_ctor_var_reset(VLFSRMaxPeriod* self) {
    ...
    self->LFSRMaxPeriod__DOT__rv_lo = VL_RAND_RESET_I(7);
    self->LFSRMaxPeriod__DOT__rv = VL_RAND_RESET_I(15);
    self->LFSRMaxPeriod__DOT__started = VL_RAND_RESET_I(1);
    self->LFSRMaxPeriod__DOT__seed = VL_RAND_RESET_I(15);
    self->LFSRMaxPeriod__DOT__wrap_value = VL_RAND_RESET_I(15);
    self->LFSRMaxPeriod__DOT__wrap_wrap_wrap = VL_RAND_RESET_I(1);
    self->LFSRMaxPeriod__DOT___wrap_wrap_value_T_1 = VL_RAND_RESET_I(15);
    self->LFSRMaxPeriod__DOT__last = VL_RAND_RESET_I(15);
