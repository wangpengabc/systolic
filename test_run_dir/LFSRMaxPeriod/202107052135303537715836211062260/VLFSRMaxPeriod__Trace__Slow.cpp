...
void VLFSRMaxPeriod::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+15,"LFSRMaxPeriod clock", false,-1);
        tracep->declBit(c+16,"LFSRMaxPeriod reset", false,-1);
        tracep->declBit(c+15,"LFSRMaxPeriod rv_prng_clock", false,-1);
        tracep->declBit(c+16,"LFSRMaxPeriod rv_prng_reset", false,-1);
        ...
        tracep->declBus(c+6,"LFSRMaxPeriod rv_lo", false,-1, 1,0);
        tracep->declBus(c+7,"LFSRMaxPeriod rv_hi", false,-1, 2,0);
        tracep->declBus(c+8,"LFSRMaxPeriod rv", false,-1, 4,0);
        tracep->declBit(c+9,"LFSRMaxPeriod started", false,-1);
        tracep->declBus(c+10,"LFSRMaxPeriod seed", false,-1, 4,0);
        tracep->declBus(c+11,"LFSRMaxPeriod wrap_value", false,-1, 4,0);
        tracep->declBit(c+12,"LFSRMaxPeriod wrap_wrap_wrap", false,-1);
        tracep->declBit(c+13,"LFSRMaxPeriod wrap", false,-1);
        tracep->declBus(c+14,"LFSRMaxPeriod last", false,-1, 4,0);
        tracep->declBit(c+15,"LFSRMaxPeriod rv_prng clock", false,-1);
        tracep->declBit(c+16,"LFSRMaxPeriod rv_prng reset", false,-1);
...
void VLFSRMaxPeriod::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+6,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_1) 
                                    << 1U) | (IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_0))),2);
        tracep->fullCData(oldp+7,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_4) 
                                    << 2U) | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_3) 
                                               << 1U) 
                                              | (IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_2)))),3);
        tracep->fullCData(oldp+8,(vlTOPp->LFSRMaxPeriod__DOT__rv),5);
        tracep->fullBit(oldp+9,(vlTOPp->LFSRMaxPeriod__DOT__started));
        tracep->fullCData(oldp+10,(vlTOPp->LFSRMaxPeriod__DOT__seed),5);
        tracep->fullCData(oldp+11,(vlTOPp->LFSRMaxPeriod__DOT__wrap_value),5);
        tracep->fullBit(oldp+12,((0x1eU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value))));
        tracep->fullBit(oldp+13,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
                                  & (0x1eU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value)))));
        tracep->fullCData(oldp+14,(vlTOPp->LFSRMaxPeriod__DOT__last),5);
        tracep->fullBit(oldp+15,(vlTOPp->clock));
        tracep->fullBit(oldp+16,(vlTOPp->reset));
    }
}
