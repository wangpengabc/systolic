...
void VLFSRMaxPeriod::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+22,"LFSRMaxPeriod clock", false,-1);
        tracep->declBit(c+23,"LFSRMaxPeriod reset", false,-1);
        tracep->declBit(c+22,"LFSRMaxPeriod rv_prng_clock", false,-1);
        tracep->declBit(c+23,"LFSRMaxPeriod rv_prng_reset", false,-1);
        ...
        tracep->declBus(c+13,"LFSRMaxPeriod rv_lo", false,-1, 5,0);
        tracep->declBus(c+14,"LFSRMaxPeriod rv_hi", false,-1, 5,0);
        tracep->declBus(c+15,"LFSRMaxPeriod rv", false,-1, 11,0);
        tracep->declBit(c+16,"LFSRMaxPeriod started", false,-1);
        tracep->declBus(c+17,"LFSRMaxPeriod seed", false,-1, 11,0);
        tracep->declBus(c+18,"LFSRMaxPeriod wrap_value", false,-1, 11,0);
        tracep->declBit(c+19,"LFSRMaxPeriod wrap_wrap_wrap", false,-1);
        tracep->declBit(c+20,"LFSRMaxPeriod wrap", false,-1);
        tracep->declBus(c+21,"LFSRMaxPeriod last", false,-1, 11,0);
        tracep->declBit(c+22,"LFSRMaxPeriod rv_prng clock", false,-1);
        tracep->declBit(c+23,"LFSRMaxPeriod rv_prng reset", false,-1);
...
void VLFSRMaxPeriod::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+13,(vlTOPp->LFSRMaxPeriod__DOT__rv_lo),6);
        tracep->fullCData(oldp+14,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_11) 
        ...
        tracep->fullSData(oldp+15,(vlTOPp->LFSRMaxPeriod__DOT__rv),12);
        tracep->fullBit(oldp+16,(vlTOPp->LFSRMaxPeriod__DOT__started));
        tracep->fullSData(oldp+17,(vlTOPp->LFSRMaxPeriod__DOT__seed),12);
        tracep->fullSData(oldp+18,(vlTOPp->LFSRMaxPeriod__DOT__wrap_value),12);
        tracep->fullBit(oldp+19,((0xffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value))));
        tracep->fullBit(oldp+20,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
                                  & (0xffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value)))));
        tracep->fullSData(oldp+21,(vlTOPp->LFSRMaxPeriod__DOT__last),12);
        tracep->fullBit(oldp+22,(vlTOPp->clock));
