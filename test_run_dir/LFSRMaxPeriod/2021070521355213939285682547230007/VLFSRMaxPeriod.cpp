...
void VLFSRMaxPeriod::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/LFSRMaxPeriod/2021070521355213939285682547230007/LFSRMaxPeriod.v", 184, "",
...
VL_INLINE_OPT void VLFSRMaxPeriod::_sequent__TOP__1(VLFSRMaxPeriod__Syms* __restrict vlSymsp) {
    ...
    VLFSRMaxPeriod* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    CData/*0:0*/ __Vdly__LFSRMaxPeriod__DOT__rv_prng__DOT__state_5;
    // Body
    __Vdly__LFSRMaxPeriod__DOT__rv_prng__DOT__state_5 
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
                         ...
                         & (~ (((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
                                & (0xffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value))) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:275: Assertion failed in %NLFSRMaxPeriod\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/LFSRMaxPeriod/2021070521355213939285682547230007/LFSRMaxPeriod.v", 275, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
                          ...
                          & (IData)(vlTOPp->LFSRMaxPeriod__DOT__started)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/LFSRMaxPeriod/2021070521355213939285682547230007/LFSRMaxPeriod.v", 286, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
            ...
            VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:310: Assertion failed in %NLFSRMaxPeriod\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/LFSRMaxPeriod/2021070521355213939285682547230007/LFSRMaxPeriod.v", 310, "");
        }
    }
    __Vdly__LFSRMaxPeriod__DOT__rv_prng__DOT__state_5 
        = (1U & ((~ (IData)(vlTOPp->reset)) & (~ ((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_6) 
    ...
    vlTOPp->LFSRMaxPeriod__DOT__last = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_11) 
                                         << 0xbU) | 
    ...
    vlTOPp->LFSRMaxPeriod__DOT__wrap_wrap_wrap = (0xffeU 
                                                  == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value));
    vlTOPp->LFSRMaxPeriod__DOT___wrap_wrap_value_T_1 
        = (0xfffU & ((IData)(1U) + (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value)));
    ...
    vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_7 
        = (1U & ((~ (IData)(vlTOPp->reset)) & (~ ((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_8) 
                                                  ^ (IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_0)))));
                                          ...
                                          (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_3) 
                                           ...
                                           | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_2) 
                                              ...
                                              | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_1) 
                                                  << 1U) 
                                                 | (IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_0))))));
    vlTOPp->LFSRMaxPeriod__DOT__rv = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_11) 
                                       << 0xbU) | (
                                                   ((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_10) 
                                                    << 0xaU) 
                                                   | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_9) 
