...
void VLFSRMaxPeriod::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+19,"LFSRMaxPeriod clock", false,-1);
        tracep->declBit(c+20,"LFSRMaxPeriod reset", false,-1);
        tracep->declBit(c+19,"LFSRMaxPeriod rv_prng_clock", false,-1);
        tracep->declBit(c+20,"LFSRMaxPeriod rv_prng_reset", false,-1);
        ...
        tracep->declBus(c+10,"LFSRMaxPeriod rv_lo", false,-1, 3,0);
        tracep->declBus(c+11,"LFSRMaxPeriod rv_hi", false,-1, 4,0);
        tracep->declBus(c+12,"LFSRMaxPeriod rv", false,-1, 8,0);
        tracep->declBit(c+13,"LFSRMaxPeriod started", false,-1);
        tracep->declBus(c+14,"LFSRMaxPeriod seed", false,-1, 8,0);
        tracep->declBus(c+15,"LFSRMaxPeriod wrap_value", false,-1, 8,0);
        tracep->declBit(c+16,"LFSRMaxPeriod wrap_wrap_wrap", false,-1);
        tracep->declBit(c+17,"LFSRMaxPeriod wrap", false,-1);
        tracep->declBus(c+18,"LFSRMaxPeriod last", false,-1, 8,0);
        tracep->declBit(c+19,"LFSRMaxPeriod rv_prng clock", false,-1);
        tracep->declBit(c+20,"LFSRMaxPeriod rv_prng reset", false,-1);
...
void VLFSRMaxPeriod::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+10,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_3) 
        ...
        tracep->fullCData(oldp+11,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_8) 
                                     << 4U) | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_7) 
                                                << 3U) 
                                               | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_6) 
                                                   << 2U) 
                                                  | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_5) 
                                                      << 1U) 
                                                     | (IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_4)))))),5);
        tracep->fullSData(oldp+12,(vlTOPp->LFSRMaxPeriod__DOT__rv),9);
        tracep->fullBit(oldp+13,(vlTOPp->LFSRMaxPeriod__DOT__started));
        tracep->fullSData(oldp+14,(vlTOPp->LFSRMaxPeriod__DOT__seed),9);
        tracep->fullSData(oldp+15,(vlTOPp->LFSRMaxPeriod__DOT__wrap_value),9);
        tracep->fullBit(oldp+16,((0x1feU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value))));
        tracep->fullBit(oldp+17,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
                                  & (0x1feU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value)))));
        tracep->fullSData(oldp+18,(vlTOPp->LFSRMaxPeriod__DOT__last),9);
        tracep->fullBit(oldp+19,(vlTOPp->clock));
