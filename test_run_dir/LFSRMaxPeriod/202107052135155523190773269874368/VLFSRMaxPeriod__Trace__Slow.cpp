...
void VLFSRMaxPeriod::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+24,"LFSRMaxPeriod clock", false,-1);
        tracep->declBit(c+25,"LFSRMaxPeriod reset", false,-1);
        tracep->declBit(c+24,"LFSRMaxPeriod rv_prng_clock", false,-1);
        tracep->declBit(c+25,"LFSRMaxPeriod rv_prng_reset", false,-1);
        ...
        tracep->declBus(c+15,"LFSRMaxPeriod rv_lo", false,-1, 6,0);
        tracep->declBus(c+16,"LFSRMaxPeriod rv_hi", false,-1, 6,0);
        tracep->declBus(c+17,"LFSRMaxPeriod rv", false,-1, 13,0);
        tracep->declBit(c+18,"LFSRMaxPeriod started", false,-1);
        tracep->declBus(c+19,"LFSRMaxPeriod seed", false,-1, 13,0);
        tracep->declBus(c+20,"LFSRMaxPeriod wrap_value", false,-1, 13,0);
        tracep->declBit(c+21,"LFSRMaxPeriod wrap_wrap_wrap", false,-1);
        tracep->declBit(c+22,"LFSRMaxPeriod wrap", false,-1);
        tracep->declBus(c+23,"LFSRMaxPeriod last", false,-1, 13,0);
        tracep->declBit(c+24,"LFSRMaxPeriod rv_prng clock", false,-1);
        tracep->declBit(c+25,"LFSRMaxPeriod rv_prng reset", false,-1);
...
void VLFSRMaxPeriod::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+15,(vlTOPp->LFSRMaxPeriod__DOT__rv_lo),7);
        tracep->fullCData(oldp+16,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_13) 
                                     << 6U) | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_12) 
                                                << 5U) 
                                                  ...
                                                  | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_10) 
                                                     ...
                                                     | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_9) 
                                                        ...
                                                        | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_8) 
                                                            << 1U) 
                                                           | (IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_7)))))))),7);
        tracep->fullSData(oldp+17,(vlTOPp->LFSRMaxPeriod__DOT__rv),14);
        tracep->fullBit(oldp+18,(vlTOPp->LFSRMaxPeriod__DOT__started));
        tracep->fullSData(oldp+19,(vlTOPp->LFSRMaxPeriod__DOT__seed),14);
        tracep->fullSData(oldp+20,(vlTOPp->LFSRMaxPeriod__DOT__wrap_value),14);
        tracep->fullBit(oldp+21,((0x3ffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value))));
        tracep->fullBit(oldp+22,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
                                  & (0x3ffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value)))));
        tracep->fullSData(oldp+23,(vlTOPp->LFSRMaxPeriod__DOT__last),14);
