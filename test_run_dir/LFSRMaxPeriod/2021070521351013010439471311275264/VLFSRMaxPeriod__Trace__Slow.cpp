...
void VLFSRMaxPeriod::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+21,"LFSRMaxPeriod clock", false,-1);
        tracep->declBit(c+22,"LFSRMaxPeriod reset", false,-1);
        tracep->declBit(c+21,"LFSRMaxPeriod rv_prng_clock", false,-1);
        tracep->declBit(c+22,"LFSRMaxPeriod rv_prng_reset", false,-1);
        ...
        tracep->declBus(c+12,"LFSRMaxPeriod rv_lo", false,-1, 4,0);
        tracep->declBus(c+13,"LFSRMaxPeriod rv_hi", false,-1, 5,0);
        tracep->declBus(c+14,"LFSRMaxPeriod rv", false,-1, 10,0);
        tracep->declBit(c+15,"LFSRMaxPeriod started", false,-1);
        tracep->declBus(c+16,"LFSRMaxPeriod seed", false,-1, 10,0);
        tracep->declBus(c+17,"LFSRMaxPeriod wrap_value", false,-1, 10,0);
        tracep->declBit(c+18,"LFSRMaxPeriod wrap_wrap_wrap", false,-1);
        tracep->declBit(c+19,"LFSRMaxPeriod wrap", false,-1);
        tracep->declBus(c+20,"LFSRMaxPeriod last", false,-1, 10,0);
        tracep->declBit(c+21,"LFSRMaxPeriod rv_prng clock", false,-1);
        tracep->declBit(c+22,"LFSRMaxPeriod rv_prng reset", false,-1);
...
void VLFSRMaxPeriod::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+12,(vlTOPp->LFSRMaxPeriod__DOT__rv_lo),5);
        tracep->fullCData(oldp+13,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_10) 
        ...
        tracep->fullSData(oldp+14,(vlTOPp->LFSRMaxPeriod__DOT__rv),11);
        tracep->fullBit(oldp+15,(vlTOPp->LFSRMaxPeriod__DOT__started));
        tracep->fullSData(oldp+16,(vlTOPp->LFSRMaxPeriod__DOT__seed),11);
        tracep->fullSData(oldp+17,(vlTOPp->LFSRMaxPeriod__DOT__wrap_value),11);
        tracep->fullBit(oldp+18,((0x7feU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value))));
        tracep->fullBit(oldp+19,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
                                  & (0x7feU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value)))));
        tracep->fullSData(oldp+20,(vlTOPp->LFSRMaxPeriod__DOT__last),11);
