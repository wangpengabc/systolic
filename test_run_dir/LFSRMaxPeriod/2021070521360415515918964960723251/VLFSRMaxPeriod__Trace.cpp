...
void VLFSRMaxPeriod::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+2,(vlTOPp->LFSRMaxPeriod__DOT__rv),2);
            tracep->chgBit(oldp+3,(vlTOPp->LFSRMaxPeriod__DOT__started));
            tracep->chgCData(oldp+4,(vlTOPp->LFSRMaxPeriod__DOT__seed),2);
            tracep->chgCData(oldp+5,(vlTOPp->LFSRMaxPeriod__DOT__wrap_value),2);
            tracep->chgBit(oldp+6,((2U == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value))));
            tracep->chgBit(oldp+7,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
                                    & (2U == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value)))));
            tracep->chgCData(oldp+8,(vlTOPp->LFSRMaxPeriod__DOT__last),2);
        }
