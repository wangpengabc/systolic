...
void VLFSRMaxPeriod::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->declBit(c+26,"clock", false,-1);
        tracep->declBit(c+27,"reset", false,-1);
        tracep->declBit(c+26,"LFSRMaxPeriod clock", false,-1);
        tracep->declBit(c+27,"LFSRMaxPeriod reset", false,-1);
        tracep->declBit(c+26,"LFSRMaxPeriod rv_prng_clock", false,-1);
        tracep->declBit(c+27,"LFSRMaxPeriod rv_prng_reset", false,-1);
        ...
        tracep->declBit(c+14,"LFSRMaxPeriod rv_prng_io_out_13", false,-1);
        tracep->declBit(c+15,"LFSRMaxPeriod rv_prng_io_out_14", false,-1);
        tracep->declBit(c+16,"LFSRMaxPeriod rv_prng_io_out_15", false,-1);
        tracep->declBus(c+17,"LFSRMaxPeriod rv_lo", false,-1, 7,0);
        tracep->declBus(c+18,"LFSRMaxPeriod rv_hi", false,-1, 7,0);
        tracep->declBus(c+19,"LFSRMaxPeriod rv", false,-1, 15,0);
        tracep->declBit(c+20,"LFSRMaxPeriod started", false,-1);
        tracep->declBus(c+21,"LFSRMaxPeriod seed", false,-1, 15,0);
        tracep->declBus(c+22,"LFSRMaxPeriod wrap_value", false,-1, 15,0);
        tracep->declBit(c+23,"LFSRMaxPeriod wrap_wrap_wrap", false,-1);
        tracep->declBit(c+24,"LFSRMaxPeriod wrap", false,-1);
        tracep->declBus(c+25,"LFSRMaxPeriod last", false,-1, 15,0);
        tracep->declBit(c+26,"LFSRMaxPeriod rv_prng clock", false,-1);
        tracep->declBit(c+27,"LFSRMaxPeriod rv_prng reset", false,-1);
        ...
        tracep->declBit(c+14,"LFSRMaxPeriod rv_prng io_out_13", false,-1);
        tracep->declBit(c+15,"LFSRMaxPeriod rv_prng io_out_14", false,-1);
        tracep->declBit(c+16,"LFSRMaxPeriod rv_prng io_out_15", false,-1);
        ...
        tracep->declBit(c+14,"LFSRMaxPeriod rv_prng state_13", false,-1);
        tracep->declBit(c+15,"LFSRMaxPeriod rv_prng state_14", false,-1);
        tracep->declBit(c+16,"LFSRMaxPeriod rv_prng state_15", false,-1);
    }
}
...
void VLFSRMaxPeriod::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+14,(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_13));
        tracep->fullBit(oldp+15,(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_14));
        tracep->fullBit(oldp+16,(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_15));
        tracep->fullCData(oldp+17,(vlTOPp->LFSRMaxPeriod__DOT__rv_lo),8);
        tracep->fullCData(oldp+18,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_15) 
        ...
        tracep->fullSData(oldp+19,(vlTOPp->LFSRMaxPeriod__DOT__rv),16);
        tracep->fullBit(oldp+20,(vlTOPp->LFSRMaxPeriod__DOT__started));
        tracep->fullSData(oldp+21,(vlTOPp->LFSRMaxPeriod__DOT__seed),16);
        tracep->fullSData(oldp+22,(vlTOPp->LFSRMaxPeriod__DOT__wrap_value),16);
        tracep->fullBit(oldp+23,((0xfffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value))));
        tracep->fullBit(oldp+24,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
                                  & (0xfffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value)))));
        tracep->fullSData(oldp+25,(vlTOPp->LFSRMaxPeriod__DOT__last),16);
        tracep->fullBit(oldp+26,(vlTOPp->clock));
        tracep->fullBit(oldp+27,(vlTOPp->reset));
    }
}
