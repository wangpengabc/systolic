...
void VLFSRMaxPeriod::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->declBit(c+17,"clock", false,-1);
        tracep->declBit(c+18,"reset", false,-1);
        tracep->declBit(c+17,"LFSRMaxPeriod clock", false,-1);
        tracep->declBit(c+18,"LFSRMaxPeriod reset", false,-1);
        tracep->declBit(c+17,"LFSRMaxPeriod rv_prng_clock", false,-1);
        tracep->declBit(c+18,"LFSRMaxPeriod rv_prng_reset", false,-1);
        ...
        tracep->declBus(c+8,"LFSRMaxPeriod rv_lo", false,-1, 2,0);
        tracep->declBus(c+9,"LFSRMaxPeriod rv_hi", false,-1, 3,0);
        tracep->declBus(c+10,"LFSRMaxPeriod rv", false,-1, 6,0);
        tracep->declBit(c+11,"LFSRMaxPeriod started", false,-1);
        tracep->declBus(c+12,"LFSRMaxPeriod seed", false,-1, 6,0);
        tracep->declBus(c+13,"LFSRMaxPeriod wrap_value", false,-1, 6,0);
        tracep->declBit(c+14,"LFSRMaxPeriod wrap_wrap_wrap", false,-1);
        tracep->declBit(c+15,"LFSRMaxPeriod wrap", false,-1);
        tracep->declBus(c+16,"LFSRMaxPeriod last", false,-1, 6,0);
        tracep->declBit(c+17,"LFSRMaxPeriod rv_prng clock", false,-1);
        tracep->declBit(c+18,"LFSRMaxPeriod rv_prng reset", false,-1);
...
void VLFSRMaxPeriod::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+8,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_2) 
                                    << 2U) | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_1) 
                                               << 1U) 
                                              | (IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_0)))),3);
        tracep->fullCData(oldp+9,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_6) 
        ...
        tracep->fullCData(oldp+10,(vlTOPp->LFSRMaxPeriod__DOT__rv),7);
        tracep->fullBit(oldp+11,(vlTOPp->LFSRMaxPeriod__DOT__started));
        tracep->fullCData(oldp+12,(vlTOPp->LFSRMaxPeriod__DOT__seed),7);
        tracep->fullCData(oldp+13,(vlTOPp->LFSRMaxPeriod__DOT__wrap_value),7);
        tracep->fullBit(oldp+14,((0x7eU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value))));
        tracep->fullBit(oldp+15,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
                                  & (0x7eU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value)))));
        tracep->fullCData(oldp+16,(vlTOPp->LFSRMaxPeriod__DOT__last),7);
        tracep->fullBit(oldp+17,(vlTOPp->clock));
        tracep->fullBit(oldp+18,(vlTOPp->reset));
    }
}
