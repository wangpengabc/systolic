...
VL_MODULE(VLFSRMaxPeriod) {
  public:
    ...
    SData/*9:0*/ LFSRMaxPeriod__DOT__rv;
    SData/*9:0*/ LFSRMaxPeriod__DOT__seed;
    SData/*9:0*/ LFSRMaxPeriod__DOT__wrap_value;
    SData/*9:0*/ LFSRMaxPeriod__DOT___wrap_wrap_value_T_1;
    SData/*9:0*/ LFSRMaxPeriod__DOT__last;
