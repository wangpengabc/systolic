...
void VLFSRMaxPeriod::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/LFSRMaxPeriod/2021070521355410295479893638890807/LFSRMaxPeriod.v", 195, "",
...
VL_INLINE_OPT void VLFSRMaxPeriod::_sequent__TOP__1(VLFSRMaxPeriod__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
            ...
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/LFSRMaxPeriod/2021070521355410295479893638890807/LFSRMaxPeriod.v", 288, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
                          ...
                          & (IData)(vlTOPp->LFSRMaxPeriod__DOT__started)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/LFSRMaxPeriod/2021070521355410295479893638890807/LFSRMaxPeriod.v", 299, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
            ...
            VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:323: Assertion failed in %NLFSRMaxPeriod\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/LFSRMaxPeriod/2021070521355410295479893638890807/LFSRMaxPeriod.v", 323, "");
        }
    }
    __Vdly__LFSRMaxPeriod__DOT__rv_prng__DOT__state_8 
    ...
    vlTOPp->LFSRMaxPeriod__DOT__last = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_12) 
                                         << 0xcU) | 
    ...
    vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_11 
        = (1U & ((~ (IData)(vlTOPp->reset)) & (~ ((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_12) 
                                                  ^ (IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_0)))));
    ...
    vlTOPp->LFSRMaxPeriod__DOT__rv_lo = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_5) 
                                          << 5U) | 
    ...
    vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_8 
        = __Vdly__LFSRMaxPeriod__DOT__rv_prng__DOT__state_8;
    vlTOPp->LFSRMaxPeriod__DOT__rv = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_12) 
                                       << 0xcU) | (
                                                   ((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_11) 
                                                    << 0xbU) 
                                                   | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_10) 
