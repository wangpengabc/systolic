...
void VLFSRMaxPeriod::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+4,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_1) 
                                       << 1U) | (IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_0))),2);
            tracep->chgCData(oldp+5,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_3) 
                                       << 1U) | (IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_2))),2);
            tracep->chgCData(oldp+6,(vlTOPp->LFSRMaxPeriod__DOT__rv),4);
            tracep->chgBit(oldp+7,(vlTOPp->LFSRMaxPeriod__DOT__started));
            tracep->chgCData(oldp+8,(vlTOPp->LFSRMaxPeriod__DOT__seed),4);
            tracep->chgCData(oldp+9,(vlTOPp->LFSRMaxPeriod__DOT__wrap_value),4);
            tracep->chgBit(oldp+10,((0xeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value))));
            tracep->chgBit(oldp+11,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
                                     & (0xeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value)))));
            tracep->chgCData(oldp+12,(vlTOPp->LFSRMaxPeriod__DOT__last),4);
        }
        tracep->chgBit(oldp+13,(vlTOPp->clock));
