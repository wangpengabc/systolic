...
void VLFSRMaxPeriod::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+14,(vlTOPp->LFSRMaxPeriod__DOT__rv_lo),7);
            tracep->chgCData(oldp+15,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_13) 
            ...
            tracep->chgSData(oldp+16,(vlTOPp->LFSRMaxPeriod__DOT__rv),14);
            tracep->chgBit(oldp+17,(vlTOPp->LFSRMaxPeriod__DOT__started));
            tracep->chgSData(oldp+18,(vlTOPp->LFSRMaxPeriod__DOT__seed),14);
            tracep->chgSData(oldp+19,(vlTOPp->LFSRMaxPeriod__DOT__wrap_value),14);
            tracep->chgBit(oldp+20,((0x3ffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value))));
            tracep->chgBit(oldp+21,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
                                     & (0x3ffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value)))));
            tracep->chgSData(oldp+22,(vlTOPp->LFSRMaxPeriod__DOT__last),14);
        }
