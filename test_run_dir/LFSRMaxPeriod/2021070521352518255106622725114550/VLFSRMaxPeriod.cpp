...
void VLFSRMaxPeriod::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/LFSRMaxPeriod/2021070521352518255106622725114550/LFSRMaxPeriod.v", 83, "",
...
VL_INLINE_OPT void VLFSRMaxPeriod::_sequent__TOP__1(VLFSRMaxPeriod__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
                         ...
                         & (~ (((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
                                & (6U == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value))) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:152: Assertion failed in %NLFSRMaxPeriod\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/LFSRMaxPeriod/2021070521352518255106622725114550/LFSRMaxPeriod.v", 152, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
                          ...
                          & (IData)(vlTOPp->LFSRMaxPeriod__DOT__started)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/LFSRMaxPeriod/2021070521352518255106622725114550/LFSRMaxPeriod.v", 163, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv) 
                                   != (IData)(vlTOPp->LFSRMaxPeriod__DOT__last)) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: LFSRMaxPeriod.v:187: Assertion failed in %NLFSRMaxPeriod\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/LFSRMaxPeriod/2021070521352518255106622725114550/LFSRMaxPeriod.v", 187, "");
        }
    }
    __Vdly__LFSRMaxPeriod__DOT__rv_prng__DOT__state_1 
    ...
    vlTOPp->LFSRMaxPeriod__DOT__last = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_2) 
                                         << 2U) | (
                                                   ((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_1) 
                                                    << 1U) 
                                                   | (IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_0)));
    vlTOPp->LFSRMaxPeriod__DOT__wrap_wrap_wrap = (6U 
                                                  == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value));
    vlTOPp->LFSRMaxPeriod__DOT___wrap_wrap_value_T_1 
        = (7U & ((IData)(1U) + (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value)));
    ...
    vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_1 
        = __Vdly__LFSRMaxPeriod__DOT__rv_prng__DOT__state_1;
    vlTOPp->LFSRMaxPeriod__DOT__rv = (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_2) 
