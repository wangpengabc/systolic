...
void VLFSRMaxPeriod::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->declBit(c+25,"clock", false,-1);
        tracep->declBit(c+26,"reset", false,-1);
        tracep->declBit(c+25,"LFSRMaxPeriod clock", false,-1);
        tracep->declBit(c+26,"LFSRMaxPeriod reset", false,-1);
        tracep->declBit(c+25,"LFSRMaxPeriod rv_prng_clock", false,-1);
        tracep->declBit(c+26,"LFSRMaxPeriod rv_prng_reset", false,-1);
        ...
        tracep->declBus(c+16,"LFSRMaxPeriod rv_lo", false,-1, 6,0);
        tracep->declBus(c+17,"LFSRMaxPeriod rv_hi", false,-1, 7,0);
        tracep->declBus(c+18,"LFSRMaxPeriod rv", false,-1, 14,0);
        tracep->declBit(c+19,"LFSRMaxPeriod started", false,-1);
        tracep->declBus(c+20,"LFSRMaxPeriod seed", false,-1, 14,0);
        tracep->declBus(c+21,"LFSRMaxPeriod wrap_value", false,-1, 14,0);
        tracep->declBit(c+22,"LFSRMaxPeriod wrap_wrap_wrap", false,-1);
        tracep->declBit(c+23,"LFSRMaxPeriod wrap", false,-1);
        tracep->declBus(c+24,"LFSRMaxPeriod last", false,-1, 14,0);
        tracep->declBit(c+25,"LFSRMaxPeriod rv_prng clock", false,-1);
        tracep->declBit(c+26,"LFSRMaxPeriod rv_prng reset", false,-1);
...
void VLFSRMaxPeriod::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+16,(vlTOPp->LFSRMaxPeriod__DOT__rv_lo),7);
        tracep->fullCData(oldp+17,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_14) 
                                     << 7U) | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_13) 
                                                << 6U) 
                                                     ...
                                                     | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_10) 
                                                        ...
                                                        | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_9) 
                                                           ...
                                                           | (((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_8) 
                                                               << 1U) 
                                                              | (IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_7))))))))),8);
        tracep->fullSData(oldp+18,(vlTOPp->LFSRMaxPeriod__DOT__rv),15);
        tracep->fullBit(oldp+19,(vlTOPp->LFSRMaxPeriod__DOT__started));
        tracep->fullSData(oldp+20,(vlTOPp->LFSRMaxPeriod__DOT__seed),15);
        tracep->fullSData(oldp+21,(vlTOPp->LFSRMaxPeriod__DOT__wrap_value),15);
        tracep->fullBit(oldp+22,((0x7ffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value))));
        tracep->fullBit(oldp+23,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
                                  & (0x7ffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value)))));
        tracep->fullSData(oldp+24,(vlTOPp->LFSRMaxPeriod__DOT__last),15);
        tracep->fullBit(oldp+25,(vlTOPp->clock));
