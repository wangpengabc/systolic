...
void VLFSRMaxPeriod::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+15,(vlTOPp->LFSRMaxPeriod__DOT__rv_lo),7);
            tracep->chgCData(oldp+16,((((IData)(vlTOPp->LFSRMaxPeriod__DOT__rv_prng__DOT__state_14) 
            ...
            tracep->chgSData(oldp+17,(vlTOPp->LFSRMaxPeriod__DOT__rv),15);
            tracep->chgBit(oldp+18,(vlTOPp->LFSRMaxPeriod__DOT__started));
            tracep->chgSData(oldp+19,(vlTOPp->LFSRMaxPeriod__DOT__seed),15);
            tracep->chgSData(oldp+20,(vlTOPp->LFSRMaxPeriod__DOT__wrap_value),15);
            tracep->chgBit(oldp+21,((0x7ffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value))));
            tracep->chgBit(oldp+22,(((IData)(vlTOPp->LFSRMaxPeriod__DOT__started) 
                                     & (0x7ffeU == (IData)(vlTOPp->LFSRMaxPeriod__DOT__wrap_value)))));
            tracep->chgSData(oldp+23,(vlTOPp->LFSRMaxPeriod__DOT__last),15);
        }
        tracep->chgBit(oldp+24,(vlTOPp->clock));
