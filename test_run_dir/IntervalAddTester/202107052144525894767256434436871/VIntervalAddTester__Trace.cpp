...
void VIntervalAddTester::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VIntervalAddTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VIntervalAddTester__Syms* __restrict vlSymsp = static_cast<VIntervalAddTester__Syms*>(userp);
    VIntervalAddTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VIntervalAddTester::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VIntervalAddTester__Syms* __restrict vlSymsp = static_cast<VIntervalAddTester__Syms*>(userp);
    VIntervalAddTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
