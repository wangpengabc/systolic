...
void VQueueFactoryTester::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+40,"QueueFactoryTester clock", false,-1);
        tracep->declBit(c+41,"QueueFactoryTester reset", false,-1);
        tracep->declBit(c+40,"QueueFactoryTester deq_clock", false,-1);
        tracep->declBit(c+41,"QueueFactoryTester deq_reset", false,-1);
        ...
        tracep->declBus(c+3,"QueueFactoryTester deq_io_enq_bits", false,-1, 3,0);
        ...
        tracep->declBus(c+6,"QueueFactoryTester deq_io_deq_bits", false,-1, 3,0);
        tracep->declBit(c+40,"QueueFactoryTester deq_io_deq_ready_prng_clock", false,-1);
        tracep->declBit(c+41,"QueueFactoryTester deq_io_deq_ready_prng_reset", false,-1);
        ...
        tracep->declBit(c+40,"QueueFactoryTester deq clock", false,-1);
        tracep->declBit(c+41,"QueueFactoryTester deq reset", false,-1);
        ...
        tracep->declBus(c+3,"QueueFactoryTester deq io_enq_bits", false,-1, 3,0);
        ...
        tracep->declBus(c+6,"QueueFactoryTester deq io_deq_bits", false,-1, 3,0);
        {int i; for (i=0; i<2; i++) {
                tracep->declBus(c+28+i*1,"QueueFactoryTester deq ram", true,(i+0), 3,0);}}
        tracep->declBit(c+42,"QueueFactoryTester deq ram_io_deq_bits_MPORT_en", false,-1);
        tracep->declBit(c+30,"QueueFactoryTester deq ram_io_deq_bits_MPORT_addr", false,-1);
        tracep->declBus(c+6,"QueueFactoryTester deq ram_io_deq_bits_MPORT_data", false,-1, 3,0);
        tracep->declBus(c+3,"QueueFactoryTester deq ram_MPORT_data", false,-1, 3,0);
        tracep->declBit(c+31,"QueueFactoryTester deq ram_MPORT_addr", false,-1);
        tracep->declBit(c+42,"QueueFactoryTester deq ram_MPORT_mask", false,-1);
        tracep->declBit(c+32,"QueueFactoryTester deq ram_MPORT_en", false,-1);
        tracep->declBit(c+30,"QueueFactoryTester deq ram_io_deq_bits_MPORT_addr_pipe_0", false,-1);
        tracep->declBit(c+31,"QueueFactoryTester deq value", false,-1);
        tracep->declBit(c+33,"QueueFactoryTester deq value_1", false,-1);
        tracep->declBit(c+34,"QueueFactoryTester deq maybe_full", false,-1);
        tracep->declBit(c+35,"QueueFactoryTester deq ptr_match", false,-1);
        tracep->declBit(c+36,"QueueFactoryTester deq empty", false,-1);
        tracep->declBit(c+37,"QueueFactoryTester deq full", false,-1);
        tracep->declBit(c+38,"QueueFactoryTester deq do_enq", false,-1);
        tracep->declBit(c+39,"QueueFactoryTester deq do_deq", false,-1);
        tracep->declBit(c+40,"QueueFactoryTester deq_io_deq_ready_prng clock", false,-1);
        tracep->declBit(c+41,"QueueFactoryTester deq_io_deq_ready_prng reset", false,-1);
...
void VQueueFactoryTester::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+3,(((0x13U == (IData)(vlTOPp->QueueFactoryTester__DOT__value))
                                    ? 0U : ((0x12U 
        ...
        tracep->fullCData(oldp+6,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram
                                  [vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram_io_deq_bits_MPORT_addr_pipe_0]),4);
        ...
        tracep->fullCData(oldp+28,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram[0]),4);
        tracep->fullCData(oldp+29,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram[1]),4);
        tracep->fullBit(oldp+30,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram_io_deq_bits_MPORT_addr_pipe_0));
        tracep->fullBit(oldp+31,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__value));
        tracep->fullBit(oldp+32,(((~ (IData)(vlTOPp->QueueFactoryTester__DOT__deq__DOT__full)) 
                                  & (0x14U > (IData)(vlTOPp->QueueFactoryTester__DOT__value)))));
        tracep->fullBit(oldp+33,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__value_1));
        tracep->fullBit(oldp+34,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__maybe_full));
        tracep->fullBit(oldp+35,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ptr_match));
        tracep->fullBit(oldp+36,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__empty));
        tracep->fullBit(oldp+37,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__full));
        tracep->fullBit(oldp+38,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__do_enq));
        tracep->fullBit(oldp+39,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__do_deq));
        tracep->fullBit(oldp+40,(vlTOPp->clock));
