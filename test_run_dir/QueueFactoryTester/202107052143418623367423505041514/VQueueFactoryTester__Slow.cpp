...
void VQueueFactoryTester::_ctor_var_reset(VQueueFactoryTester* self) {
    ...
    self->QueueFactoryTester__DOT__deq__DOT__ram_io_deq_bits_MPORT_addr_pipe_0 = VL_RAND_RESET_I(1);
    self->QueueFactoryTester__DOT__deq__DOT__value = VL_RAND_RESET_I(1);
    self->QueueFactoryTester__DOT__deq__DOT__value_1 = VL_RAND_RESET_I(1);
    ...
    self->QueueFactoryTester__DOT__deq__DOT___value_T_3 = VL_RAND_RESET_I(1);
    self->QueueFactoryTester__DOT__deq__DOT___GEN_8 = VL_RAND_RESET_I(2);
