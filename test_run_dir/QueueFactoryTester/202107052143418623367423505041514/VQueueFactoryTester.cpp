...
void VQueueFactoryTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFactoryTester/202107052143418623367423505041514/QueueFactoryTester.v", 361, "",
...
VL_INLINE_OPT void VQueueFactoryTester::_sequent__TOP__1(VQueueFactoryTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & ((((IData)(vlTOPp->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
                                 >> 3U) & (~ (IData)(vlTOPp->QueueFactoryTester__DOT__deq__DOT__empty))) 
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & ((((IData)(vlTOPp->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
                               ...
                               & (~ ((((0x13U == (IData)(vlTOPp->QueueFactoryTester__DOT__value_1)) 
                                      ...
                                      [vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram_io_deq_bits_MPORT_addr_pipe_0]) 
                                     | (IData)(vlTOPp->reset))))))) {
            VL_WRITEF("[%0t] %%Error: QueueFactoryTester.v:503: Assertion failed in %NQueueFactoryTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFactoryTester/202107052143418623367423505041514/QueueFactoryTester.v", 503, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->QueueFactoryTester__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFactoryTester/202107052143418623367423505041514/QueueFactoryTester.v", 514, "");
        }
    }
