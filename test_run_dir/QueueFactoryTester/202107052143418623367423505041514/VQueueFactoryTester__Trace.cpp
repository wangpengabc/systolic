...
void VQueueFactoryTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgBit(oldp+29,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram_io_deq_bits_MPORT_addr_pipe_0));
            tracep->chgBit(oldp+30,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__value));
            tracep->chgBit(oldp+31,(((~ (IData)(vlTOPp->QueueFactoryTester__DOT__deq__DOT__full)) 
                                     & (0x14U > (IData)(vlTOPp->QueueFactoryTester__DOT__value)))));
            tracep->chgBit(oldp+32,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__value_1));
            tracep->chgBit(oldp+33,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__maybe_full));
            tracep->chgBit(oldp+34,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ptr_match));
            tracep->chgBit(oldp+35,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__empty));
            tracep->chgBit(oldp+36,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__full));
            tracep->chgBit(oldp+37,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__do_enq));
            tracep->chgBit(oldp+38,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__do_deq));
        }
        tracep->chgBit(oldp+39,(vlTOPp->clock));
