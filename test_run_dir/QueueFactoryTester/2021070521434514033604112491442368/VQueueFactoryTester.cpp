...
void VQueueFactoryTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFactoryTester/2021070521434514033604112491442368/QueueFactoryTester.v", 347, "",
...
VL_INLINE_OPT void VQueueFactoryTester::_sequent__TOP__1(VQueueFactoryTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & ((((IData)(vlTOPp->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
                                 >> 2U) & (~ (IData)(vlTOPp->QueueFactoryTester__DOT__deq__DOT__empty))) 
                               & (~ ((((0x13U == (IData)(vlTOPp->QueueFactoryTester__DOT__value_1)) 
                                       | ((0x12U != (IData)(vlTOPp->QueueFactoryTester__DOT__value_1)) 
                                          & ((0x11U 
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & ((((IData)(vlTOPp->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
                               ...
                               & (~ ((((0x13U == (IData)(vlTOPp->QueueFactoryTester__DOT__value_1)) 
                                      ...
                                      [vlTOPp->QueueFactoryTester__DOT__deq__DOT__value_1]) 
                                     | (IData)(vlTOPp->reset))))))) {
            VL_WRITEF("[%0t] %%Error: QueueFactoryTester.v:490: Assertion failed in %NQueueFactoryTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFactoryTester/2021070521434514033604112491442368/QueueFactoryTester.v", 490, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->QueueFactoryTester__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFactoryTester/2021070521434514033604112491442368/QueueFactoryTester.v", 501, "");
        }
    }
                     ...
                     | ((0x10U == (IData)(vlTOPp->QueueFactoryTester__DOT__value)) 
                        | ((0xfU == (IData)(vlTOPp->QueueFactoryTester__DOT__value)) 
                           | ((0xeU != (IData)(vlTOPp->QueueFactoryTester__DOT__value)) 
                              & ((0xdU != (IData)(vlTOPp->QueueFactoryTester__DOT__value)) 
                                 & ((0xcU == (IData)(vlTOPp->QueueFactoryTester__DOT__value)) 
                                    | ((0xbU == (IData)(vlTOPp->QueueFactoryTester__DOT__value)) 
                                       | ((0xaU != (IData)(vlTOPp->QueueFactoryTester__DOT__value)) 
                                          & ((9U != (IData)(vlTOPp->QueueFactoryTester__DOT__value)) 
                                             & ((8U 
    ...
    if (vlTOPp->reset) {
        vlTOPp->QueueFactoryTester__DOT__deq__DOT__value_1 = 0U;
    ...
    if (vlTOPp->reset) {
        vlTOPp->QueueFactoryTester__DOT__deq__DOT__value = 0U;
    } else if (vlTOPp->QueueFactoryTester__DOT__deq__DOT__do_enq) {
        vlTOPp->QueueFactoryTester__DOT__deq__DOT__value 
            = vlTOPp->QueueFactoryTester__DOT__deq__DOT___value_T_1;
    }
    ...
    vlTOPp->QueueFactoryTester__DOT___value_T_3 = (0x1fU 
                                                   & ((IData)(1U) 
                                                      + (IData)(vlTOPp->QueueFactoryTester__DOT__value_1)));
    vlTOPp->QueueFactoryTester__DOT__deq__DOT___value_T_3 
        = (3U & ((IData)(1U) + (IData)(vlTOPp->QueueFactoryTester__DOT__deq__DOT__value_1)));
    ...
    vlTOPp->QueueFactoryTester__DOT___value_T_1 = (0x1fU 
                                                   & ((IData)(1U) 
                                                      + (IData)(vlTOPp->QueueFactoryTester__DOT__value)));
    vlTOPp->QueueFactoryTester__DOT__deq__DOT___value_T_1 
        = (3U & ((IData)(1U) + (IData)(vlTOPp->QueueFactoryTester__DOT__deq__DOT__value)));
