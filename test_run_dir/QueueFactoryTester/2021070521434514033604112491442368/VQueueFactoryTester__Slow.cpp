...
void VQueueFactoryTester::_ctor_var_reset(VQueueFactoryTester* self) {
    ...
    for (int __Vi0=0; __Vi0<4; ++__Vi0) {
        self->QueueFactoryTester__DOT__deq__DOT__ram[__Vi0] = VL_RAND_RESET_I(1);
    }
    self->QueueFactoryTester__DOT__deq__DOT__value = VL_RAND_RESET_I(2);
    self->QueueFactoryTester__DOT__deq__DOT__value_1 = VL_RAND_RESET_I(2);
    self->QueueFactoryTester__DOT__deq__DOT__maybe_full = VL_RAND_RESET_I(1);
    self->QueueFactoryTester__DOT__deq__DOT__ptr_match = VL_RAND_RESET_I(1);
    self->QueueFactoryTester__DOT__deq__DOT__empty = VL_RAND_RESET_I(1);
    self->QueueFactoryTester__DOT__deq__DOT__full = VL_RAND_RESET_I(1);
    ...
    self->QueueFactoryTester__DOT__deq__DOT___value_T_1 = VL_RAND_RESET_I(2);
    self->QueueFactoryTester__DOT__deq__DOT___value_T_3 = VL_RAND_RESET_I(2);
