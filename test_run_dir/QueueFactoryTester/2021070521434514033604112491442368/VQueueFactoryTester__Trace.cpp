...
void VQueueFactoryTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            tracep->chgBit(oldp+0,((1U & (~ (IData)(vlTOPp->QueueFactoryTester__DOT__deq__DOT__full)))));
            tracep->chgBit(oldp+1,((0x14U > (IData)(vlTOPp->QueueFactoryTester__DOT__value))));
            tracep->chgBit(oldp+2,(((0x13U == (IData)(vlTOPp->QueueFactoryTester__DOT__value)) 
            ...
            tracep->chgBit(oldp+3,((1U & ((IData)(vlTOPp->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
                                          >> 2U))));
            tracep->chgBit(oldp+4,((1U & (~ (IData)(vlTOPp->QueueFactoryTester__DOT__deq__DOT__empty)))));
            tracep->chgBit(oldp+5,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram
            ...
            tracep->chgBit(oldp+27,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram[0]));
            tracep->chgBit(oldp+28,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram[1]));
            tracep->chgBit(oldp+29,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram[2]));
            tracep->chgBit(oldp+30,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram[3]));
            tracep->chgCData(oldp+31,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__value_1),2);
            tracep->chgCData(oldp+32,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__value),2);
            tracep->chgBit(oldp+33,(((~ (IData)(vlTOPp->QueueFactoryTester__DOT__deq__DOT__full)) 
                                     & (0x14U > (IData)(vlTOPp->QueueFactoryTester__DOT__value)))));
            tracep->chgBit(oldp+34,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__maybe_full));
            tracep->chgBit(oldp+35,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ptr_match));
            tracep->chgBit(oldp+36,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__empty));
            tracep->chgBit(oldp+37,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__full));
            tracep->chgBit(oldp+38,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__do_enq));
            tracep->chgBit(oldp+39,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__do_deq));
        }
