...
void VQueueFactoryTester::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+32,"QueueFactoryTester clock", false,-1);
        tracep->declBit(c+33,"QueueFactoryTester reset", false,-1);
        tracep->declBit(c+32,"QueueFactoryTester deq_clock", false,-1);
        tracep->declBit(c+33,"QueueFactoryTester deq_reset", false,-1);
        ...
        tracep->declBit(c+32,"QueueFactoryTester deq_io_deq_ready_prng_clock", false,-1);
        tracep->declBit(c+33,"QueueFactoryTester deq_io_deq_ready_prng_reset", false,-1);
        ...
        tracep->declBit(c+32,"QueueFactoryTester deq clock", false,-1);
        tracep->declBit(c+33,"QueueFactoryTester deq reset", false,-1);
        ...
        tracep->declBit(c+34,"QueueFactoryTester deq ram_io_deq_bits_MPORT_en", false,-1);
        tracep->declBit(c+35,"QueueFactoryTester deq ram_io_deq_bits_MPORT_addr", false,-1);
        ...
        tracep->declBit(c+35,"QueueFactoryTester deq ram_MPORT_addr", false,-1);
        tracep->declBit(c+34,"QueueFactoryTester deq ram_MPORT_mask", false,-1);
        tracep->declBit(c+29,"QueueFactoryTester deq ram_MPORT_en", false,-1);
        tracep->declBit(c+5,"QueueFactoryTester deq maybe_full", false,-1);
        tracep->declBit(c+1,"QueueFactoryTester deq empty", false,-1);
        tracep->declBit(c+30,"QueueFactoryTester deq do_enq", false,-1);
        tracep->declBit(c+31,"QueueFactoryTester deq do_deq", false,-1);
        tracep->declBit(c+32,"QueueFactoryTester deq_io_deq_ready_prng clock", false,-1);
        tracep->declBit(c+33,"QueueFactoryTester deq_io_deq_ready_prng reset", false,-1);
...
void VQueueFactoryTester::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->fullBit(oldp+1,((1U & (~ (IData)(vlTOPp->QueueFactoryTester__DOT__deq__DOT__maybe_full)))));
        ...
        tracep->fullBit(oldp+4,((1U & ((IData)(vlTOPp->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
                                       >> 0xeU))));
        tracep->fullBit(oldp+5,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__maybe_full));
        ...
        tracep->fullBit(oldp+29,(((~ (IData)(vlTOPp->QueueFactoryTester__DOT__deq__DOT__maybe_full)) 
                                  & (0x14U > (IData)(vlTOPp->QueueFactoryTester__DOT__value)))));
        tracep->fullBit(oldp+30,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__do_enq));
        tracep->fullBit(oldp+31,((((IData)(vlTOPp->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
                                   >> 0xeU) & (IData)(vlTOPp->QueueFactoryTester__DOT__deq__DOT__maybe_full))));
        tracep->fullBit(oldp+32,(vlTOPp->clock));
