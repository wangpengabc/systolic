...
void VQueueFactoryTester::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+3,"QueueFactoryTester deq_io_enq_bits", false,-1, 2,0);
        ...
        tracep->declBus(c+6,"QueueFactoryTester deq_io_deq_bits", false,-1, 2,0);
        ...
        tracep->declBus(c+3,"QueueFactoryTester deq io_enq_bits", false,-1, 2,0);
        ...
        tracep->declBus(c+6,"QueueFactoryTester deq io_deq_bits", false,-1, 2,0);
        {int i; for (i=0; i<2; i++) {
                tracep->declBus(c+28+i*1,"QueueFactoryTester deq ram", true,(i+0), 2,0);}}
        ...
        tracep->declBus(c+6,"QueueFactoryTester deq ram_io_deq_bits_MPORT_data", false,-1, 2,0);
        tracep->declBus(c+3,"QueueFactoryTester deq ram_MPORT_data", false,-1, 2,0);
...
void VQueueFactoryTester::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+6,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram
                                  [vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram_io_deq_bits_MPORT_addr_pipe_0]),3);
        ...
        tracep->fullCData(oldp+28,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram[0]),3);
        tracep->fullCData(oldp+29,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram[1]),3);
