...
void VQueueFactoryTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFactoryTester/202107052143502979836206707050488/QueueFactoryTester.v", 361, "",
...
VL_INLINE_OPT void VQueueFactoryTester::_sequent__TOP__1(VQueueFactoryTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & ((((IData)(vlTOPp->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
                                 >> 0xdU) & (~ (IData)(vlTOPp->QueueFactoryTester__DOT__deq__DOT__empty))) 
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & ((((IData)(vlTOPp->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
            ...
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFactoryTester/202107052143502979836206707050488/QueueFactoryTester.v", 521, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->QueueFactoryTester__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFactoryTester/202107052143502979836206707050488/QueueFactoryTester.v", 532, "");
        }
    }
        ...
        __Vdlyvval__QueueFactoryTester__DOT__deq__DOT__ram__v0 
            = ((0x13U == (IData)(vlTOPp->QueueFactoryTester__DOT__value))
                ? 4U : ((0x12U == (IData)(vlTOPp->QueueFactoryTester__DOT__value))
                         ? 4U : ((0x11U == (IData)(vlTOPp->QueueFactoryTester__DOT__value))
                                  ? 5U : ((0x10U == (IData)(vlTOPp->QueueFactoryTester__DOT__value))
                                           ? 2U : (
                                                   (0xfU 
