...
void VQueueFactoryTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFactoryTester/202107052143371768545544343379175/QueueFactoryTester.v", 347, "",
...
VL_INLINE_OPT void VQueueFactoryTester::_sequent__TOP__1(VQueueFactoryTester__Syms* __restrict vlSymsp) {
    ...
    CData/*2:0*/ __Vdlyvval__QueueFactoryTester__DOT__deq__DOT__ram__v0;
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & ((((IData)(vlTOPp->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
                               ...
                               & (~ ((((0x13U == (IData)(vlTOPp->QueueFactoryTester__DOT__value_1))
                                      ...
                                      [vlTOPp->QueueFactoryTester__DOT__deq__DOT__value_1]) 
                                     | (IData)(vlTOPp->reset))))))) {
            VL_WRITEF("[%0t] %%Error: QueueFactoryTester.v:507: Assertion failed in %NQueueFactoryTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFactoryTester/202107052143371768545544343379175/QueueFactoryTester.v", 507, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->QueueFactoryTester__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFactoryTester/202107052143371768545544343379175/QueueFactoryTester.v", 518, "");
        }
    }
    ...
    if (((~ (IData)(vlTOPp->QueueFactoryTester__DOT__deq__DOT__full)) 
        ...
        __Vdlyvval__QueueFactoryTester__DOT__deq__DOT__ram__v0 
            = ((0x13U == (IData)(vlTOPp->QueueFactoryTester__DOT__value))
                ? 7U : ((0x12U == (IData)(vlTOPp->QueueFactoryTester__DOT__value))
                         ? 1U : ((0x11U == (IData)(vlTOPp->QueueFactoryTester__DOT__value))
                                  ? 3U : ((0x10U == (IData)(vlTOPp->QueueFactoryTester__DOT__value))
                                           ? 7U : (
                                                   (0xfU 
