    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+5,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram
                                     [vlTOPp->QueueFactoryTester__DOT__deq__DOT__value_1]),3);
            ...
            tracep->chgCData(oldp+29,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram[2]),3);
            tracep->chgCData(oldp+30,(vlTOPp->QueueFactoryTester__DOT__deq__DOT__ram[3]),3);
