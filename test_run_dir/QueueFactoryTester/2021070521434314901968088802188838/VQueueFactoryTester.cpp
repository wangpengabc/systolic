...
void VQueueFactoryTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFactoryTester/2021070521434314901968088802188838/QueueFactoryTester.v", 325, "",
...
VL_INLINE_OPT void VQueueFactoryTester::_sequent__TOP__1(VQueueFactoryTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((((IData)(vlTOPp->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
                         ...
                         & (~ ((((0x13U == (IData)(vlTOPp->QueueFactoryTester__DOT__value_1))
                                  ? 0U : ((0x12U == (IData)(vlTOPp->QueueFactoryTester__DOT__value_1))
                                           ? 1U : (
                                                   (0x11U 
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((((IData)(vlTOPp->QueueFactoryTester__DOT___deq_io_deq_ready_T) 
            ...
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFactoryTester/2021070521434314901968088802188838/QueueFactoryTester.v", 485, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->QueueFactoryTester__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFactoryTester/2021070521434314901968088802188838/QueueFactoryTester.v", 496, "");
        }
    }
            ...
            = ((0x13U == (IData)(vlTOPp->QueueFactoryTester__DOT__value))
                ? 0U : ((0x12U == (IData)(vlTOPp->QueueFactoryTester__DOT__value))
                         ? 1U : ((0x11U == (IData)(vlTOPp->QueueFactoryTester__DOT__value))
                                  ? 6U : ((0x10U == (IData)(vlTOPp->QueueFactoryTester__DOT__value))
                                           ? 3U : (
                                                   (0xfU 
