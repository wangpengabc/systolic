...
void VShiftResetTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftResetTester/202107052140476941892517353962094/ShiftResetTester.v", 1, "",
...
VL_INLINE_OPT void VShiftResetTester::_sequent__TOP__1(VShiftResetTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((2U == (IData)(vlTOPp->ShiftResetTester__DOT__cntVal)) 
                         & (~ ((1U == (IData)(vlTOPp->ShiftResetTester__DOT__sr)) 
                               | (IData)(vlTOPp->reset)))))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((2U == (IData)(vlTOPp->ShiftResetTester__DOT__cntVal)) 
                         & (~ ((1U == (IData)(vlTOPp->ShiftResetTester__DOT__sr)) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: ShiftResetTester.v:66: Assertion failed in %NShiftResetTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftResetTester/202107052140476941892517353962094/ShiftResetTester.v", 66, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((2U == (IData)(vlTOPp->ShiftResetTester__DOT__cntVal)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftResetTester/202107052140476941892517353962094/ShiftResetTester.v", 77, "");
        }
    }
    if (vlTOPp->reset) {
        vlTOPp->ShiftResetTester__DOT__sr = 1U;
        vlTOPp->ShiftResetTester__DOT__sr_r_2 = 1U;
        vlTOPp->ShiftResetTester__DOT__sr_r_1 = 1U;
        vlTOPp->ShiftResetTester__DOT__sr_r = 1U;
        vlTOPp->ShiftResetTester__DOT__cntVal = 0U;
    } else {
        vlTOPp->ShiftResetTester__DOT__sr = vlTOPp->ShiftResetTester__DOT__sr_r_2;
        vlTOPp->ShiftResetTester__DOT__sr_r_2 = vlTOPp->ShiftResetTester__DOT__sr_r_1;
        vlTOPp->ShiftResetTester__DOT__sr_r_1 = vlTOPp->ShiftResetTester__DOT__sr_r;
        vlTOPp->ShiftResetTester__DOT__sr_r = (0x1fU 
                                               & ((IData)(0x17U) 
                                                  + (IData)(vlTOPp->ShiftResetTester__DOT__cntVal)));
        vlTOPp->ShiftResetTester__DOT__cntVal = ((IData)(vlTOPp->ShiftResetTester__DOT__wrap_wrap)
                                                  ? 0U
                                                  : (IData)(vlTOPp->ShiftResetTester__DOT___wrap_value_T_1));
    }
