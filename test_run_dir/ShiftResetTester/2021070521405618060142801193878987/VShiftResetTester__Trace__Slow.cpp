...
void VShiftResetTester::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+5,"ShiftResetTester clock", false,-1);
        tracep->declBit(c+6,"ShiftResetTester reset", false,-1);
        tracep->declBit(c+1,"ShiftResetTester cntVal", false,-1);
        tracep->declBus(c+2,"ShiftResetTester sr_r", false,-1, 4,0);
        tracep->declBus(c+3,"ShiftResetTester sr_r_1", false,-1, 4,0);
        tracep->declBus(c+4,"ShiftResetTester sr", false,-1, 4,0);
    }
}
...
void VShiftResetTester::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->fullBit(oldp+1,(vlTOPp->ShiftResetTester__DOT__cntVal));
        tracep->fullCData(oldp+2,(vlTOPp->ShiftResetTester__DOT__sr_r),5);
        tracep->fullCData(oldp+3,(vlTOPp->ShiftResetTester__DOT__sr_r_1),5);
        tracep->fullCData(oldp+4,(vlTOPp->ShiftResetTester__DOT__sr),5);
