...
void VShiftResetTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftResetTester/2021070521405618060142801193878987/ShiftResetTester.v", 1, "",
...
VL_INLINE_OPT void VShiftResetTester::_sequent__TOP__1(VShiftResetTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftResetTester__DOT__cntVal) 
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftResetTester__DOT__cntVal) 
                         & (~ ((1U == (IData)(vlTOPp->ShiftResetTester__DOT__sr)) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: ShiftResetTester.v:56: Assertion failed in %NShiftResetTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftResetTester/2021070521405618060142801193878987/ShiftResetTester.v", 56, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftResetTester__DOT__cntVal) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftResetTester/2021070521405618060142801193878987/ShiftResetTester.v", 67, "");
        }
    }
    if (vlTOPp->reset) {
        ...
        vlTOPp->ShiftResetTester__DOT__sr = vlTOPp->ShiftResetTester__DOT__sr_r_1;
    ...
    vlTOPp->ShiftResetTester__DOT__cntVal = ((~ (IData)(vlTOPp->reset)) 
                                             & (IData)(vlTOPp->ShiftResetTester__DOT___wrap_value_T_1));
    vlTOPp->ShiftResetTester__DOT___wrap_value_T_1 
        = (1U & ((IData)(1U) + (IData)(vlTOPp->ShiftResetTester__DOT__cntVal)));
}
