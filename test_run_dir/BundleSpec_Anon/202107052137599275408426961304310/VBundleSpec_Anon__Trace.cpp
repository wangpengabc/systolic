...
void VBundleSpec_Anon::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VBundleSpec_Anon::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VBundleSpec_Anon__Syms* __restrict vlSymsp = static_cast<VBundleSpec_Anon__Syms*>(userp);
    VBundleSpec_Anon* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VBundleSpec_Anon::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VBundleSpec_Anon__Syms* __restrict vlSymsp = static_cast<VBundleSpec_Anon__Syms*>(userp);
    VBundleSpec_Anon* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
