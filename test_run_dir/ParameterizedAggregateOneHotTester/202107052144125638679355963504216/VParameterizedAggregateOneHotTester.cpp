...
VerilatedContext* VParameterizedAggregateOneHotTester::contextp() {
...
void VParameterizedAggregateOneHotTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/ParameterizedAggregateOneHotTester/202107052144125638679355963504216/ParameterizedAggregateOneHotTester.v", 31, "",
...
VL_INLINE_OPT void VParameterizedAggregateOneHotTester::_sequent__TOP__1(VParameterizedAggregateOneHotTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/ParameterizedAggregateOneHotTester/202107052144125638679355963504216/ParameterizedAggregateOneHotTester.v", 213, "");
        }
    }
}
...
VL_INLINE_OPT QData VParameterizedAggregateOneHotTester::_change_request_1(VParameterizedAggregateOneHotTester__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VParameterizedAggregateOneHotTester::_change_request_1\n"); );
    VParameterizedAggregateOneHotTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
