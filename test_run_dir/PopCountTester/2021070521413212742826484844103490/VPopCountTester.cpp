...
void VPopCountTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/PopCountTester/2021070521413212742826484844103490/PopCountTester.v", 1, "",
...
VL_INLINE_OPT void VPopCountTester::_sequent__TOP__1(VPopCountTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->PopCountTester__DOT__REG) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/PopCountTester/2021070521413212742826484844103490/PopCountTester.v", 29, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((3U & ((1U & (IData)(vlTOPp->PopCountTester__DOT__x)) 
                                          + (1U & ((IData)(vlTOPp->PopCountTester__DOT__x) 
                                                   >> 1U)))) 
                                   == (7U & ((1U & (IData)(vlTOPp->PopCountTester__DOT__x)) 
                                             + (1U 
                                   ...
                                   == (7U & ((1U & (IData)(vlTOPp->PopCountTester__DOT__x)) 
                                             + (1U 
                                                & ((IData)(vlTOPp->PopCountTester__DOT__x) 
                                                   >> 1U))))) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: PopCountTester.v:51: Assertion failed in %NPopCountTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/PopCountTester/2021070521413212742826484844103490/PopCountTester.v", 51, "");
        }
    }
    vlTOPp->PopCountTester__DOT__REG = (3U == (IData)(vlTOPp->PopCountTester__DOT__x));
    vlTOPp->PopCountTester__DOT__x = ((IData)(vlTOPp->reset)
                                       ? 0U : (IData)(vlTOPp->PopCountTester__DOT___x_T_1));
    vlTOPp->PopCountTester__DOT___x_T_1 = (3U & ((IData)(1U) 
                                                 + (IData)(vlTOPp->PopCountTester__DOT__x)));
}
