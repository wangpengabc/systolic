...
void VPopCountTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/PopCountTester/202107052141413537384322129374793/PopCountTester.v", 1, "",
...
VL_INLINE_OPT void VPopCountTester::_sequent__TOP__1(VPopCountTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->PopCountTester__DOT__REG) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/PopCountTester/202107052141413537384322129374793/PopCountTester.v", 29, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((3U & ((1U & (IData)(vlTOPp->PopCountTester__DOT__x)) 
            ...
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/PopCountTester/202107052141413537384322129374793/PopCountTester.v", 51, "");
        }
    }
