...
void VPopCountTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/PopCountTester/2021070521413910704643783270777109/PopCountTester.v", 1, "",
...
VL_INLINE_OPT void VPopCountTester::_sequent__TOP__1(VPopCountTester__Syms* __restrict vlSymsp) {
    ...
    // Body
    __Vdly__PopCountTester__DOT__x = vlTOPp->PopCountTester__DOT__x;
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->PopCountTester__DOT__REG) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/PopCountTester/2021070521413910704643783270777109/PopCountTester.v", 24, "");
        }
    }
    __Vdly__PopCountTester__DOT__x = (1U & ((~ (IData)(vlTOPp->reset)) 
                                            & ((IData)(1U) 
                                               + (IData)(vlTOPp->PopCountTester__DOT__x))));
    vlTOPp->PopCountTester__DOT__REG = vlTOPp->PopCountTester__DOT__x;
    vlTOPp->PopCountTester__DOT__x = __Vdly__PopCountTester__DOT__x;
}
