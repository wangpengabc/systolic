...
VerilatedContext* VStopTester::contextp() {
    return __VlSymsp->_vm_contextp__;
}

void VStopTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/StopTester/202107052144159967986705332147702/StopTester.v", 1, "",
...
VL_INLINE_OPT void VStopTester::_sequent__TOP__1(VStopTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/StopTester/202107052144159967986705332147702/StopTester.v", 11, "");
        }
    }
}
...
VL_INLINE_OPT QData VStopTester::_change_request_1(VStopTester__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VStopTester::_change_request_1\n"); );
    VStopTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
