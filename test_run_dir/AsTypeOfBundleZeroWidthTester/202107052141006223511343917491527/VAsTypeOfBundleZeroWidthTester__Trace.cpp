...
void VAsTypeOfBundleZeroWidthTester::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VAsTypeOfBundleZeroWidthTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VAsTypeOfBundleZeroWidthTester__Syms* __restrict vlSymsp = static_cast<VAsTypeOfBundleZeroWidthTester__Syms*>(userp);
    VAsTypeOfBundleZeroWidthTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VAsTypeOfBundleZeroWidthTester::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VAsTypeOfBundleZeroWidthTester__Syms* __restrict vlSymsp = static_cast<VAsTypeOfBundleZeroWidthTester__Syms*>(userp);
    VAsTypeOfBundleZeroWidthTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
