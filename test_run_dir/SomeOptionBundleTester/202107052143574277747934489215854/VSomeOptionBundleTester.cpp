...
void VSomeOptionBundleTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/SomeOptionBundleTester/202107052143574277747934489215854/SomeOptionBundleTester.v", 1, "",
...
VL_INLINE_OPT void VSomeOptionBundleTester::_sequent__TOP__1(VSomeOptionBundleTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/SomeOptionBundleTester/202107052143574277747934489215854/SomeOptionBundleTester.v", 11, "");
        }
    }
}
