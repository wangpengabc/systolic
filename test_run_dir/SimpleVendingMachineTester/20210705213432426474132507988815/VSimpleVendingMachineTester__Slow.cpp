...
void VSimpleVendingMachineTester::_ctor_var_reset(VSimpleVendingMachineTester* self) {
    ...
    self->SimpleVendingMachineTester__DOT__dut__DOT__value = VL_RAND_RESET_I(3);
    self->SimpleVendingMachineTester__DOT__dut__DOT__doDispense = VL_RAND_RESET_I(1);
    self->SimpleVendingMachineTester__DOT__dut__DOT___value_T_1 = VL_RAND_RESET_I(3);
