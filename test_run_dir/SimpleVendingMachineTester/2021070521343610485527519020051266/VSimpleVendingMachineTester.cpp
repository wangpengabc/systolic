...
void VSimpleVendingMachineTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/SimpleVendingMachineTester/2021070521343610485527519020051266/SimpleVendingMachineTester.v", 52, "",
                                            ...
                                            & ((7U 
                                               ...
                                               & ((6U 
                                                  ...
                                                  | (5U 
                                                     == (IData)(vlTOPp->SimpleVendingMachineTester__DOT__cycle)))))))) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: SimpleVendingMachineTester.v:44: Assertion failed in %NSimpleVendingMachineTester.dut\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/SimpleVendingMachineTester/2021070521343610485527519020051266/SimpleVendingMachineTester.v", 44, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((9U == (IData)(vlTOPp->SimpleVendingMachineTester__DOT__cycle)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/SimpleVendingMachineTester/2021070521343610485527519020051266/SimpleVendingMachineTester.v", 100, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((9U == (IData)(vlTOPp->SimpleVendingMachineTester__DOT__cycle)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/SimpleVendingMachineTester/2021070521343610485527519020051266/SimpleVendingMachineTester.v", 111, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((4U == (IData)(vlTOPp->SimpleVendingMachineTester__DOT__dut__DOT__impl__DOT__state)) 
                                   == ((9U != (IData)(vlTOPp->SimpleVendingMachineTester__DOT__cycle)) 
                                       & ((8U != (IData)(vlTOPp->SimpleVendingMachineTester__DOT__cycle)) 
                                          & ((7U == (IData)(vlTOPp->SimpleVendingMachineTester__DOT__cycle)) 
                                             | ((6U 
                                             ...
                                             | ((6U 
                                                ...
                                                & ((5U 
                                                   ...
                                                   & (4U 
                                                      == (IData)(vlTOPp->SimpleVendingMachineTester__DOT__cycle)))))))) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: SimpleVendingMachineTester.v:134: Assertion failed in %NSimpleVendingMachineTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/SimpleVendingMachineTester/2021070521343610485527519020051266/SimpleVendingMachineTester.v", 134, "");
        }
    }
    __Vtableidx1 = ((((9U == (IData)(vlTOPp->SimpleVendingMachineTester__DOT__cycle)) 
                      | ((8U != (IData)(vlTOPp->SimpleVendingMachineTester__DOT__cycle)) 
                         & ((7U != (IData)(vlTOPp->SimpleVendingMachineTester__DOT__cycle)) 
                            & ((6U == (IData)(vlTOPp->SimpleVendingMachineTester__DOT__cycle)) 
                               | (5U == (IData)(vlTOPp->SimpleVendingMachineTester__DOT__cycle)))))) 
                     << 5U) | ((((9U != (IData)(vlTOPp->SimpleVendingMachineTester__DOT__cycle)) 
                                 & ((8U == (IData)(vlTOPp->SimpleVendingMachineTester__DOT__cycle)) 
                                    | ((7U != (IData)(vlTOPp->SimpleVendingMachineTester__DOT__cycle)) 
                                       & ((6U != (IData)(vlTOPp->SimpleVendingMachineTester__DOT__cycle)) 
                                          & (5U != (IData)(vlTOPp->SimpleVendingMachineTester__DOT__cycle)))))) 
                                << 4U) | (((IData)(vlTOPp->SimpleVendingMachineTester__DOT__dut__DOT__impl__DOT__state) 
                                           << 1U) | (IData)(vlTOPp->reset))));
    if (vlTOPp->__Vtablechg1[__Vtableidx1]) {
        vlTOPp->SimpleVendingMachineTester__DOT__dut__DOT__impl__DOT__state 
            = vlTOPp->__Vtable1_SimpleVendingMachineTester__DOT__dut__DOT__impl__DOT__state
            [__Vtableidx1];
    }
