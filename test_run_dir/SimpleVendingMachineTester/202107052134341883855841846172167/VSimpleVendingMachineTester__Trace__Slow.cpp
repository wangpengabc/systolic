...
void VSimpleVendingMachineTester::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+6,"SimpleVendingMachineTester dut state", false,-1, 2,0);
    }
}
...
void VSimpleVendingMachineTester::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->fullBit(oldp+1,(vlTOPp->SimpleVendingMachineTester__DOT__dut_io_nickel));
        tracep->fullBit(oldp+2,(vlTOPp->SimpleVendingMachineTester__DOT__dut_io_dime));
        tracep->fullBit(oldp+3,((4U == (IData)(vlTOPp->SimpleVendingMachineTester__DOT__dut__DOT__state))));
        ...
        tracep->fullCData(oldp+6,(vlTOPp->SimpleVendingMachineTester__DOT__dut__DOT__state),3);
