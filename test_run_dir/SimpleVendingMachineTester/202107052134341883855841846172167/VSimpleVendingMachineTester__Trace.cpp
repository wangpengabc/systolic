...
void VSimpleVendingMachineTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            tracep->chgBit(oldp+0,(vlTOPp->SimpleVendingMachineTester__DOT__dut_io_nickel));
            tracep->chgBit(oldp+1,(vlTOPp->SimpleVendingMachineTester__DOT__dut_io_dime));
            tracep->chgBit(oldp+2,((4U == (IData)(vlTOPp->SimpleVendingMachineTester__DOT__dut__DOT__state))));
            ...
            tracep->chgCData(oldp+5,(vlTOPp->SimpleVendingMachineTester__DOT__dut__DOT__state),3);
        }
