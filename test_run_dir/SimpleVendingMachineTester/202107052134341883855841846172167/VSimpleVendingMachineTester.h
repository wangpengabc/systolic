...
VL_MODULE(VSimpleVendingMachineTester) {
  public:
    ...
    CData/*0:0*/ SimpleVendingMachineTester__DOT__dut_io_nickel;
    CData/*0:0*/ SimpleVendingMachineTester__DOT__dut_io_dime;
    ...
    CData/*2:0*/ SimpleVendingMachineTester__DOT__dut__DOT__state;
    CData/*2:0*/ SimpleVendingMachineTester__DOT__dut__DOT___GEN_2;
    CData/*2:0*/ SimpleVendingMachineTester__DOT__dut__DOT___GEN_5;
    CData/*2:0*/ SimpleVendingMachineTester__DOT__dut__DOT___GEN_9;
