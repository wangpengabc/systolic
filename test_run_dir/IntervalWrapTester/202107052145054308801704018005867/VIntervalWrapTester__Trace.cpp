...
void VIntervalWrapTester::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VIntervalWrapTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VIntervalWrapTester__Syms* __restrict vlSymsp = static_cast<VIntervalWrapTester__Syms*>(userp);
    VIntervalWrapTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VIntervalWrapTester::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VIntervalWrapTester__Syms* __restrict vlSymsp = static_cast<VIntervalWrapTester__Syms*>(userp);
    VIntervalWrapTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
