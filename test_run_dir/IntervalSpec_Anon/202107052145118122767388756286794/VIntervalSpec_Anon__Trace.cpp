...
void VIntervalSpec_Anon::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VIntervalSpec_Anon::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VIntervalSpec_Anon__Syms* __restrict vlSymsp = static_cast<VIntervalSpec_Anon__Syms*>(userp);
    VIntervalSpec_Anon* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VIntervalSpec_Anon::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VIntervalSpec_Anon__Syms* __restrict vlSymsp = static_cast<VIntervalSpec_Anon__Syms*>(userp);
    VIntervalSpec_Anon* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
