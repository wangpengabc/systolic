    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgBit(oldp+1,((1U & ((IData)(vlTOPp->ParameterizedVendingMachineTester__DOT___GEN_102) 
                                          >> 1U))));
            tracep->chgBit(oldp+2,((4U <= (IData)(vlTOPp->ParameterizedVendingMachineTester__DOT__dut__DOT__value))));
            ...
            tracep->chgCData(oldp+5,(vlTOPp->ParameterizedVendingMachineTester__DOT__dut__DOT__value),3);
            tracep->chgCData(oldp+6,(((2U & (IData)(vlTOPp->ParameterizedVendingMachineTester__DOT___GEN_102))
                                       ? 2U : ((1U 
