...
void VParameterizedVendingMachineTester::_ctor_var_reset(VParameterizedVendingMachineTester* self) {
    ...
    self->ParameterizedVendingMachineTester__DOT___GEN_23 = VL_RAND_RESET_I(2);
    self->ParameterizedVendingMachineTester__DOT___GEN_44 = VL_RAND_RESET_I(2);
    self->ParameterizedVendingMachineTester__DOT___GEN_65 = VL_RAND_RESET_I(2);
    self->ParameterizedVendingMachineTester__DOT___GEN_86 = VL_RAND_RESET_I(2);
    self->ParameterizedVendingMachineTester__DOT___GEN_102 = VL_RAND_RESET_I(2);
    self->ParameterizedVendingMachineTester__DOT___GEN_132 = VL_RAND_RESET_I(1);
    self->ParameterizedVendingMachineTester__DOT___GEN_159 = VL_RAND_RESET_I(1);
    self->ParameterizedVendingMachineTester__DOT___GEN_186 = VL_RAND_RESET_I(1);
