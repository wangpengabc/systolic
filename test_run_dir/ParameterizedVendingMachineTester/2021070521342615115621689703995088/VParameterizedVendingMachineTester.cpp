...
void VParameterizedVendingMachineTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/ParameterizedVendingMachineTester/2021070521342615115621689703995088/ParameterizedVendingMachineTester.v", 70, "",
...
VL_INLINE_OPT void VParameterizedVendingMachineTester::_sequent__TOP__1(VParameterizedVendingMachineTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x64U == (IData)(vlTOPp->ParameterizedVendingMachineTester__DOT__idx)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/ParameterizedVendingMachineTester/2021070521342615115621689703995088/ParameterizedVendingMachineTester.v", 240, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x64U == (IData)(vlTOPp->ParameterizedVendingMachineTester__DOT__idx)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/ParameterizedVendingMachineTester/2021070521342615115621689703995088/ParameterizedVendingMachineTester.v", 251, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((6U <= (IData)(vlTOPp->ParameterizedVendingMachineTester__DOT__dut__DOT__value)) 
                                                               ...
                                                               & ((0x5aU 
                                                                  ...
                                                                  & ((0x59U 
                                                                     ...
                                                                     & ((0x58U 
                                                                        ...
                                                                        & ((0x57U 
                                                                            == (IData)(vlTOPp->ParameterizedVendingMachineTester__DOT__idx)) 
                                                                           | (IData)(vlTOPp->ParameterizedVendingMachineTester__DOT___GEN_189))))))))))))))) 
                                  | (IData)(vlTOPp->reset)))))) {
                                                                  ...
                                                                  & ((0x59U 
                                                                     ...
                                                                     & ((0x58U 
                                                                        ...
                                                                        & ((0x57U 
                                                                           ...
                                                                           | (IData)(vlTOPp->ParameterizedVendingMachineTester__DOT___GEN_189))))))))))))))) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: ParameterizedVendingMachineTester.v:274: Assertion failed in %NParameterizedVendingMachineTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/ParameterizedVendingMachineTester/2021070521342615115621689703995088/ParameterizedVendingMachineTester.v", 274, "");
        }
    }
    if (vlTOPp->reset) {
