...
void VParameterizedVendingMachineTester::_ctor_var_reset(VParameterizedVendingMachineTester* self) {
    ...
    self->ParameterizedVendingMachineTester__DOT___GEN_184 = VL_RAND_RESET_I(1);
    self->ParameterizedVendingMachineTester__DOT__dut__DOT__value = VL_RAND_RESET_I(10);
    self->ParameterizedVendingMachineTester__DOT__dut__DOT__doDispense = VL_RAND_RESET_I(1);
    self->ParameterizedVendingMachineTester__DOT__dut__DOT___value_T_1 = VL_RAND_RESET_I(10);
