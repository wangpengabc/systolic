...
void VParameterizedVendingMachineTester::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+6,"ParameterizedVendingMachineTester dut value", false,-1, 9,0);
        tracep->declBit(c+3,"ParameterizedVendingMachineTester dut doDispense", false,-1);
        tracep->declBus(c+7,"ParameterizedVendingMachineTester dut incValue", false,-1, 9,0);
    }
}
...
void VParameterizedVendingMachineTester::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+2,((1U & ((IData)(vlTOPp->ParameterizedVendingMachineTester__DOT___GEN_102) 
                                       >> 1U))));
        tracep->fullBit(oldp+3,((0x1edU <= (IData)(vlTOPp->ParameterizedVendingMachineTester__DOT__dut__DOT__value))));
        ...
        tracep->fullSData(oldp+6,(vlTOPp->ParameterizedVendingMachineTester__DOT__dut__DOT__value),10);
        tracep->fullSData(oldp+7,(((2U & (IData)(vlTOPp->ParameterizedVendingMachineTester__DOT___GEN_102))
                                    ? 0x1dU : ((1U 
