...
void Vtest::_initial__TOP__1(Vtest__Syms* __restrict vlSymsp) {
    ...
    if (vlSymsp->_vm_contextp__->assertOn()) {
        if (VL_UNLIKELY(vlSymsp->_vm_contextp__->assertOn())) {
            ...
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/test/202107052144377261331815414981921/test.v", 4, "");
        }
    }
    VL_WRITEF("test!\n");
    VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/test/202107052144377261331815414981921/test.v", 6, "");
}
