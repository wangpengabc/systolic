...
void VThingsPassThroughTester::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+3,"ThingsPassThroughTester q_io_enq_bits", false,-1, 1,0);
        ...
        tracep->declBus(c+6,"ThingsPassThroughTester q_io_deq_bits", false,-1, 1,0);
        ...
        tracep->declBus(c+3,"ThingsPassThroughTester q io_enq_bits", false,-1, 1,0);
        ...
        tracep->declBus(c+6,"ThingsPassThroughTester q io_deq_bits", false,-1, 1,0);
        {int i; for (i=0; i<4; i++) {
                tracep->declBus(c+28+i*1,"ThingsPassThroughTester q ram", true,(i+0), 1,0);}}
        ...
        tracep->declBus(c+6,"ThingsPassThroughTester q ram_io_deq_bits_MPORT_data", false,-1, 1,0);
        tracep->declBus(c+3,"ThingsPassThroughTester q ram_MPORT_data", false,-1, 1,0);
...
void VThingsPassThroughTester::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+6,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram
                                  [vlTOPp->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value]),2);
        ...
        tracep->fullCData(oldp+28,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[0]),2);
        tracep->fullCData(oldp+29,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[1]),2);
        tracep->fullCData(oldp+30,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[2]),2);
        tracep->fullCData(oldp+31,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[3]),2);
