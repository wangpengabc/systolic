...
void VThingsPassThroughTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/ThingsPassThroughTester/202107052142083403175965118606518/ThingsPassThroughTester.v", 347, "",
...
VL_INLINE_OPT void VThingsPassThroughTester::_sequent__TOP__1(VThingsPassThroughTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (((IData)(vlTOPp->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
            ...
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/ThingsPassThroughTester/202107052142083403175965118606518/ThingsPassThroughTester.v", 505, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/ThingsPassThroughTester/202107052142083403175965118606518/ThingsPassThroughTester.v", 516, "");
        }
    }
