...
void VThingsPassThroughTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            tracep->chgBit(oldp+0,((1U & (~ (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__maybe_full)))));
            ...
            tracep->chgBit(oldp+3,((1U & ((IData)(vlTOPp->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
                                          >> 8U))));
            tracep->chgBit(oldp+4,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__maybe_full));
            ...
            tracep->chgBit(oldp+28,(((~ (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__maybe_full)) 
                                     & (0x14U > (IData)(vlTOPp->ThingsPassThroughTester__DOT__value)))));
            tracep->chgBit(oldp+29,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__do_enq));
            tracep->chgBit(oldp+30,((((IData)(vlTOPp->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
