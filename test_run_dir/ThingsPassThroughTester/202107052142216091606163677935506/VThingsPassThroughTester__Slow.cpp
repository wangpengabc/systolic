...
void VThingsPassThroughTester::_settle__TOP__2(VThingsPassThroughTester__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->ThingsPassThroughTester__DOT___T = ((~ (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__maybe_full)) 
                                                & (0x14U 
                                                   > (IData)(vlTOPp->ThingsPassThroughTester__DOT__value)));
    ...
    vlTOPp->ThingsPassThroughTester__DOT__q__DOT__do_deq 
        = (((IData)(vlTOPp->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
            >> 8U) & (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__maybe_full));
}
