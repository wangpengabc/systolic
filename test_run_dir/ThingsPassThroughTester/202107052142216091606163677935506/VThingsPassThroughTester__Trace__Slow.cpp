...
void VThingsPassThroughTester::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+32,"ThingsPassThroughTester clock", false,-1);
        tracep->declBit(c+33,"ThingsPassThroughTester reset", false,-1);
        tracep->declBit(c+32,"ThingsPassThroughTester q_clock", false,-1);
        tracep->declBit(c+33,"ThingsPassThroughTester q_reset", false,-1);
        ...
        tracep->declBit(c+32,"ThingsPassThroughTester q_io_deq_ready_prng_clock", false,-1);
        tracep->declBit(c+33,"ThingsPassThroughTester q_io_deq_ready_prng_reset", false,-1);
        ...
        tracep->declBit(c+32,"ThingsPassThroughTester q clock", false,-1);
        tracep->declBit(c+33,"ThingsPassThroughTester q reset", false,-1);
        ...
        tracep->declBit(c+34,"ThingsPassThroughTester q ram_io_deq_bits_MPORT_en", false,-1);
        tracep->declBit(c+35,"ThingsPassThroughTester q ram_io_deq_bits_MPORT_addr", false,-1);
        ...
        tracep->declBit(c+35,"ThingsPassThroughTester q ram_MPORT_addr", false,-1);
        tracep->declBit(c+34,"ThingsPassThroughTester q ram_MPORT_mask", false,-1);
        tracep->declBit(c+29,"ThingsPassThroughTester q ram_MPORT_en", false,-1);
        tracep->declBit(c+5,"ThingsPassThroughTester q maybe_full", false,-1);
        tracep->declBit(c+1,"ThingsPassThroughTester q empty", false,-1);
        tracep->declBit(c+30,"ThingsPassThroughTester q do_enq", false,-1);
        tracep->declBit(c+31,"ThingsPassThroughTester q do_deq", false,-1);
        tracep->declBit(c+32,"ThingsPassThroughTester q_io_deq_ready_prng clock", false,-1);
        tracep->declBit(c+33,"ThingsPassThroughTester q_io_deq_ready_prng reset", false,-1);
...
void VThingsPassThroughTester::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->fullBit(oldp+1,((1U & (~ (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__maybe_full)))));
        ...
        tracep->fullBit(oldp+4,((1U & ((IData)(vlTOPp->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
                                       >> 8U))));
        tracep->fullBit(oldp+5,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__maybe_full));
        ...
        tracep->fullBit(oldp+29,(((~ (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__maybe_full)) 
                                  & (0x14U > (IData)(vlTOPp->ThingsPassThroughTester__DOT__value)))));
        tracep->fullBit(oldp+30,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__do_enq));
        tracep->fullBit(oldp+31,((((IData)(vlTOPp->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
