...
void VThingsPassThroughTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/ThingsPassThroughTester/202107052142216091606163677935506/ThingsPassThroughTester.v", 325, "",
...
VL_INLINE_OPT void VThingsPassThroughTester::_sequent__TOP__1(VThingsPassThroughTester__Syms* __restrict vlSymsp) {
    ...
    VThingsPassThroughTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    CData/*2:0*/ __Vdlyvval__ThingsPassThroughTester__DOT__q__DOT__ram__v0;
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((((IData)(vlTOPp->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
                           >> 8U) & (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__maybe_full)) 
                         & (~ ((((0x13U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__value_1))
                                  ? 3U : ((0x12U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__value_1))
                                           ? 4U : (
                                                   (0x11U 
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((((IData)(vlTOPp->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
            ...
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/ThingsPassThroughTester/202107052142216091606163677935506/ThingsPassThroughTester.v", 483, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/ThingsPassThroughTester/202107052142216091606163677935506/ThingsPassThroughTester.v", 494, "");
        }
    }
    ...
    if (((~ (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__maybe_full)) 
        ...
        __Vdlyvval__ThingsPassThroughTester__DOT__q__DOT__ram__v0 
            = ((0x13U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__value))
                ? 3U : ((0x12U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__value))
                         ? 4U : ((0x11U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__value))
    ...
    if (__Vdlyvset__ThingsPassThroughTester__DOT__q__DOT__ram__v0) {
        vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[0U] 
            = __Vdlyvval__ThingsPassThroughTester__DOT__q__DOT__ram__v0;
    }
    if (vlTOPp->reset) {
        vlTOPp->ThingsPassThroughTester__DOT__value_1 = 0U;
    } else if ((((IData)(vlTOPp->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
                 >> 8U) & (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__maybe_full))) {
