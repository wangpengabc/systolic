...
void VThingsPassThroughTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+27,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[0]),4);
            tracep->chgCData(oldp+28,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[1]),4);
            tracep->chgCData(oldp+29,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[2]),4);
            tracep->chgCData(oldp+30,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[3]),4);
            tracep->chgCData(oldp+31,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0),2);
            ...
            tracep->chgCData(oldp+34,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value),2);
            tracep->chgBit(oldp+35,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__maybe_full));
            tracep->chgBit(oldp+36,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ptr_match));
            tracep->chgBit(oldp+37,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__empty));
            tracep->chgBit(oldp+38,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__full));
            tracep->chgBit(oldp+39,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__do_enq));
            tracep->chgBit(oldp+40,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__do_deq));
        }
        tracep->chgBit(oldp+41,(vlTOPp->clock));
        tracep->chgBit(oldp+42,(vlTOPp->reset));
    }
}
