...
void VThingsPassThroughTester::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+42,"ThingsPassThroughTester clock", false,-1);
        tracep->declBit(c+43,"ThingsPassThroughTester reset", false,-1);
        tracep->declBit(c+42,"ThingsPassThroughTester q_clock", false,-1);
        tracep->declBit(c+43,"ThingsPassThroughTester q_reset", false,-1);
        ...
        tracep->declBus(c+3,"ThingsPassThroughTester q_io_enq_bits", false,-1, 3,0);
        ...
        tracep->declBus(c+6,"ThingsPassThroughTester q_io_deq_bits", false,-1, 3,0);
        tracep->declBit(c+42,"ThingsPassThroughTester q_io_deq_ready_prng_clock", false,-1);
        tracep->declBit(c+43,"ThingsPassThroughTester q_io_deq_ready_prng_reset", false,-1);
        ...
        tracep->declBit(c+42,"ThingsPassThroughTester q clock", false,-1);
        tracep->declBit(c+43,"ThingsPassThroughTester q reset", false,-1);
        ...
        tracep->declBus(c+3,"ThingsPassThroughTester q io_enq_bits", false,-1, 3,0);
        ...
        tracep->declBus(c+6,"ThingsPassThroughTester q io_deq_bits", false,-1, 3,0);
        {int i; for (i=0; i<4; i++) {
                tracep->declBus(c+28+i*1,"ThingsPassThroughTester q ram", true,(i+0), 3,0);}}
        tracep->declBit(c+44,"ThingsPassThroughTester q ram_io_deq_bits_MPORT_en", false,-1);
        tracep->declBus(c+32,"ThingsPassThroughTester q ram_io_deq_bits_MPORT_addr", false,-1, 1,0);
        tracep->declBus(c+6,"ThingsPassThroughTester q ram_io_deq_bits_MPORT_data", false,-1, 3,0);
        tracep->declBus(c+3,"ThingsPassThroughTester q ram_MPORT_data", false,-1, 3,0);
        tracep->declBus(c+33,"ThingsPassThroughTester q ram_MPORT_addr", false,-1, 1,0);
        tracep->declBit(c+44,"ThingsPassThroughTester q ram_MPORT_mask", false,-1);
        tracep->declBit(c+34,"ThingsPassThroughTester q ram_MPORT_en", false,-1);
        tracep->declBus(c+32,"ThingsPassThroughTester q ram_io_deq_bits_MPORT_addr_pipe_0", false,-1, 1,0);
        tracep->declBus(c+33,"ThingsPassThroughTester q enq_ptr_value", false,-1, 1,0);
        tracep->declBus(c+35,"ThingsPassThroughTester q deq_ptr_value", false,-1, 1,0);
        tracep->declBit(c+36,"ThingsPassThroughTester q maybe_full", false,-1);
        tracep->declBit(c+37,"ThingsPassThroughTester q ptr_match", false,-1);
        tracep->declBit(c+38,"ThingsPassThroughTester q empty", false,-1);
        tracep->declBit(c+39,"ThingsPassThroughTester q full", false,-1);
        tracep->declBit(c+40,"ThingsPassThroughTester q do_enq", false,-1);
        tracep->declBit(c+41,"ThingsPassThroughTester q do_deq", false,-1);
        tracep->declBit(c+42,"ThingsPassThroughTester q_io_deq_ready_prng clock", false,-1);
        tracep->declBit(c+43,"ThingsPassThroughTester q_io_deq_ready_prng reset", false,-1);
...
void VThingsPassThroughTester::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+6,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram
                                  [vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0]),4);
        ...
        tracep->fullCData(oldp+28,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[0]),4);
        tracep->fullCData(oldp+29,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[1]),4);
        tracep->fullCData(oldp+30,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[2]),4);
        tracep->fullCData(oldp+31,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[3]),4);
        tracep->fullCData(oldp+32,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0),2);
        ...
        tracep->fullCData(oldp+35,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value),2);
        tracep->fullBit(oldp+36,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__maybe_full));
        tracep->fullBit(oldp+37,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ptr_match));
        tracep->fullBit(oldp+38,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__empty));
        tracep->fullBit(oldp+39,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__full));
        tracep->fullBit(oldp+40,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__do_enq));
        tracep->fullBit(oldp+41,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__do_deq));
        tracep->fullBit(oldp+42,(vlTOPp->clock));
        tracep->fullBit(oldp+43,(vlTOPp->reset));
