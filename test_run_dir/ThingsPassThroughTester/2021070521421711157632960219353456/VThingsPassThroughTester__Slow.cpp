...
void VThingsPassThroughTester::_ctor_var_reset(VThingsPassThroughTester* self) {
    ...
    for (int __Vi0=0; __Vi0<4; ++__Vi0) {
        self->ThingsPassThroughTester__DOT__q__DOT__ram[__Vi0] = VL_RAND_RESET_I(4);
    }
    self->ThingsPassThroughTester__DOT__q__DOT__ram_io_deq_bits_MPORT_addr_pipe_0 = VL_RAND_RESET_I(2);
