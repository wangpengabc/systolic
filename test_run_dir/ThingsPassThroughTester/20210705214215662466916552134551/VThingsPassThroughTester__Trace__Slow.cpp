...
void VThingsPassThroughTester::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+31,"ThingsPassThroughTester q ram_io_deq_bits_MPORT_addr", false,-1, 1,0);
        ...
        tracep->declBus(c+32,"ThingsPassThroughTester q ram_MPORT_addr", false,-1, 1,0);
        tracep->declBit(c+44,"ThingsPassThroughTester q ram_MPORT_mask", false,-1);
        tracep->declBit(c+33,"ThingsPassThroughTester q ram_MPORT_en", false,-1);
        tracep->declBus(c+32,"ThingsPassThroughTester q enq_ptr_value", false,-1, 1,0);
        tracep->declBus(c+31,"ThingsPassThroughTester q deq_ptr_value", false,-1, 1,0);
        tracep->declBit(c+34,"ThingsPassThroughTester q maybe_full", false,-1);
        tracep->declBit(c+35,"ThingsPassThroughTester q ptr_match", false,-1);
        tracep->declBit(c+36,"ThingsPassThroughTester q empty", false,-1);
        tracep->declBit(c+37,"ThingsPassThroughTester q full", false,-1);
        tracep->declBit(c+38,"ThingsPassThroughTester q do_enq", false,-1);
        tracep->declBit(c+39,"ThingsPassThroughTester q do_deq", false,-1);
        tracep->declBit(c+40,"ThingsPassThroughTester q wrap", false,-1);
        tracep->declBit(c+41,"ThingsPassThroughTester q wrap_1", false,-1);
...
void VThingsPassThroughTester::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+6,(((2U >= (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value))
        ...
        tracep->fullCData(oldp+31,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value),2);
        tracep->fullCData(oldp+32,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value),2);
        tracep->fullBit(oldp+33,(((~ (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__full)) 
                                  & (0x14U > (IData)(vlTOPp->ThingsPassThroughTester__DOT__value)))));
        tracep->fullBit(oldp+34,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__maybe_full));
        tracep->fullBit(oldp+35,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ptr_match));
        tracep->fullBit(oldp+36,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__empty));
        tracep->fullBit(oldp+37,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__full));
        tracep->fullBit(oldp+38,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__do_enq));
        tracep->fullBit(oldp+39,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__do_deq));
        tracep->fullBit(oldp+40,((2U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value))));
        tracep->fullBit(oldp+41,((2U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value))));
