...
VL_MODULE(VThingsPassThroughTester) {
  public:
    ...
    CData/*0:0*/ ThingsPassThroughTester__DOT__q__DOT__wrap;
    CData/*1:0*/ ThingsPassThroughTester__DOT__q__DOT___value_T_1;
    CData/*0:0*/ ThingsPassThroughTester__DOT__q__DOT__wrap_1;
    ...
    VlUnpacked<CData/*2:0*/, 3> ThingsPassThroughTester__DOT__q__DOT__ram;

    // LOCAL VARIABLES
    // Internals; generally not touched by application code
    CData/*2:0*/ ThingsPassThroughTester__DOT__q__DOT____Vlvbound1;
