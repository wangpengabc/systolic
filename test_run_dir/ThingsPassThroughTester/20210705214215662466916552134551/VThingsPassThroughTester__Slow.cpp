...
VThingsPassThroughTester::VThingsPassThroughTester(VerilatedContext* _vcontextp__, const char* _vcname__)
 ...
 {
    VThingsPassThroughTester__Syms* __restrict vlSymsp = __VlSymsp = new VThingsPassThroughTester__Syms(_vcontextp__, this, name());
...
void VThingsPassThroughTester::_settle__TOP__2(VThingsPassThroughTester__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->ThingsPassThroughTester__DOT__q__DOT__wrap_1 
        = (2U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value));
    ...
    vlTOPp->ThingsPassThroughTester__DOT__q__DOT__wrap 
        = (2U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value));
    ...
    vlTOPp->ThingsPassThroughTester__DOT__q__DOT__do_deq 
        = (1U & (((IData)(vlTOPp->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
                  >> 1U) & (~ (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__empty))));
...
void VThingsPassThroughTester::_ctor_var_reset(VThingsPassThroughTester* self) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VThingsPassThroughTester::_ctor_var_reset\n"); );
    // Body
    if (false && self) {}  // Prevent unused
    self->clock = VL_RAND_RESET_I(1);
    self->reset = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__value = VL_RAND_RESET_I(5);
    self->ThingsPassThroughTester__DOT__value_1 = VL_RAND_RESET_I(5);
    self->ThingsPassThroughTester__DOT___q_io_deq_ready_T = VL_RAND_RESET_I(16);
    self->ThingsPassThroughTester__DOT___T = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__wrap = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT___value_T_1 = VL_RAND_RESET_I(5);
    self->ThingsPassThroughTester__DOT__wrap_1 = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT___value_T_3 = VL_RAND_RESET_I(5);
    for (int __Vi0=0; __Vi0<3; ++__Vi0) {
        self->ThingsPassThroughTester__DOT__q__DOT__ram[__Vi0] = VL_RAND_RESET_I(3);
    }
    self->ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value = VL_RAND_RESET_I(2);
    self->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value = VL_RAND_RESET_I(2);
    self->ThingsPassThroughTester__DOT__q__DOT__maybe_full = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q__DOT__ptr_match = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q__DOT__empty = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q__DOT__full = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q__DOT__do_enq = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q__DOT__do_deq = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q__DOT__wrap = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q__DOT___value_T_1 = VL_RAND_RESET_I(2);
    self->ThingsPassThroughTester__DOT__q__DOT__wrap_1 = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q__DOT___value_T_3 = VL_RAND_RESET_I(2);
    self->ThingsPassThroughTester__DOT__q__DOT____Vlvbound1 = VL_RAND_RESET_I(3);
    self->ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_0 = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_1 = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_2 = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_3 = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_4 = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_5 = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_6 = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_7 = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_8 = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_9 = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_10 = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_11 = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_12 = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_13 = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_14 = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_15 = VL_RAND_RESET_I(1);
