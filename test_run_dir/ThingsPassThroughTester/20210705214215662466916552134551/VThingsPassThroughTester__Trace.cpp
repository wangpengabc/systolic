...
void VThingsPassThroughTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+5,(((2U >= (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value))
            ...
            tracep->chgCData(oldp+30,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value),2);
            tracep->chgCData(oldp+31,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value),2);
            tracep->chgBit(oldp+32,(((~ (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__full)) 
                                     & (0x14U > (IData)(vlTOPp->ThingsPassThroughTester__DOT__value)))));
            tracep->chgBit(oldp+33,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__maybe_full));
            tracep->chgBit(oldp+34,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ptr_match));
            tracep->chgBit(oldp+35,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__empty));
            tracep->chgBit(oldp+36,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__full));
            tracep->chgBit(oldp+37,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__do_enq));
            tracep->chgBit(oldp+38,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__do_deq));
            tracep->chgBit(oldp+39,((2U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value))));
            tracep->chgBit(oldp+40,((2U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value))));
        }
