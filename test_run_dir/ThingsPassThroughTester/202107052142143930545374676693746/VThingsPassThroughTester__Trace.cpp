...
void VThingsPassThroughTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+27,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[0]),2);
            tracep->chgCData(oldp+28,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[1]),2);
            tracep->chgCData(oldp+29,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[2]),2);
            tracep->chgCData(oldp+30,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[3]),2);
