...
void VThingsPassThroughTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/ThingsPassThroughTester/202107052142104824842466292516130/ThingsPassThroughTester.v", 345, "",
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & ((((IData)(vlTOPp->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
                               ...
                               & (~ ((((0x13U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__value_1)) 
                                      ...
                                      [vlTOPp->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value]) 
                                     | (IData)(vlTOPp->reset))))))) {
            VL_WRITEF("[%0t] %%Error: ThingsPassThroughTester.v:482: Assertion failed in %NThingsPassThroughTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/ThingsPassThroughTester/202107052142104824842466292516130/ThingsPassThroughTester.v", 482, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/ThingsPassThroughTester/202107052142104824842466292516130/ThingsPassThroughTester.v", 493, "");
        }
    }
