...
void VThingsPassThroughTester::_ctor_var_reset(VThingsPassThroughTester* self) {
    ...
    for (int __Vi0=0; __Vi0<2; ++__Vi0) {
        self->ThingsPassThroughTester__DOT__q__DOT__ram[__Vi0] = VL_RAND_RESET_I(1);
    }
    self->ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value = VL_RAND_RESET_I(1);
    self->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value = VL_RAND_RESET_I(1);
