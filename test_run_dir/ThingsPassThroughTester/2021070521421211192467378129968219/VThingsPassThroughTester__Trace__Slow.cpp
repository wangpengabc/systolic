...
void VThingsPassThroughTester::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+39,"ThingsPassThroughTester clock", false,-1);
        tracep->declBit(c+40,"ThingsPassThroughTester reset", false,-1);
        tracep->declBit(c+39,"ThingsPassThroughTester q_clock", false,-1);
        tracep->declBit(c+40,"ThingsPassThroughTester q_reset", false,-1);
        ...
        tracep->declBit(c+3,"ThingsPassThroughTester q_io_enq_bits", false,-1);
        ...
        tracep->declBit(c+6,"ThingsPassThroughTester q_io_deq_bits", false,-1);
        tracep->declBit(c+39,"ThingsPassThroughTester q_io_deq_ready_prng_clock", false,-1);
        tracep->declBit(c+40,"ThingsPassThroughTester q_io_deq_ready_prng_reset", false,-1);
        ...
        tracep->declBit(c+39,"ThingsPassThroughTester q clock", false,-1);
        tracep->declBit(c+40,"ThingsPassThroughTester q reset", false,-1);
        ...
        tracep->declBit(c+3,"ThingsPassThroughTester q io_enq_bits", false,-1);
        ...
        tracep->declBit(c+6,"ThingsPassThroughTester q io_deq_bits", false,-1);
        {int i; for (i=0; i<2; i++) {
                tracep->declBit(c+28+i*1,"ThingsPassThroughTester q ram", true,(i+0));}}
        tracep->declBit(c+41,"ThingsPassThroughTester q ram_io_deq_bits_MPORT_en", false,-1);
        tracep->declBit(c+30,"ThingsPassThroughTester q ram_io_deq_bits_MPORT_addr", false,-1);
        tracep->declBit(c+6,"ThingsPassThroughTester q ram_io_deq_bits_MPORT_data", false,-1);
        tracep->declBit(c+3,"ThingsPassThroughTester q ram_MPORT_data", false,-1);
        tracep->declBit(c+31,"ThingsPassThroughTester q ram_MPORT_addr", false,-1);
        tracep->declBit(c+41,"ThingsPassThroughTester q ram_MPORT_mask", false,-1);
        tracep->declBit(c+32,"ThingsPassThroughTester q ram_MPORT_en", false,-1);
        tracep->declBit(c+31,"ThingsPassThroughTester q enq_ptr_value", false,-1);
        tracep->declBit(c+30,"ThingsPassThroughTester q deq_ptr_value", false,-1);
        tracep->declBit(c+33,"ThingsPassThroughTester q maybe_full", false,-1);
        tracep->declBit(c+34,"ThingsPassThroughTester q ptr_match", false,-1);
        tracep->declBit(c+35,"ThingsPassThroughTester q empty", false,-1);
        tracep->declBit(c+36,"ThingsPassThroughTester q full", false,-1);
        tracep->declBit(c+37,"ThingsPassThroughTester q do_enq", false,-1);
        tracep->declBit(c+38,"ThingsPassThroughTester q do_deq", false,-1);
        tracep->declBit(c+39,"ThingsPassThroughTester q_io_deq_ready_prng clock", false,-1);
        tracep->declBit(c+40,"ThingsPassThroughTester q_io_deq_ready_prng reset", false,-1);
...
void VThingsPassThroughTester::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+3,(((0x13U != (IData)(vlTOPp->ThingsPassThroughTester__DOT__value)) 
        ...
        tracep->fullBit(oldp+6,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram
        ...
        tracep->fullBit(oldp+28,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[0]));
        tracep->fullBit(oldp+29,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ram[1]));
        tracep->fullBit(oldp+30,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value));
        tracep->fullBit(oldp+31,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value));
        tracep->fullBit(oldp+32,(((~ (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__full)) 
                                  & (0x14U > (IData)(vlTOPp->ThingsPassThroughTester__DOT__value)))));
        tracep->fullBit(oldp+33,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__maybe_full));
        tracep->fullBit(oldp+34,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__ptr_match));
        tracep->fullBit(oldp+35,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__empty));
        tracep->fullBit(oldp+36,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__full));
        tracep->fullBit(oldp+37,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__do_enq));
        tracep->fullBit(oldp+38,(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__do_deq));
        tracep->fullBit(oldp+39,(vlTOPp->clock));
