...
void VThingsPassThroughTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/ThingsPassThroughTester/2021070521421211192467378129968219/ThingsPassThroughTester.v", 345, "",
...
VL_INLINE_OPT void VThingsPassThroughTester::_sequent__TOP__1(VThingsPassThroughTester__Syms* __restrict vlSymsp) {
    ...
    VThingsPassThroughTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    CData/*0:0*/ __Vdly__ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value;
    CData/*0:0*/ __Vdlyvdim0__ThingsPassThroughTester__DOT__q__DOT__ram__v0;
    ...
    CData/*0:0*/ __Vdly__ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value;
    ...
    __Vdly__ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value 
        = vlTOPp->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value;
    __Vdly__ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value 
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & ((((IData)(vlTOPp->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
                               ...
                               & (~ ((((0x13U != (IData)(vlTOPp->ThingsPassThroughTester__DOT__value_1)) 
                                       & ((0x12U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__value_1)) 
                                          | ((0x11U 
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & ((((IData)(vlTOPp->ThingsPassThroughTester__DOT___q_io_deq_ready_T) 
                               ...
                               & (~ ((((0x13U != (IData)(vlTOPp->ThingsPassThroughTester__DOT__value_1)) 
                                      ...
                                      [vlTOPp->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value]) 
                                     | (IData)(vlTOPp->reset))))))) {
            VL_WRITEF("[%0t] %%Error: ThingsPassThroughTester.v:483: Assertion failed in %NThingsPassThroughTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/ThingsPassThroughTester/2021070521421211192467378129968219/ThingsPassThroughTester.v", 483, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->ThingsPassThroughTester__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/ThingsPassThroughTester/2021070521421211192467378129968219/ThingsPassThroughTester.v", 494, "");
        }
    }
    ...
    if (vlTOPp->reset) {
        __Vdly__ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value = 0U;
    } else if (vlTOPp->ThingsPassThroughTester__DOT__q__DOT__do_deq) {
        __Vdly__ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value 
            = (1U & ((IData)(1U) + (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__deq_ptr_value)));
    }
    if (vlTOPp->reset) {
        __Vdly__ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value = 0U;
    } else if (vlTOPp->ThingsPassThroughTester__DOT__q__DOT__do_enq) {
        __Vdly__ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value 
            = (1U & ((IData)(1U) + (IData)(vlTOPp->ThingsPassThroughTester__DOT__q__DOT__enq_ptr_value)));
    }
    __Vdly__ThingsPassThroughTester__DOT__q_io_deq_ready_prng__DOT__state_0 
