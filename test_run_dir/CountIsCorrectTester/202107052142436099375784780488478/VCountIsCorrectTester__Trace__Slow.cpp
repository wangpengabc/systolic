...
void VCountIsCorrectTester::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+5,"CountIsCorrectTester q_io_count", false,-1, 2,0);
        ...
        tracep->declBus(c+5,"CountIsCorrectTester q io_count", false,-1, 2,0);
        ...
        tracep->declBus(c+35,"CountIsCorrectTester q ptr_diff", false,-1, 1,0);
...
void VCountIsCorrectTester::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+35,((3U & ((IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__enq_ptr_value) 
