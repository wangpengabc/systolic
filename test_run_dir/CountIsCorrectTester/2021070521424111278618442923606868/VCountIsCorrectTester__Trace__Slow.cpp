...
void VCountIsCorrectTester::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+36,"CountIsCorrectTester clock", false,-1);
        tracep->declBit(c+37,"CountIsCorrectTester reset", false,-1);
        tracep->declBit(c+36,"CountIsCorrectTester q_clock", false,-1);
        tracep->declBit(c+37,"CountIsCorrectTester q_reset", false,-1);
        ...
        tracep->declBit(c+36,"CountIsCorrectTester q_io_deq_ready_prng_clock", false,-1);
        tracep->declBit(c+37,"CountIsCorrectTester q_io_deq_ready_prng_reset", false,-1);
        ...
        tracep->declBit(c+36,"CountIsCorrectTester q clock", false,-1);
        tracep->declBit(c+37,"CountIsCorrectTester q reset", false,-1);
        ...
        tracep->declBit(c+27,"CountIsCorrectTester q enq_ptr_value", false,-1);
        tracep->declBit(c+28,"CountIsCorrectTester q deq_ptr_value", false,-1);
        ...
        tracep->declBit(c+35,"CountIsCorrectTester q ptr_diff", false,-1);
        tracep->declBit(c+36,"CountIsCorrectTester q_io_deq_ready_prng clock", false,-1);
        tracep->declBit(c+37,"CountIsCorrectTester q_io_deq_ready_prng reset", false,-1);
...
void VCountIsCorrectTester::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+5,(((((IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__maybe_full) 
        ...
        tracep->fullBit(oldp+27,(vlTOPp->CountIsCorrectTester__DOT__q__DOT__enq_ptr_value));
        tracep->fullBit(oldp+28,(vlTOPp->CountIsCorrectTester__DOT__q__DOT__deq_ptr_value));
        ...
        tracep->fullBit(oldp+33,(((~ (IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__full)) 
                                  & (0x14U > (IData)(vlTOPp->CountIsCorrectTester__DOT__value)))));
        tracep->fullBit(oldp+34,((1U & (((IData)(vlTOPp->CountIsCorrectTester__DOT___q_io_deq_ready_T) 
                                         >> 0xbU) & 
                                        (~ (IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__empty))))));
        tracep->fullBit(oldp+35,((1U & ((IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__enq_ptr_value) 
