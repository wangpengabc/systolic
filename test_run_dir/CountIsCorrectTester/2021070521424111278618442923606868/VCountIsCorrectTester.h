...
#ifndef VERILATED_VCOUNTISCORRECTTESTER_H_
#define VERILATED_VCOUNTISCORRECTTESTER_H_  // guard
...
class VCountIsCorrectTester_VerilatedVcd;
...
VL_MODULE(VCountIsCorrectTester) {
  public:
    ...
    CData/*0:0*/ CountIsCorrectTester__DOT__q__DOT__enq_ptr_value;
    CData/*0:0*/ CountIsCorrectTester__DOT__q__DOT__deq_ptr_value;
    CData/*0:0*/ CountIsCorrectTester__DOT__q__DOT__maybe_full;
    CData/*0:0*/ CountIsCorrectTester__DOT__q__DOT__ptr_match;
    CData/*0:0*/ CountIsCorrectTester__DOT__q__DOT__empty;
    CData/*0:0*/ CountIsCorrectTester__DOT__q__DOT__full;
    ...
    static VlUnpacked<CData/*0:0*/, 32> __Vtable1_CountIsCorrectTester__DOT__q__DOT__enq_ptr_value;
    static VlUnpacked<CData/*0:0*/, 32> __Vtable1_CountIsCorrectTester__DOT__q__DOT__deq_ptr_value;
    static VlUnpacked<CData/*0:0*/, 32> __Vtable1_CountIsCorrectTester__DOT__q__DOT__maybe_full;
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(VCountIsCorrectTester);  ///< Copying not allowed
  public:
    /// Construct the model; called by application code
    /// If contextp is null, then the model will use the default global context
    /// If name is "", then makes a wrapper with a
    /// single model invisible with respect to DPI scope names.
    VCountIsCorrectTester(VerilatedContext* contextp, const char* name = "TOP");
    VCountIsCorrectTester(const char* name = "TOP")
      : VCountIsCorrectTester(nullptr, name) {}
  ...
  private:
    ...
    static QData _change_request_1(VCountIsCorrectTester__Syms* __restrict vlSymsp);
    static void _ctor_var_reset(VCountIsCorrectTester* self) VL_ATTR_COLD;
  public:
...
#endif  // VL_DEBUG
  public:
    static void _eval_initial(VCountIsCorrectTester__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _eval_settle(VCountIsCorrectTester__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _sequent__TOP__1(VCountIsCorrectTester__Syms* __restrict vlSymsp);
    static void _settle__TOP__2(VCountIsCorrectTester__Syms* __restrict vlSymsp) VL_ATTR_COLD;
  private:
