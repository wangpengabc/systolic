...
void VCountIsCorrectTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgBit(oldp+26,(vlTOPp->CountIsCorrectTester__DOT__q__DOT__enq_ptr_value));
            tracep->chgBit(oldp+27,(vlTOPp->CountIsCorrectTester__DOT__q__DOT__deq_ptr_value));
            ...
            tracep->chgBit(oldp+32,(((~ (IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__full)) 
                                     & (0x14U > (IData)(vlTOPp->CountIsCorrectTester__DOT__value)))));
            tracep->chgBit(oldp+33,((1U & (((IData)(vlTOPp->CountIsCorrectTester__DOT___q_io_deq_ready_T) 
                                            >> 6U) 
                                           & (~ (IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__empty))))));
            tracep->chgBit(oldp+34,((1U & ((IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__enq_ptr_value) 
