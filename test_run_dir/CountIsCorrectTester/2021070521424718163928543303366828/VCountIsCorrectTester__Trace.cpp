...
void VCountIsCorrectTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+4,((3U & ((IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__ptr_match)
            ...
            tracep->chgBit(oldp+34,((2U == (IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__enq_ptr_value))));
            tracep->chgBit(oldp+35,((2U == (IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__deq_ptr_value))));
            tracep->chgCData(oldp+36,(vlTOPp->CountIsCorrectTester__DOT__q__DOT__ptr_diff),2);
        }
