...
void VCountIsCorrectTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/CountIsCorrectTester/2021070521424513795672886328469128/CountIsCorrectTester.v", 323, "",
        ...
        if (VL_UNLIKELY((((~ (IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__full)) 
                         ...
                         & (~ ((((((IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__maybe_full) 
                                ...
                                == (0x1fU & ((IData)(vlTOPp->CountIsCorrectTester__DOT__value) 
                                             - (IData)(vlTOPp->CountIsCorrectTester__DOT__value_1)))) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: CountIsCorrectTester.v:444: Assertion failed in %NCountIsCorrectTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/CountIsCorrectTester/2021070521424513795672886328469128/CountIsCorrectTester.v", 444, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & ((((IData)(vlTOPp->CountIsCorrectTester__DOT___q_io_deq_ready_T) 
                                 >> 5U) & (~ (IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__empty))) 
                               & (~ ((((((IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__maybe_full) 
                                         & (IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__ptr_match))
                                         ? 4U : 0U) 
        ...
        if (VL_UNLIKELY((1U & ((((IData)(vlTOPp->CountIsCorrectTester__DOT___q_io_deq_ready_T) 
                               ...
                               & (~ ((((((IData)(vlTOPp->CountIsCorrectTester__DOT__q__DOT__maybe_full) 
                                      ...
                                      == (0x1fU & ((IData)(vlTOPp->CountIsCorrectTester__DOT__value) 
                                                   - (IData)(vlTOPp->CountIsCorrectTester__DOT__value_1)))) 
                                     | (IData)(vlTOPp->reset))))))) {
            VL_WRITEF("[%0t] %%Error: CountIsCorrectTester.v:467: Assertion failed in %NCountIsCorrectTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/CountIsCorrectTester/2021070521424513795672886328469128/CountIsCorrectTester.v", 467, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->CountIsCorrectTester__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/CountIsCorrectTester/2021070521424513795672886328469128/CountIsCorrectTester.v", 478, "");
        }
    }
