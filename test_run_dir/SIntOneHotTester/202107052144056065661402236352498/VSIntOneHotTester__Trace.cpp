...
void VSIntOneHotTester::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VSIntOneHotTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VSIntOneHotTester__Syms* __restrict vlSymsp = static_cast<VSIntOneHotTester__Syms*>(userp);
    VSIntOneHotTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VSIntOneHotTester::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VSIntOneHotTester__Syms* __restrict vlSymsp = static_cast<VSIntOneHotTester__Syms*>(userp);
    VSIntOneHotTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
