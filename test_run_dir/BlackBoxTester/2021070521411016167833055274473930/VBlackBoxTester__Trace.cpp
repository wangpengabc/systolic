...
void VBlackBoxTester::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VBlackBoxTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VBlackBoxTester__Syms* __restrict vlSymsp = static_cast<VBlackBoxTester__Syms*>(userp);
    VBlackBoxTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VBlackBoxTester::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VBlackBoxTester__Syms* __restrict vlSymsp = static_cast<VBlackBoxTester__Syms*>(userp);
    VBlackBoxTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
