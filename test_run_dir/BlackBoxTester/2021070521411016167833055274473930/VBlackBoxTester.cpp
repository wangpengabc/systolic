...
VerilatedContext* VBlackBoxTester::contextp() {
...
void VBlackBoxTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/BlackBoxTester/2021070521411016167833055274473930/BlackBoxTester.v", 1, "",
...
VL_INLINE_OPT void VBlackBoxTester::_sequent__TOP__1(VBlackBoxTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/BlackBoxTester/2021070521411016167833055274473930/BlackBoxTester.v", 69, "");
        }
    }
}
...
VL_INLINE_OPT QData VBlackBoxTester::_change_request_1(VBlackBoxTester__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBlackBoxTester::_change_request_1\n"); );
    VBlackBoxTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
