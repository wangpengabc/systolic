...
void VAsyncResetSpec_Anon::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+3,"AsyncResetSpec_Anon reg_x", false,-1, 15,0);
        tracep->declBus(c+4,"AsyncResetSpec_Anon reg_y", false,-1, 15,0);
        tracep->declBus(c+5,"AsyncResetSpec_Anon count", false,-1, 1,0);
        tracep->declBit(c+6,"AsyncResetSpec_Anon wrap_wrap", false,-1);
    }
}
...
void VAsyncResetSpec_Anon::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullSData(oldp+3,(vlTOPp->AsyncResetSpec_Anon__DOT__reg_x),16);
        tracep->fullSData(oldp+4,(vlTOPp->AsyncResetSpec_Anon__DOT__reg_y),16);
        tracep->fullCData(oldp+5,(vlTOPp->AsyncResetSpec_Anon__DOT__count),2);
        tracep->fullBit(oldp+6,((3U == (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__count))));
    }
}
