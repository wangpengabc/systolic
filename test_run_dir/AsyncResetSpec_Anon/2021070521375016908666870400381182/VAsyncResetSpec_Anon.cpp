...
void VAsyncResetSpec_Anon::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/AsyncResetSpec_Anon/2021070521375016908666870400381182/AsyncResetSpec_Anon.v", 1, "",
...
VL_INLINE_OPT void VAsyncResetSpec_Anon::_sequent__TOP__2(VAsyncResetSpec_Anon__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0U == (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__count)) 
                         & (~ ((0xdeadbeefU == (((IData)(vlTOPp->AsyncResetSpec_Anon__DOT__reg_x) 
                                                 << 0x10U) 
                                                | (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__reg_y))) 
                               | (IData)(vlTOPp->reset)))))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0U == (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__count)) 
                         & (~ ((0xdeadbeefU == (((IData)(vlTOPp->AsyncResetSpec_Anon__DOT__reg_x) 
                                                ...
                                                | (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__reg_y))) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: AsyncResetSpec_Anon.v:40: Assertion failed in %NAsyncResetSpec_Anon\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/AsyncResetSpec_Anon/2021070521375016908666870400381182/AsyncResetSpec_Anon.v", 40, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0U != (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__count)) 
                         & (~ ((0xbad0cad0U == (((IData)(vlTOPp->AsyncResetSpec_Anon__DOT__reg_x) 
                                                 << 0x10U) 
                                                | (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__reg_y))) 
                               | (IData)(vlTOPp->reset)))))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0U != (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__count)) 
                         & (~ ((0xbad0cad0U == (((IData)(vlTOPp->AsyncResetSpec_Anon__DOT__reg_x) 
                                                ...
                                                | (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__reg_y))) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: AsyncResetSpec_Anon.v:63: Assertion failed in %NAsyncResetSpec_Anon\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/AsyncResetSpec_Anon/2021070521375016908666870400381182/AsyncResetSpec_Anon.v", 63, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((3U == (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__count)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/AsyncResetSpec_Anon/2021070521375016908666870400381182/AsyncResetSpec_Anon.v", 74, "");
        }
    }
...
VL_INLINE_OPT void VAsyncResetSpec_Anon::_sequent__TOP__4(VAsyncResetSpec_Anon__Syms* __restrict vlSymsp) {
    ...
    // Body
    if (vlTOPp->reset) {
        vlTOPp->AsyncResetSpec_Anon__DOT__reg_x = 0xdeadU;
        vlTOPp->AsyncResetSpec_Anon__DOT__reg_y = 0xbeefU;
    } else {
        vlTOPp->AsyncResetSpec_Anon__DOT__reg_x = 0xbad0U;
        vlTOPp->AsyncResetSpec_Anon__DOT__reg_y = 0xcad0U;
    }
}
