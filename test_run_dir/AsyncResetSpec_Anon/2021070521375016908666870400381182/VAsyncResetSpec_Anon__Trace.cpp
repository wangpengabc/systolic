...
void VAsyncResetSpec_Anon::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->chgSData(oldp+2,(vlTOPp->AsyncResetSpec_Anon__DOT__reg_x),16);
        tracep->chgSData(oldp+3,(vlTOPp->AsyncResetSpec_Anon__DOT__reg_y),16);
        tracep->chgCData(oldp+4,(vlTOPp->AsyncResetSpec_Anon__DOT__count),2);
        tracep->chgBit(oldp+5,((3U == (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__count))));
    }
}
