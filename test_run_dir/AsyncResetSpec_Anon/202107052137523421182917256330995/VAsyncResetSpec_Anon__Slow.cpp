...
void VAsyncResetSpec_Anon::_ctor_var_reset(VAsyncResetSpec_Anon* self) {
    ...
    self->AsyncResetSpec_Anon__DOT__reg_0 = VL_RAND_RESET_I(8);
    self->AsyncResetSpec_Anon__DOT__reg_1 = VL_RAND_RESET_I(8);
    self->AsyncResetSpec_Anon__DOT__reg_2 = VL_RAND_RESET_I(8);
    self->AsyncResetSpec_Anon__DOT__reg_3 = VL_RAND_RESET_I(8);
