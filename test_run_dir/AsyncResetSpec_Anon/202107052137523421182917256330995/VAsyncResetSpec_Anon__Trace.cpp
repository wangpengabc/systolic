...
void VAsyncResetSpec_Anon::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            tracep->chgCData(oldp+0,(vlTOPp->AsyncResetSpec_Anon__DOT__reg_0),8);
            tracep->chgCData(oldp+1,(vlTOPp->AsyncResetSpec_Anon__DOT__reg_1),8);
            tracep->chgCData(oldp+2,(vlTOPp->AsyncResetSpec_Anon__DOT__reg_2),8);
            tracep->chgCData(oldp+3,(vlTOPp->AsyncResetSpec_Anon__DOT__reg_3),8);
        }
        tracep->chgBit(oldp+4,(vlTOPp->clock));
        tracep->chgBit(oldp+5,(vlTOPp->reset));
        tracep->chgCData(oldp+6,(vlTOPp->AsyncResetSpec_Anon__DOT__count),2);
        tracep->chgBit(oldp+7,((3U == (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__count))));
    }
}
