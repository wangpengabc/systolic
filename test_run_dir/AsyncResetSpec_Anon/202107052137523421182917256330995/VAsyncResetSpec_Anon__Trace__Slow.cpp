...
void VAsyncResetSpec_Anon::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+5,"AsyncResetSpec_Anon clock", false,-1);
        tracep->declBit(c+6,"AsyncResetSpec_Anon reset", false,-1);
        tracep->declBus(c+1,"AsyncResetSpec_Anon reg_0", false,-1, 7,0);
        tracep->declBus(c+2,"AsyncResetSpec_Anon reg_1", false,-1, 7,0);
        tracep->declBus(c+3,"AsyncResetSpec_Anon reg_2", false,-1, 7,0);
        tracep->declBus(c+4,"AsyncResetSpec_Anon reg_3", false,-1, 7,0);
        tracep->declBus(c+7,"AsyncResetSpec_Anon count", false,-1, 1,0);
        tracep->declBit(c+8,"AsyncResetSpec_Anon wrap_wrap", false,-1);
    }
}
...
void VAsyncResetSpec_Anon::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->fullCData(oldp+1,(vlTOPp->AsyncResetSpec_Anon__DOT__reg_0),8);
        tracep->fullCData(oldp+2,(vlTOPp->AsyncResetSpec_Anon__DOT__reg_1),8);
        tracep->fullCData(oldp+3,(vlTOPp->AsyncResetSpec_Anon__DOT__reg_2),8);
        tracep->fullCData(oldp+4,(vlTOPp->AsyncResetSpec_Anon__DOT__reg_3),8);
        tracep->fullBit(oldp+5,(vlTOPp->clock));
        tracep->fullBit(oldp+6,(vlTOPp->reset));
        tracep->fullCData(oldp+7,(vlTOPp->AsyncResetSpec_Anon__DOT__count),2);
        tracep->fullBit(oldp+8,((3U == (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__count))));
    }
}
