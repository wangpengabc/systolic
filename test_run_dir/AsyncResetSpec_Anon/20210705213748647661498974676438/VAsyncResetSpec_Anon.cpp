...
void VAsyncResetSpec_Anon::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/AsyncResetSpec_Anon/20210705213748647661498974676438/AsyncResetSpec_Anon.v", 1, "",
...
VL_INLINE_OPT void VAsyncResetSpec_Anon::_sequent__TOP__2(VAsyncResetSpec_Anon__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0U == (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__count)) 
                         & (~ ((0xdU == (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__reg_)) 
                               | (IData)(vlTOPp->reset)))))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0U == (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__count)) 
            ...
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/AsyncResetSpec_Anon/20210705213748647661498974676438/AsyncResetSpec_Anon.v", 36, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0U != (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__count)) 
                         & (~ ((7U == (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__reg_)) 
                               | (IData)(vlTOPp->reset)))))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0U != (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__count)) 
            ...
            VL_WRITEF("[%0t] %%Error: AsyncResetSpec_Anon.v:58: Assertion failed in %NAsyncResetSpec_Anon\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/AsyncResetSpec_Anon/20210705213748647661498974676438/AsyncResetSpec_Anon.v", 58, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((3U == (IData)(vlTOPp->AsyncResetSpec_Anon__DOT__count)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/AsyncResetSpec_Anon/20210705213748647661498974676438/AsyncResetSpec_Anon.v", 69, "");
        }
    }
