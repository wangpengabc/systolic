...
VerilatedContext* VAllSameFixedPointOneHotTester::contextp() {
    return __VlSymsp->_vm_contextp__;
}

void VAllSameFixedPointOneHotTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/AllSameFixedPointOneHotTester/202107052144084928289792304758314/AllSameFixedPointOneHotTester.v", 1, "",
...
VL_INLINE_OPT void VAllSameFixedPointOneHotTester::_sequent__TOP__1(VAllSameFixedPointOneHotTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/AllSameFixedPointOneHotTester/202107052144084928289792304758314/AllSameFixedPointOneHotTester.v", 11, "");
        }
    }
}
...
VL_INLINE_OPT QData VAllSameFixedPointOneHotTester::_change_request_1(VAllSameFixedPointOneHotTester__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VAllSameFixedPointOneHotTester::_change_request_1\n"); );
    VAllSameFixedPointOneHotTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
