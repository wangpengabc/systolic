...
void VQueueSinglePipeTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueSinglePipeTester/2021070521425317236792148357942872/QueueSinglePipeTester.v", 298, "",
...
VL_INLINE_OPT void VQueueSinglePipeTester::_sequent__TOP__1(VQueueSinglePipeTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->QueueSinglePipeTester__DOT__q_io_enq_ready) 
            ...
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueSinglePipeTester/2021070521425317236792148357942872/QueueSinglePipeTester.v", 417, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->QueueSinglePipeTester__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueSinglePipeTester/2021070521425317236792148357942872/QueueSinglePipeTester.v", 428, "");
        }
    }
