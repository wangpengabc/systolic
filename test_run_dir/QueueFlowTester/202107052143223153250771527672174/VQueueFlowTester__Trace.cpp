...
void VQueueFlowTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            tracep->chgBit(oldp+0,((1U & (~ (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__maybe_full)))));
            ...
            tracep->chgBit(oldp+4,(vlTOPp->QueueFlowTester__DOT__q__DOT__maybe_full));
            ...
            tracep->chgBit(oldp+26,(((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__maybe_full)
                                      ? (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT___do_enq_T)
                                      : ((~ ((IData)(vlTOPp->QueueFlowTester__DOT___q_io_deq_ready_T) 
                                             >> 2U)) 
                                         & (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT___do_enq_T)))));
            tracep->chgBit(oldp+27,(((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__maybe_full) 
                                     & (((IData)(vlTOPp->QueueFlowTester__DOT___q_io_deq_ready_T) 
