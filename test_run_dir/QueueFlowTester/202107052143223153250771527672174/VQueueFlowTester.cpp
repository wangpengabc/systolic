...
void VQueueFlowTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFlowTester/202107052143223153250771527672174/QueueFlowTester.v", 309, "",
...
VL_INLINE_OPT void VQueueFlowTester::_sequent__TOP__1(VQueueFlowTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (1U | (IData)(vlTOPp->reset)))))) {
            ...
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFlowTester/202107052143223153250771527672174/QueueFlowTester.v", 427, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->QueueFlowTester__DOT__q_io_deq_valid) 
            ...
            VL_WRITEF("[%0t] %%Error: QueueFlowTester.v:451: Assertion failed in %NQueueFlowTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFlowTester/202107052143223153250771527672174/QueueFlowTester.v", 451, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->QueueFlowTester__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFlowTester/202107052143223153250771527672174/QueueFlowTester.v", 462, "");
        }
    }
