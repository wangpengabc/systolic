...
void VQueueFlowTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFlowTester/202107052143354170209547369329943/QueueFlowTester.v", 332, "",
...
VL_INLINE_OPT void VQueueFlowTester::_sequent__TOP__1(VQueueFlowTester__Syms* __restrict vlSymsp) {
    ...
    VQueueFlowTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Variables
    CData/*0:0*/ __Vdly__QueueFlowTester__DOT__q__DOT__deq_ptr_value;
    CData/*0:0*/ __Vdly__QueueFlowTester__DOT__q__DOT__enq_ptr_value;
    CData/*0:0*/ __Vdly__QueueFlowTester__DOT__q_io_deq_ready_prng__DOT__state_0;
    // Body
    __Vdly__QueueFlowTester__DOT__q__DOT__enq_ptr_value 
        = vlTOPp->QueueFlowTester__DOT__q__DOT__enq_ptr_value;
    __Vdly__QueueFlowTester__DOT__q__DOT__deq_ptr_value 
        = vlTOPp->QueueFlowTester__DOT__q__DOT__deq_ptr_value;
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((~ (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__full)) 
                                   | (2U == ((((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__maybe_full) 
                                   ...
                                   | (2U == ((((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__maybe_full) 
                                             ...
                                             | (1U 
                                                & ((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__enq_ptr_value) 
                                                   - (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__deq_ptr_value)))))) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: QueueFlowTester.v:450: Assertion failed in %NQueueFlowTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFlowTester/202107052143354170209547369329943/QueueFlowTester.v", 450, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->QueueFlowTester__DOT__q_io_deq_valid) 
                                   | ((0U == ((((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__maybe_full) 
                                                & (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__ptr_match))
                                                ? 2U
                                                : 0U) 
                                              | (1U 
                                   ...
                                   | ((0U == ((((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__maybe_full) 
                                      ...
                                      & (~ ((~ (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__full)) 
                                            & (0x14U 
                                               > (IData)(vlTOPp->QueueFlowTester__DOT__value)))))) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: QueueFlowTester.v:474: Assertion failed in %NQueueFlowTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFlowTester/202107052143354170209547369329943/QueueFlowTester.v", 474, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->QueueFlowTester__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFlowTester/202107052143354170209547369329943/QueueFlowTester.v", 485, "");
        }
    }
    ...
    if (vlTOPp->reset) {
        __Vdly__QueueFlowTester__DOT__q__DOT__enq_ptr_value = 0U;
    } else if (vlTOPp->QueueFlowTester__DOT__q__DOT__do_enq) {
        __Vdly__QueueFlowTester__DOT__q__DOT__enq_ptr_value 
            = (1U & ((IData)(1U) + (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__enq_ptr_value)));
    }
    if (vlTOPp->reset) {
        __Vdly__QueueFlowTester__DOT__q__DOT__deq_ptr_value = 0U;
    } else if (vlTOPp->QueueFlowTester__DOT__q__DOT__do_deq) {
        __Vdly__QueueFlowTester__DOT__q__DOT__deq_ptr_value 
            = (1U & ((IData)(1U) + (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__deq_ptr_value)));
    }
    __Vdly__QueueFlowTester__DOT__q_io_deq_ready_prng__DOT__state_0 
