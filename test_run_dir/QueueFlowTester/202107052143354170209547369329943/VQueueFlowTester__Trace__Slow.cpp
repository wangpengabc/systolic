...
void VQueueFlowTester::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+27,"QueueFlowTester q enq_ptr_value", false,-1);
        tracep->declBit(c+28,"QueueFlowTester q deq_ptr_value", false,-1);
        ...
        tracep->declBit(c+35,"QueueFlowTester q ptr_diff", false,-1);
...
void VQueueFlowTester::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullBit(oldp+27,(vlTOPp->QueueFlowTester__DOT__q__DOT__enq_ptr_value));
        tracep->fullBit(oldp+28,(vlTOPp->QueueFlowTester__DOT__q__DOT__deq_ptr_value));
        ...
        tracep->fullBit(oldp+35,((1U & ((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__enq_ptr_value) 
