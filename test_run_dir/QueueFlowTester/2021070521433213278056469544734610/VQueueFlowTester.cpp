...
void VQueueFlowTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFlowTester/2021070521433213278056469544734610/QueueFlowTester.v", 334, "",
...
VL_INLINE_OPT void VQueueFlowTester::_sequent__TOP__1(VQueueFlowTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((~ (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__full)) 
                                   | (4U == ((((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__maybe_full) 
                                   ...
                                   | (4U == ((((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__maybe_full) 
                                             ...
                                             | (3U 
                                                & ((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__enq_ptr_value) 
                                                   - (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__deq_ptr_value)))))) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: QueueFlowTester.v:452: Assertion failed in %NQueueFlowTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFlowTester/2021070521433213278056469544734610/QueueFlowTester.v", 452, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
                                   ...
                                   | ((0U == ((((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__maybe_full) 
                                      ...
                                      & (~ ((~ (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__full)) 
                                            & (0x14U 
                                               > (IData)(vlTOPp->QueueFlowTester__DOT__value)))))) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: QueueFlowTester.v:476: Assertion failed in %NQueueFlowTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFlowTester/2021070521433213278056469544734610/QueueFlowTester.v", 476, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->QueueFlowTester__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFlowTester/2021070521433213278056469544734610/QueueFlowTester.v", 487, "");
        }
    }
