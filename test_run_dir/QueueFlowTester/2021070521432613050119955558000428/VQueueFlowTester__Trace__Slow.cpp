...
void VQueueFlowTester::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+38,"QueueFlowTester clock", false,-1);
        tracep->declBit(c+39,"QueueFlowTester reset", false,-1);
        tracep->declBit(c+38,"QueueFlowTester q_clock", false,-1);
        tracep->declBit(c+39,"QueueFlowTester q_reset", false,-1);
        ...
        tracep->declBus(c+5,"QueueFlowTester q_io_count", false,-1, 1,0);
        tracep->declBit(c+38,"QueueFlowTester q_io_deq_ready_prng_clock", false,-1);
        tracep->declBit(c+39,"QueueFlowTester q_io_deq_ready_prng_reset", false,-1);
        ...
        tracep->declBit(c+38,"QueueFlowTester q clock", false,-1);
        tracep->declBit(c+39,"QueueFlowTester q reset", false,-1);
        ...
        tracep->declBus(c+5,"QueueFlowTester q io_count", false,-1, 1,0);
        ...
        tracep->declBit(c+33,"QueueFlowTester q wrap", false,-1);
        tracep->declBit(c+34,"QueueFlowTester q do_enq", false,-1);
        tracep->declBit(c+35,"QueueFlowTester q wrap_1", false,-1);
        tracep->declBit(c+36,"QueueFlowTester q do_deq", false,-1);
        tracep->declBus(c+37,"QueueFlowTester q ptr_diff", false,-1, 1,0);
        tracep->declBit(c+38,"QueueFlowTester q_io_deq_ready_prng clock", false,-1);
        tracep->declBit(c+39,"QueueFlowTester q_io_deq_ready_prng reset", false,-1);
...
void VQueueFlowTester::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+5,((3U & ((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__ptr_match)
                                          ...
                                          : (((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__deq_ptr_value) 
                                              ...
                                              : (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__ptr_diff))))),2);
        ...
        tracep->fullBit(oldp+33,((2U == (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__enq_ptr_value))));
        tracep->fullBit(oldp+34,(vlTOPp->QueueFlowTester__DOT__q__DOT__do_enq));
        tracep->fullBit(oldp+35,((2U == (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__deq_ptr_value))));
        tracep->fullBit(oldp+36,(vlTOPp->QueueFlowTester__DOT__q__DOT__do_deq));
        tracep->fullCData(oldp+37,(vlTOPp->QueueFlowTester__DOT__q__DOT__ptr_diff),2);
