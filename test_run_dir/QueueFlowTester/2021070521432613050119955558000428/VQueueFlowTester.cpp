...
void VQueueFlowTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFlowTester/2021070521432613050119955558000428/QueueFlowTester.v", 345, "",
...
VL_INLINE_OPT void VQueueFlowTester::_sequent__TOP__1(VQueueFlowTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((~ (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__full)) 
                                   | (3U == (3U & ((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__ptr_match)
                                                    ? 
                                                   ...
                                                   (((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__deq_ptr_value) 
                                                     ...
                                                     ? 
                                                    ((IData)(3U) 
                                                     + (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__ptr_diff))
                                                     : (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__ptr_diff)))))) 
                                  | (IData)(vlTOPp->reset)))))) {
                                   ...
                                   | (3U == (3U & ((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__ptr_match)
                                                   ...
                                                   (((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__deq_ptr_value) 
                                                    ...
                                                    ((IData)(3U) 
                                                     ...
                                                     : (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__ptr_diff)))))) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: QueueFlowTester.v:463: Assertion failed in %NQueueFlowTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFlowTester/2021070521432613050119955558000428/QueueFlowTester.v", 463, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
                                   ...
                                   | ((0U == (3U & 
                                      ...
                                      & (~ ((~ (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__full)) 
                                            & (0x14U 
                                               > (IData)(vlTOPp->QueueFlowTester__DOT__value)))))) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: QueueFlowTester.v:487: Assertion failed in %NQueueFlowTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFlowTester/2021070521432613050119955558000428/QueueFlowTester.v", 487, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->QueueFlowTester__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueFlowTester/2021070521432613050119955558000428/QueueFlowTester.v", 498, "");
        }
    }
    ...
    if (vlTOPp->reset) {
        vlTOPp->QueueFlowTester__DOT__q__DOT__deq_ptr_value = 0U;
    } else if (vlTOPp->QueueFlowTester__DOT__q__DOT__do_deq) {
        vlTOPp->QueueFlowTester__DOT__q__DOT__deq_ptr_value 
            = ((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__wrap_1)
                ? 0U : (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT___value_T_3));
    }
    if (vlTOPp->reset) {
        vlTOPp->QueueFlowTester__DOT__q__DOT__enq_ptr_value = 0U;
    } else if (vlTOPp->QueueFlowTester__DOT__q__DOT__do_enq) {
        vlTOPp->QueueFlowTester__DOT__q__DOT__enq_ptr_value 
            = ((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__wrap)
                ? 0U : (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT___value_T_1));
    }
