...
void VQueueFlowTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+4,((3U & ((IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__ptr_match)
            ...
            tracep->chgCData(oldp+26,(vlTOPp->QueueFlowTester__DOT__q__DOT__enq_ptr_value),2);
            tracep->chgCData(oldp+27,(vlTOPp->QueueFlowTester__DOT__q__DOT__deq_ptr_value),2);
            ...
            tracep->chgBit(oldp+32,((2U == (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__enq_ptr_value))));
            tracep->chgBit(oldp+33,(vlTOPp->QueueFlowTester__DOT__q__DOT__do_enq));
            tracep->chgBit(oldp+34,((2U == (IData)(vlTOPp->QueueFlowTester__DOT__q__DOT__deq_ptr_value))));
            tracep->chgBit(oldp+35,(vlTOPp->QueueFlowTester__DOT__q__DOT__do_deq));
            tracep->chgCData(oldp+36,(vlTOPp->QueueFlowTester__DOT__q__DOT__ptr_diff),2);
        }
