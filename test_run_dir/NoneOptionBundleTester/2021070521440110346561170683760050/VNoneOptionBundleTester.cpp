...
VerilatedContext* VNoneOptionBundleTester::contextp() {
    return __VlSymsp->_vm_contextp__;
}

void VNoneOptionBundleTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/NoneOptionBundleTester/2021070521440110346561170683760050/NoneOptionBundleTester.v", 1, "",
...
VL_INLINE_OPT void VNoneOptionBundleTester::_sequent__TOP__1(VNoneOptionBundleTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/NoneOptionBundleTester/2021070521440110346561170683760050/NoneOptionBundleTester.v", 11, "");
        }
    }
}
...
VL_INLINE_OPT QData VNoneOptionBundleTester::_change_request_1(VNoneOptionBundleTester__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VNoneOptionBundleTester::_change_request_1\n"); );
    VNoneOptionBundleTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
