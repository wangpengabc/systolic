...
void VMixedVecConnectWithSeqTester::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VMixedVecConnectWithSeqTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VMixedVecConnectWithSeqTester__Syms* __restrict vlSymsp = static_cast<VMixedVecConnectWithSeqTester__Syms*>(userp);
    VMixedVecConnectWithSeqTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VMixedVecConnectWithSeqTester::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VMixedVecConnectWithSeqTester__Syms* __restrict vlSymsp = static_cast<VMixedVecConnectWithSeqTester__Syms*>(userp);
    VMixedVecConnectWithSeqTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
