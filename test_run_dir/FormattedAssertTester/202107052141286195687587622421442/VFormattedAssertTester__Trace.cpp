...
void VFormattedAssertTester::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VFormattedAssertTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VFormattedAssertTester__Syms* __restrict vlSymsp = static_cast<VFormattedAssertTester__Syms*>(userp);
    VFormattedAssertTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VFormattedAssertTester::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VFormattedAssertTester__Syms* __restrict vlSymsp = static_cast<VFormattedAssertTester__Syms*>(userp);
    VFormattedAssertTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
