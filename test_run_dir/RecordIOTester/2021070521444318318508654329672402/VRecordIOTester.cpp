...
VerilatedContext* VRecordIOTester::contextp() {
...
void VRecordIOTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/RecordIOTester/2021070521444318318508654329672402/RecordIOTester.v", 1, "",
...
VL_INLINE_OPT void VRecordIOTester::_sequent__TOP__1(VRecordIOTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/RecordIOTester/2021070521444318318508654329672402/RecordIOTester.v", 11, "");
        }
    }
}
...
VL_INLINE_OPT QData VRecordIOTester::_change_request_1(VRecordIOTester__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VRecordIOTester::_change_request_1\n"); );
    VRecordIOTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
