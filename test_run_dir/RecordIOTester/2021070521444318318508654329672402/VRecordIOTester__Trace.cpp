...
void VRecordIOTester::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VRecordIOTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VRecordIOTester__Syms* __restrict vlSymsp = static_cast<VRecordIOTester__Syms*>(userp);
    VRecordIOTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VRecordIOTester::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VRecordIOTester__Syms* __restrict vlSymsp = static_cast<VRecordIOTester__Syms*>(userp);
    VRecordIOTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
