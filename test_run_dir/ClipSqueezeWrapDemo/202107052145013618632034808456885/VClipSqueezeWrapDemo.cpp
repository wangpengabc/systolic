...
void VClipSqueezeWrapDemo::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/ClipSqueezeWrapDemo/202107052145013618632034808456885/ClipSqueezeWrapDemo.v", 1, "",
...
VL_INLINE_OPT void VClipSqueezeWrapDemo::_sequent__TOP__1(VClipSqueezeWrapDemo__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((VL_LTS_III(1,5,5, 0xaU, (IData)(vlTOPp->ClipSqueezeWrapDemo__DOT__counter)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/ClipSqueezeWrapDemo/202107052145013618632034808456885/ClipSqueezeWrapDemo.v", 32, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x1cU == (IData)(vlTOPp->ClipSqueezeWrapDemo__DOT__counter)) 
                         & (~ (IData)(vlTOPp->reset))))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
            VL_FWRITEF(0x80000002U,"       %2#       %2#          %2#         %2#\n",
                       5,vlTOPp->ClipSqueezeWrapDemo__DOT__counter,
                       4,(VL_LTS_III(1,5,5, 6U, (IData)(vlTOPp->ClipSqueezeWrapDemo__DOT__counter))
                           ? 6U : (VL_GTS_III(1,5,5, 0x1eU, (IData)(vlTOPp->ClipSqueezeWrapDemo__DOT__counter))
                                    ? 0xeU : (0xfU 
                                              & (IData)(vlTOPp->ClipSqueezeWrapDemo__DOT__counter)))),
                       4,(0xfU & (IData)(vlTOPp->ClipSqueezeWrapDemo__DOT__counter)),
                       4,(0xfU & (VL_LTS_III(1,5,5, 6U, (IData)(vlTOPp->ClipSqueezeWrapDemo__DOT__counter))
                                   ? VL_EXTENDS_II(6,5, 
                                                   (0x1fU 
                                                    & ((IData)(vlTOPp->ClipSqueezeWrapDemo__DOT__counter) 
                                                       - (IData)(9U))))
