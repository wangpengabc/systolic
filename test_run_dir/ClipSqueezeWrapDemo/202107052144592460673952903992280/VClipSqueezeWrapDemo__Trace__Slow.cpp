...
void VClipSqueezeWrapDemo::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+1,"ClipSqueezeWrapDemo counter", false,-1, 6,0);
        tracep->declBus(c+2,"ClipSqueezeWrapDemo clipped", false,-1, 5,0);
        tracep->declBus(c+3,"ClipSqueezeWrapDemo squeezed", false,-1, 5,0);
        tracep->declBus(c+4,"ClipSqueezeWrapDemo wrapped", false,-1, 5,0);
    }
}
...
void VClipSqueezeWrapDemo::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        tracep->fullCData(oldp+1,(vlTOPp->ClipSqueezeWrapDemo__DOT__counter),7);
        tracep->fullCData(oldp+2,((VL_LTS_III(1,7,7, 0x11U, (IData)(vlTOPp->ClipSqueezeWrapDemo__DOT__counter))
        ...
        tracep->fullCData(oldp+3,((0x3fU & (IData)(vlTOPp->ClipSqueezeWrapDemo__DOT__counter))),6);
        tracep->fullCData(oldp+4,((0x3fU & (VL_LTS_III(1,7,7, 0x11U, (IData)(vlTOPp->ClipSqueezeWrapDemo__DOT__counter))
                                             ? VL_EXTENDS_II(8,7, 
                                                             (0x7fU 
