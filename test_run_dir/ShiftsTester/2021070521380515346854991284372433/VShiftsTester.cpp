...
void VShiftsTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftsTester/2021070521380515346854991284372433/ShiftsTester.v", 1, "",
...
VL_INLINE_OPT void VShiftsTester::_sequent__TOP__1(VShiftsTester__Syms* __restrict vlSymsp) {
    ...
    // Body
    __Vdly__ShiftsTester__DOT__srs_3 = vlTOPp->ShiftsTester__DOT__srs_3;
    ...
    __Vdly__ShiftsTester__DOT__srs_3 = vlTOPp->ShiftsTester__DOT__srs_2;
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
                         & (~ ((0x1aU == (IData)(vlTOPp->ShiftsTester__DOT__srs_0)) 
                               | (IData)(vlTOPp->reset)))))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
            ...
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftsTester/2021070521380515346854991284372433/ShiftsTester.v", 48, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
                         & (~ ((0x19U == (IData)(vlTOPp->ShiftsTester__DOT__srs_1)) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_FWRITEF(0x80000002U,"Assertion failed\n    at Reg.scala:80 assert(data === (23 + n - 1 - index).U)\n");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
            ...
            VL_WRITEF("[%0t] %%Error: ShiftsTester.v:70: Assertion failed in %NShiftsTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftsTester/2021070521380515346854991284372433/ShiftsTester.v", 70, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
                         & (~ ((0x18U == (IData)(vlTOPp->ShiftsTester__DOT__srs_2)) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_FWRITEF(0x80000002U,"Assertion failed\n    at Reg.scala:80 assert(data === (23 + n - 1 - index).U)\n");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
            ...
            VL_WRITEF("[%0t] %%Error: ShiftsTester.v:92: Assertion failed in %NShiftsTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftsTester/2021070521380515346854991284372433/ShiftsTester.v", 92, "");
        }
    }
    vlTOPp->ShiftsTester__DOT__srs_1 = vlTOPp->ShiftsTester__DOT__srs_0;
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
                         & (~ ((0x17U == (IData)(vlTOPp->ShiftsTester__DOT__srs_3)) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_FWRITEF(0x80000002U,"Assertion failed\n    at Reg.scala:80 assert(data === (23 + n - 1 - index).U)\n");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
                         & (~ ((0x17U == (IData)(vlTOPp->ShiftsTester__DOT__srs_3)) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: ShiftsTester.v:114: Assertion failed in %NShiftsTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftsTester/2021070521380515346854991284372433/ShiftsTester.v", 114, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftsTester/2021070521380515346854991284372433/ShiftsTester.v", 125, "");
        }
    }
    vlTOPp->ShiftsTester__DOT__srs_2 = __Vdly__ShiftsTester__DOT__srs_2;
    vlTOPp->ShiftsTester__DOT__srs_3 = __Vdly__ShiftsTester__DOT__srs_3;
    vlTOPp->ShiftsTester__DOT__REG = (3U == (IData)(vlTOPp->ShiftsTester__DOT__cntVal));
    ...
    vlTOPp->ShiftsTester__DOT__cntVal = ((IData)(vlTOPp->reset)
                                          ? 0U : (IData)(vlTOPp->ShiftsTester__DOT___wrap_value_T_1));
