...
void VShiftsTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+1,(vlTOPp->ShiftsTester__DOT__srs_0),5);
            tracep->chgCData(oldp+2,(vlTOPp->ShiftsTester__DOT__srs_1),5);
            tracep->chgCData(oldp+3,(vlTOPp->ShiftsTester__DOT__srs_2),5);
            tracep->chgCData(oldp+4,(vlTOPp->ShiftsTester__DOT__srs_3),5);
