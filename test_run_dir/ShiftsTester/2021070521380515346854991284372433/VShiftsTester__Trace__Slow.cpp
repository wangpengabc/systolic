...
void VShiftsTester::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+4,"ShiftsTester srs_2", false,-1, 4,0);
        tracep->declBus(c+5,"ShiftsTester srs_3", false,-1, 4,0);
...
void VShiftsTester::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+4,(vlTOPp->ShiftsTester__DOT__srs_2),5);
        tracep->fullCData(oldp+5,(vlTOPp->ShiftsTester__DOT__srs_3),5);
