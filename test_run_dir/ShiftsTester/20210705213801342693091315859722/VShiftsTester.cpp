...
void VShiftsTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftsTester/20210705213801342693091315859722/ShiftsTester.v", 1, "",
...
VL_INLINE_OPT void VShiftsTester::_sequent__TOP__1(VShiftsTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftsTester/20210705213801342693091315859722/ShiftsTester.v", 11, "");
        }
    }
}
