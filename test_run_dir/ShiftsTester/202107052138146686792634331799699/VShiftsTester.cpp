...
void VShiftsTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftsTester/202107052138146686792634331799699/ShiftsTester.v", 1, "",
...
VL_INLINE_OPT void VShiftsTester::_sequent__TOP__1(VShiftsTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
                         & (~ ((0x18U == (IData)(vlTOPp->ShiftsTester__DOT__srs_0)) 
                               | (IData)(vlTOPp->reset)))))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
                         & (~ ((0x18U == (IData)(vlTOPp->ShiftsTester__DOT__srs_0)) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: ShiftsTester.v:42: Assertion failed in %NShiftsTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftsTester/202107052138146686792634331799699/ShiftsTester.v", 42, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
                         & (~ ((0x17U == (IData)(vlTOPp->ShiftsTester__DOT__srs_1)) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_FWRITEF(0x80000002U,"Assertion failed\n    at Reg.scala:80 assert(data === (23 + n - 1 - index).U)\n");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
                         & (~ ((0x17U == (IData)(vlTOPp->ShiftsTester__DOT__srs_1)) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: ShiftsTester.v:64: Assertion failed in %NShiftsTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftsTester/202107052138146686792634331799699/ShiftsTester.v", 64, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftsTester/202107052138146686792634331799699/ShiftsTester.v", 75, "");
        }
    }
    vlTOPp->ShiftsTester__DOT__srs_1 = vlTOPp->ShiftsTester__DOT__srs_0;
    vlTOPp->ShiftsTester__DOT__REG = vlTOPp->ShiftsTester__DOT__cntVal;
    ...
    vlTOPp->ShiftsTester__DOT___wrap_value_T_1 = (1U 
                                                  & ((IData)(1U) 
                                                     + (IData)(vlTOPp->ShiftsTester__DOT__cntVal)));
}
