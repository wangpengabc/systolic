...
void VShiftsTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftsTester/2021070521380311997744531981933268/ShiftsTester.v", 1, "",
...
VL_INLINE_OPT void VShiftsTester::_sequent__TOP__1(VShiftsTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
            ...
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftsTester/2021070521380311997744531981933268/ShiftsTester.v", 48, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
            ...
            VL_WRITEF("[%0t] %%Error: ShiftsTester.v:70: Assertion failed in %NShiftsTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftsTester/2021070521380311997744531981933268/ShiftsTester.v", 70, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
            ...
            VL_WRITEF("[%0t] %%Error: ShiftsTester.v:92: Assertion failed in %NShiftsTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftsTester/2021070521380311997744531981933268/ShiftsTester.v", 92, "");
        }
    }
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((IData)(vlTOPp->ShiftsTester__DOT__REG) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/ShiftsTester/2021070521380311997744531981933268/ShiftsTester.v", 103, "");
        }
    }
