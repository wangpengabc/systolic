...
VerilatedContext* VSimpleOneHotTester::contextp() {
...
void VSimpleOneHotTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/SimpleOneHotTester/20210705214403475965103057661657/SimpleOneHotTester.v", 1, "",
...
VL_INLINE_OPT void VSimpleOneHotTester::_sequent__TOP__1(VSimpleOneHotTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/SimpleOneHotTester/20210705214403475965103057661657/SimpleOneHotTester.v", 11, "");
        }
    }
}
...
VL_INLINE_OPT QData VSimpleOneHotTester::_change_request_1(VSimpleOneHotTester__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VSimpleOneHotTester::_change_request_1\n"); );
    VSimpleOneHotTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
