...
void VSimpleOneHotTester::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VSimpleOneHotTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VSimpleOneHotTester__Syms* __restrict vlSymsp = static_cast<VSimpleOneHotTester__Syms*>(userp);
    VSimpleOneHotTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VSimpleOneHotTester::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VSimpleOneHotTester__Syms* __restrict vlSymsp = static_cast<VSimpleOneHotTester__Syms*>(userp);
    VSimpleOneHotTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
