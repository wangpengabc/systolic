...
void VQueueReasonableReadyValid::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueReasonableReadyValid/2021070521423211759089687042703140/QueueReasonableReadyValid.v", 334, "",
...
VL_INLINE_OPT void VQueueReasonableReadyValid::_sequent__TOP__1(VQueueReasonableReadyValid__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((~ (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__full)) 
                                   | (3U == (3U & ((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__ptr_match)
                                                    ? 
                                                   ...
                                                   (((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value) 
                                                     ...
                                                     ? 
                                                    ((IData)(3U) 
                                                     + (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__ptr_diff))
                                                     : (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__ptr_diff)))))) 
                                  | (IData)(vlTOPp->reset)))))) {
                                   ...
                                   | (3U == (3U & ((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__ptr_match)
                                                   ...
                                                   (((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value) 
                                                    ...
                                                    ((IData)(3U) 
                                                     ...
                                                     : (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__ptr_diff)))))) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: QueueReasonableReadyValid.v:452: Assertion failed in %NQueueReasonableReadyValid\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueReasonableReadyValid/2021070521423211759089687042703140/QueueReasonableReadyValid.v", 452, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((~ (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__empty)) 
                                   | (0U == (3U & ((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__ptr_match)
                                                    ? 
                                                   ((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__maybe_full)
                                                     ? 3U
                                                     : 0U)
                                   ...
                                   | (0U == (3U & ((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__ptr_match)
                                                   ...
                                                   (((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value) 
                                                    ...
                                                    ((IData)(3U) 
                                                     ...
                                                     : (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__ptr_diff)))))) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: QueueReasonableReadyValid.v:475: Assertion failed in %NQueueReasonableReadyValid\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueReasonableReadyValid/2021070521423211759089687042703140/QueueReasonableReadyValid.v", 475, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->QueueReasonableReadyValid__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueReasonableReadyValid/2021070521423211759089687042703140/QueueReasonableReadyValid.v", 486, "");
        }
    }
    ...
    if (vlTOPp->reset) {
        vlTOPp->QueueReasonableReadyValid__DOT__value_1 = 0U;
                       ...
                       >> 6U) & (~ (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__empty))))) {
    ...
    if (vlTOPp->reset) {
        vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__maybe_full = 0U;
    } else if (((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__do_enq) 
                != (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__do_deq))) {
        vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__maybe_full 
            = vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__do_enq;
    }
    if (vlTOPp->reset) {
        vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value = 0U;
    } else if (vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__do_deq) {
        vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value 
            = ((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__wrap_1)
                ? 0U : (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT___value_T_3));
    }
    if (vlTOPp->reset) {
        vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value = 0U;
    } else if (vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__do_enq) {
        vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value 
            = ((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__wrap)
                ? 0U : (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT___value_T_1));
    }
    ...
    vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__wrap_1 
        = (2U == (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value));
    vlTOPp->QueueReasonableReadyValid__DOT__q__DOT___value_T_3 
        = (3U & ((IData)(1U) + (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value)));
    vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__wrap 
        = (2U == (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value));
    vlTOPp->QueueReasonableReadyValid__DOT__q__DOT___value_T_1 
        = (3U & ((IData)(1U) + (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value)));
    vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__ptr_diff 
    ...
    vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__do_deq 
        = (1U & (((IData)(vlTOPp->QueueReasonableReadyValid__DOT___q_io_deq_ready_T) 
                  >> 6U) & (~ (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__empty))));
}
