...
void VQueueReasonableReadyValid::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBit(c+38,"QueueReasonableReadyValid clock", false,-1);
        tracep->declBit(c+39,"QueueReasonableReadyValid reset", false,-1);
        tracep->declBit(c+38,"QueueReasonableReadyValid q_clock", false,-1);
        tracep->declBit(c+39,"QueueReasonableReadyValid q_reset", false,-1);
        ...
        tracep->declBit(c+38,"QueueReasonableReadyValid q_io_deq_ready_prng_clock", false,-1);
        tracep->declBit(c+39,"QueueReasonableReadyValid q_io_deq_ready_prng_reset", false,-1);
        ...
        tracep->declBit(c+38,"QueueReasonableReadyValid q clock", false,-1);
        tracep->declBit(c+39,"QueueReasonableReadyValid q reset", false,-1);
        ...
        tracep->declBus(c+27,"QueueReasonableReadyValid q enq_ptr_value", false,-1, 1,0);
        tracep->declBus(c+28,"QueueReasonableReadyValid q deq_ptr_value", false,-1, 1,0);
        ...
        tracep->declBit(c+35,"QueueReasonableReadyValid q wrap", false,-1);
        tracep->declBit(c+36,"QueueReasonableReadyValid q wrap_1", false,-1);
        tracep->declBus(c+37,"QueueReasonableReadyValid q ptr_diff", false,-1, 1,0);
        tracep->declBit(c+38,"QueueReasonableReadyValid q_io_deq_ready_prng clock", false,-1);
        tracep->declBit(c+39,"QueueReasonableReadyValid q_io_deq_ready_prng reset", false,-1);
...
void VQueueReasonableReadyValid::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+5,((3U & ((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__ptr_match)
                                          ...
                                          : (((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value) 
                                              ...
                                              : (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__ptr_diff))))),2);
        ...
        tracep->fullCData(oldp+27,(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value),2);
        tracep->fullCData(oldp+28,(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value),2);
        ...
        tracep->fullBit(oldp+33,(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__do_enq));
        tracep->fullBit(oldp+34,(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__do_deq));
        tracep->fullBit(oldp+35,((2U == (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value))));
        tracep->fullBit(oldp+36,((2U == (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value))));
        tracep->fullCData(oldp+37,(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__ptr_diff),2);
