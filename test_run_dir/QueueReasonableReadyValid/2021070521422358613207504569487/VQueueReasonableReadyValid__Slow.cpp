...
void VQueueReasonableReadyValid::_ctor_var_reset(VQueueReasonableReadyValid* self) {
    ...
    self->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value = VL_RAND_RESET_I(2);
    self->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value = VL_RAND_RESET_I(2);
    ...
    self->QueueReasonableReadyValid__DOT__q__DOT__do_enq = VL_RAND_RESET_I(1);
    self->QueueReasonableReadyValid__DOT__q__DOT__do_deq = VL_RAND_RESET_I(1);
    self->QueueReasonableReadyValid__DOT__q__DOT__wrap = VL_RAND_RESET_I(1);
    self->QueueReasonableReadyValid__DOT__q__DOT___value_T_1 = VL_RAND_RESET_I(2);
    self->QueueReasonableReadyValid__DOT__q__DOT__wrap_1 = VL_RAND_RESET_I(1);
    self->QueueReasonableReadyValid__DOT__q__DOT___value_T_3 = VL_RAND_RESET_I(2);
    self->QueueReasonableReadyValid__DOT__q__DOT__ptr_diff = VL_RAND_RESET_I(2);
