    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+4,(((((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__maybe_full) 
                                        ...
                                        ? 2U : 0U) 
                                      | (1U & ((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value) 
            ...
            tracep->chgBit(oldp+26,(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value));
            tracep->chgBit(oldp+27,(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value));
            ...
            tracep->chgBit(oldp+32,(((~ (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__full)) 
                                     & (0x14U > (IData)(vlTOPp->QueueReasonableReadyValid__DOT__value)))));
            tracep->chgBit(oldp+33,((1U & (((IData)(vlTOPp->QueueReasonableReadyValid__DOT___q_io_deq_ready_T) 
                                            >> 0xcU) 
                                           & (~ (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__empty))))));
            tracep->chgBit(oldp+34,((1U & ((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value) 
