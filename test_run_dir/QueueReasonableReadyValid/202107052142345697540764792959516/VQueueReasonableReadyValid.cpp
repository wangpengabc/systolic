...
void VQueueReasonableReadyValid::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueReasonableReadyValid/202107052142345697540764792959516/QueueReasonableReadyValid.v", 298, "",
...
VL_INLINE_OPT void VQueueReasonableReadyValid::_sequent__TOP__1(VQueueReasonableReadyValid__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (1U | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: QueueReasonableReadyValid.v:416: Assertion failed in %NQueueReasonableReadyValid\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueReasonableReadyValid/202107052142345697540764792959516/QueueReasonableReadyValid.v", 416, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (1U | (IData)(vlTOPp->reset)))))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (1U | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: QueueReasonableReadyValid.v:439: Assertion failed in %NQueueReasonableReadyValid\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueReasonableReadyValid/202107052142345697540764792959516/QueueReasonableReadyValid.v", 439, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->QueueReasonableReadyValid__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueReasonableReadyValid/202107052142345697540764792959516/QueueReasonableReadyValid.v", 450, "");
        }
    }
    ...
    } else if ((((IData)(vlTOPp->QueueReasonableReadyValid__DOT___q_io_deq_ready_T) 
    ...
    vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__do_deq 
        = (((IData)(vlTOPp->QueueReasonableReadyValid__DOT___q_io_deq_ready_T) 
            >> 0xcU) & (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__maybe_full));
}
