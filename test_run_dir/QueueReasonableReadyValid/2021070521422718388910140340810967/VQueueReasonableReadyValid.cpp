...
void VQueueReasonableReadyValid::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueReasonableReadyValid/2021070521422718388910140340810967/QueueReasonableReadyValid.v", 321, "",
...
VL_INLINE_OPT void VQueueReasonableReadyValid::_sequent__TOP__1(VQueueReasonableReadyValid__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((~ (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__full)) 
            ...
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueReasonableReadyValid/2021070521422718388910140340810967/QueueReasonableReadyValid.v", 439, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((~ (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__empty)) 
            ...
            VL_WRITEF("[%0t] %%Error: QueueReasonableReadyValid.v:462: Assertion failed in %NQueueReasonableReadyValid\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueReasonableReadyValid/2021070521422718388910140340810967/QueueReasonableReadyValid.v", 462, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->QueueReasonableReadyValid__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueReasonableReadyValid/2021070521422718388910140340810967/QueueReasonableReadyValid.v", 473, "");
        }
    }
    ...
    if (vlTOPp->reset) {
        vlTOPp->QueueReasonableReadyValid__DOT__value_1 = 0U;
                       ...
                       >> 0xaU) & (~ (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__empty))))) {
    ...
    __Vtableidx1 = (((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value) 
                     << 4U) | ((8U & (((IData)(vlTOPp->QueueReasonableReadyValid__DOT___q_io_deq_ready_T) 
                                       >> 7U) & ((~ (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__empty)) 
                                                 << 3U))) 
                               | (((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value) 
                                   << 2U) | ((((~ (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__full)) 
                                               & (0x14U 
