...
void VQueueReasonableReadyValid::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+5,"QueueReasonableReadyValid q_io_count", false,-1, 2,0);
        ...
        tracep->declBus(c+5,"QueueReasonableReadyValid q io_count", false,-1, 2,0);
        ...
        tracep->declBus(c+35,"QueueReasonableReadyValid q ptr_diff", false,-1, 1,0);
...
void VQueueReasonableReadyValid::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullCData(oldp+35,((3U & ((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value) 
