...
void VQueueReasonableReadyValid::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueReasonableReadyValid/20210705214236318766930069498717/QueueReasonableReadyValid.v", 323, "",
...
VL_INLINE_OPT void VQueueReasonableReadyValid::_sequent__TOP__1(VQueueReasonableReadyValid__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((~ (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__full)) 
                                   | (4U == ((((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__maybe_full) 
                                   ...
                                   | (4U == ((((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__maybe_full) 
                                             ...
                                             | (3U 
                                                & ((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value) 
                                                   - (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value)))))) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: QueueReasonableReadyValid.v:441: Assertion failed in %NQueueReasonableReadyValid\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueReasonableReadyValid/20210705214236318766930069498717/QueueReasonableReadyValid.v", 441, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
                                   ...
                                   | (0U == ((((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__maybe_full) 
                                             ...
                                             | (3U 
                                                & ((IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__enq_ptr_value) 
                                                   - (IData)(vlTOPp->QueueReasonableReadyValid__DOT__q__DOT__deq_ptr_value)))))) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: QueueReasonableReadyValid.v:464: Assertion failed in %NQueueReasonableReadyValid\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueReasonableReadyValid/20210705214236318766930069498717/QueueReasonableReadyValid.v", 464, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->QueueReasonableReadyValid__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/QueueReasonableReadyValid/20210705214236318766930069498717/QueueReasonableReadyValid.v", 475, "");
        }
    }
