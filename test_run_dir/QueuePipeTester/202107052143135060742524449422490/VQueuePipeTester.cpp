...
void VQueuePipeTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/QueuePipeTester/202107052143135060742524449422490/QueuePipeTester.v", 334, "",
...
VL_INLINE_OPT void VQueuePipeTester::_sequent__TOP__1(VQueuePipeTester__Syms* __restrict vlSymsp) {
        ...
        if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->QueuePipeTester__DOT__q_io_enq_ready) 
                                   | ((3U == (3U & 
                                      ...
                                      & (~ ((IData)(vlTOPp->QueuePipeTester__DOT___q_io_deq_ready_T) 
                                            >> 0xfU)))) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: QueuePipeTester.v:453: Assertion failed in %NQueuePipeTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueuePipeTester/202107052143135060742524449422490/QueuePipeTester.v", 453, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->QueuePipeTester__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/QueuePipeTester/202107052143135060742524449422490/QueuePipeTester.v", 464, "");
        }
    }
    ...
    } else if ((1U & (((IData)(vlTOPp->QueuePipeTester__DOT___q_io_deq_ready_T) 
                       >> 0xfU) & (~ (IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__empty))))) {
    ...
    if (vlTOPp->reset) {
        vlTOPp->QueuePipeTester__DOT__q__DOT__deq_ptr_value = 0U;
    } else if (vlTOPp->QueuePipeTester__DOT__q__DOT__do_deq) {
        vlTOPp->QueuePipeTester__DOT__q__DOT__deq_ptr_value 
            = ((IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__wrap_1)
                ? 0U : (IData)(vlTOPp->QueuePipeTester__DOT__q__DOT___value_T_3));
    }
    if (vlTOPp->reset) {
        vlTOPp->QueuePipeTester__DOT__q__DOT__enq_ptr_value = 0U;
    } else if (vlTOPp->QueuePipeTester__DOT__q__DOT__do_enq) {
        vlTOPp->QueuePipeTester__DOT__q__DOT__enq_ptr_value 
            = ((IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__wrap)
                ? 0U : (IData)(vlTOPp->QueuePipeTester__DOT__q__DOT___value_T_1));
    }
    ...
    vlTOPp->QueuePipeTester__DOT__q_io_enq_ready = 
        (1U & (((IData)(vlTOPp->QueuePipeTester__DOT___q_io_deq_ready_T) 
                >> 0xfU) | (~ ((IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__ptr_match) 
                               & (IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__maybe_full)))));
