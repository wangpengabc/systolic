...
void VQueuePipeTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            ...
            tracep->chgCData(oldp+4,(((((IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__maybe_full) 
            ...
            tracep->chgCData(oldp+34,((3U & ((IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__enq_ptr_value) 
