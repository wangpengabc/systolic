...
void VQueuePipeTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/QueuePipeTester/2021070521430715819304461239496951/QueuePipeTester.v", 323, "",
...
VL_INLINE_OPT void VQueuePipeTester::_sequent__TOP__1(VQueuePipeTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->QueuePipeTester__DOT__q_io_enq_ready) 
                                   | ((4U == ((((IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__maybe_full) 
        ...
        if (VL_UNLIKELY((1U & (~ (((IData)(vlTOPp->QueuePipeTester__DOT__q_io_enq_ready) 
                                   | ((4U == ((((IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__maybe_full) 
                                      ...
                                      & (~ ((IData)(vlTOPp->QueuePipeTester__DOT___q_io_deq_ready_T) 
                                            >> 0xaU)))) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: QueuePipeTester.v:442: Assertion failed in %NQueuePipeTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/QueuePipeTester/2021070521430715819304461239496951/QueuePipeTester.v", 442, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((0x14U == (IData)(vlTOPp->QueuePipeTester__DOT__value_1)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/QueuePipeTester/2021070521430715819304461239496951/QueuePipeTester.v", 453, "");
        }
    }
    ...
    if (vlTOPp->reset) {
        vlTOPp->QueuePipeTester__DOT__value_1 = 0U;
                       ...
                       >> 0xaU) & (~ (IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__empty))))) {
    ...
    vlTOPp->QueuePipeTester__DOT__q_io_enq_ready = 
        (1U & (((IData)(vlTOPp->QueuePipeTester__DOT___q_io_deq_ready_T) 
                >> 0xaU) | (~ ((IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__ptr_match) 
                               & (IData)(vlTOPp->QueuePipeTester__DOT__q__DOT__maybe_full)))));
