...
void VBundleLiteralSpec_Anon::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/BundleLiteralSpec_Anon/2021070521420111413178272605051596/BundleLiteralSpec_Anon.v", 1, "",
...
VL_INLINE_OPT void VBundleLiteralSpec_Anon::_sequent__TOP__1(VBundleLiteralSpec_Anon__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ ((0x2aU == (IData)(vlTOPp->BundleLiteralSpec_Anon__DOT__r_a)) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: BundleLiteralSpec_Anon.v:34: Assertion failed in %NBundleLiteralSpec_Anon\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/BundleLiteralSpec_Anon/2021070521420111413178272605051596/BundleLiteralSpec_Anon.v", 34, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/BundleLiteralSpec_Anon/2021070521420111413178272605051596/BundleLiteralSpec_Anon.v", 45, "");
        }
    }
    vlTOPp->BundleLiteralSpec_Anon__DOT__r_a = ((IData)(vlTOPp->reset)
                                                 ? 0x2aU
                                                 : (IData)(vlTOPp->BundleLiteralSpec_Anon__DOT___r_a_T_1));
