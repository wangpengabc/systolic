...
void VBundleLiteralSpec_Anon::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/BundleLiteralSpec_Anon/202107052141564302223557495027935/BundleLiteralSpec_Anon.v", 1, "",
...
VL_INLINE_OPT void VBundleLiteralSpec_Anon::_sequent__TOP__1(VBundleLiteralSpec_Anon__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/BundleLiteralSpec_Anon/202107052141564302223557495027935/BundleLiteralSpec_Anon.v", 11, "");
        }
    }
}
