...
void VBundleLiteralSpec_Anon::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/BundleLiteralSpec_Anon/202107052142038662958335132516428/BundleLiteralSpec_Anon.v", 1, "",
...
VL_INLINE_OPT void VBundleLiteralSpec_Anon::_sequent__TOP__1(VBundleLiteralSpec_Anon__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ ((0x2aU == (IData)(vlTOPp->BundleLiteralSpec_Anon__DOT__r)) 
                                  | (IData)(vlTOPp->reset)))))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ ((0x2aU == (IData)(vlTOPp->BundleLiteralSpec_Anon__DOT__r)) 
                                  | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: BundleLiteralSpec_Anon.v:33: Assertion failed in %NBundleLiteralSpec_Anon\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/BundleLiteralSpec_Anon/202107052142038662958335132516428/BundleLiteralSpec_Anon.v", 33, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/BundleLiteralSpec_Anon/202107052142038662958335132516428/BundleLiteralSpec_Anon.v", 44, "");
        }
    }
    vlTOPp->BundleLiteralSpec_Anon__DOT__r = ((IData)(vlTOPp->reset)
                                               ? 0x2aU
                                               : (IData)(vlTOPp->BundleLiteralSpec_Anon__DOT___r_T_1));
    vlTOPp->BundleLiteralSpec_Anon__DOT___r_T_1 = (0x3fU 
                                                   & ((IData)(1U) 
                                                      + (IData)(vlTOPp->BundleLiteralSpec_Anon__DOT__r)));
}
