...
void VBundleLiteralSpec_Anon::_ctor_var_reset(VBundleLiteralSpec_Anon* self) {
    ...
    self->BundleLiteralSpec_Anon__DOT__r_b = VL_RAND_RESET_I(1);
    self->BundleLiteralSpec_Anon__DOT__r_c = VL_RAND_RESET_I(1);
    self->BundleLiteralSpec_Anon__DOT___r_T = VL_RAND_RESET_I(10);
