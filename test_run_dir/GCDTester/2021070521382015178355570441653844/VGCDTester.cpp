...
void VGCDTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/GCDTester/2021070521382015178355570441653844/GCDTester.v", 77, "",
...
VL_INLINE_OPT void VGCDTester::_sequent__TOP__1(VGCDTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((((~ (IData)(vlTOPp->GCDTester__DOT__first)) 
            ...
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/GCDTester/2021070521382015178355570441653844/GCDTester.v", 117, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((((~ (IData)(vlTOPp->GCDTester__DOT__first)) 
                          & (0U == vlTOPp->GCDTester__DOT__dut__DOT__y)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/GCDTester/2021070521382015178355570441653844/GCDTester.v", 128, "");
        }
    }
    ...
    if (vlTOPp->GCDTester__DOT__first) {
        __Vdly__GCDTester__DOT__dut__DOT__y = 0x40U;
    } else if ((vlTOPp->GCDTester__DOT__dut__DOT__x 
                <= vlTOPp->GCDTester__DOT__dut__DOT__y)) {
