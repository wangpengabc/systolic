...
#ifndef VERILATED_VGCDTESTER_H_
#define VERILATED_VGCDTESTER_H_  // guard
...
VL_MODULE(VGCDTester) {
  public:
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(VGCDTester);  ///< Copying not allowed
  public:
    /// Construct the model; called by application code
    /// If contextp is null, then the model will use the default global context
    /// If name is "", then makes a wrapper with a
    /// single model invisible with respect to DPI scope names.
    VGCDTester(VerilatedContext* contextp, const char* name = "TOP");
    VGCDTester(const char* name = "TOP")
      : VGCDTester(nullptr, name) {}
  ...
  private:
    ...
    static QData _change_request_1(VGCDTester__Syms* __restrict vlSymsp);
    static void _ctor_var_reset(VGCDTester* self) VL_ATTR_COLD;
  public:
...
#endif  // VL_DEBUG
  public:
    static void _eval_initial(VGCDTester__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _eval_settle(VGCDTester__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _sequent__TOP__1(VGCDTester__Syms* __restrict vlSymsp);
    static void _settle__TOP__2(VGCDTester__Syms* __restrict vlSymsp) VL_ATTR_COLD;
  private:
