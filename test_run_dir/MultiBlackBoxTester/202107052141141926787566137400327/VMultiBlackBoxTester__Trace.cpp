...
void VMultiBlackBoxTester::traceChgTop0(void* userp, VerilatedVcd* tracep) {
...
void VMultiBlackBoxTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    VMultiBlackBoxTester__Syms* __restrict vlSymsp = static_cast<VMultiBlackBoxTester__Syms*>(userp);
    VMultiBlackBoxTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
...
void VMultiBlackBoxTester::traceCleanup(void* userp, VerilatedVcd* /*unused*/) {
    VMultiBlackBoxTester__Syms* __restrict vlSymsp = static_cast<VMultiBlackBoxTester__Syms*>(userp);
    VMultiBlackBoxTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    {
