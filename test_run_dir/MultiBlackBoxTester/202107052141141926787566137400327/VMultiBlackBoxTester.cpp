...
VerilatedContext* VMultiBlackBoxTester::contextp() {
...
void VMultiBlackBoxTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/MultiBlackBoxTester/202107052141141926787566137400327/MultiBlackBoxTester.v", 1, "",
...
VL_INLINE_OPT void VMultiBlackBoxTester::_sequent__TOP__1(VMultiBlackBoxTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/MultiBlackBoxTester/202107052141141926787566137400327/MultiBlackBoxTester.v", 127, "");
        }
    }
}
...
VL_INLINE_OPT QData VMultiBlackBoxTester::_change_request_1(VMultiBlackBoxTester__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMultiBlackBoxTester::_change_request_1\n"); );
    VMultiBlackBoxTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
