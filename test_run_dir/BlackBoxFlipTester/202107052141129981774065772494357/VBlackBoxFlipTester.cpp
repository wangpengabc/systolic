...
VerilatedContext* VBlackBoxFlipTester::contextp() {
...
void VBlackBoxFlipTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/BlackBoxFlipTester/202107052141129981774065772494357/BlackBoxFlipTester.v", 1, "",
...
VL_INLINE_OPT void VBlackBoxFlipTester::_sequent__TOP__1(VBlackBoxFlipTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((1U & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/BlackBoxFlipTester/202107052141129981774065772494357/BlackBoxFlipTester.v", 40, "");
        }
    }
}
...
VL_INLINE_OPT QData VBlackBoxFlipTester::_change_request_1(VBlackBoxFlipTester__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBlackBoxFlipTester::_change_request_1\n"); );
    VBlackBoxFlipTester* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    // Change detection
