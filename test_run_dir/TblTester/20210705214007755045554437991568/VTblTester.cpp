...
void VTblTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/TblTester/20210705214007755045554437991568/TblTester.v", 79, "",
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((((0U < (IData)(vlTOPp->TblTester__DOT__cnt)) 
                          & (((7U == (7U & ((IData)(vlTOPp->TblTester__DOT__cnt) 
                                            - (IData)(1U))))
                               ? 0U : (IData)(vlTOPp->TblTester__DOT___GEN_16)) 
                             == ((7U == (IData)(vlTOPp->TblTester__DOT__cnt))
                                  ? 0U : (IData)(vlTOPp->TblTester__DOT___GEN_8)))) 
                         & (~ (((((IData)(vlTOPp->TblTester__DOT__dut_io_ri) 
                                ...
                                == ((7U == (IData)(vlTOPp->TblTester__DOT__cnt))
                                     ? 2U : (IData)(vlTOPp->TblTester__DOT___GEN_24))) 
                               | (IData)(vlTOPp->reset)))))) {
        ...
        if (VL_UNLIKELY((((0U < (IData)(vlTOPp->TblTester__DOT__cnt)) 
                         ...
                         & (~ (((((IData)(vlTOPp->TblTester__DOT__dut_io_ri) 
                                ...
                                == ((7U == (IData)(vlTOPp->TblTester__DOT__cnt))
                                     ? 2U : (IData)(vlTOPp->TblTester__DOT___GEN_24))) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: TblTester.v:152: Assertion failed in %NTblTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/TblTester/20210705214007755045554437991568/TblTester.v", 152, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((((0U < (IData)(vlTOPp->TblTester__DOT__cnt)) 
                                     ...
                                     ? 2U : ((6U == 
                                             ...
                                             ((5U == 
                                               ...
                                               : ((4U 
                                                   ...
                                                   : 2U))))) 
                               | (IData)(vlTOPp->reset)))))) {
            VL_WRITEF("[%0t] %%Error: TblTester.v:174: Assertion failed in %NTblTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/TblTester/20210705214007755045554437991568/TblTester.v", 174, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((7U == (IData)(vlTOPp->TblTester__DOT__cnt)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/TblTester/20210705214007755045554437991568/TblTester.v", 185, "");
        }
    }
