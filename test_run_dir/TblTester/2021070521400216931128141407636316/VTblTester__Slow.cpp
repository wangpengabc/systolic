...
void VTblTester::_ctor_var_reset(VTblTester* self) {
    ...
    self->TblTester__DOT__dut_io_wi = VL_RAND_RESET_I(3);
    self->TblTester__DOT__dut_io_ri = VL_RAND_RESET_I(3);
    self->TblTester__DOT__dut_io_d = VL_RAND_RESET_I(3);
    self->TblTester__DOT__cnt = VL_RAND_RESET_I(3);
    self->TblTester__DOT___wrap_value_T_1 = VL_RAND_RESET_I(3);
    self->TblTester__DOT___GEN_8 = VL_RAND_RESET_I(3);
    self->TblTester__DOT___GEN_16 = VL_RAND_RESET_I(3);
    self->TblTester__DOT___GEN_24 = VL_RAND_RESET_I(3);
    for (int __Vi0=0; __Vi0<8; ++__Vi0) {
        self->TblTester__DOT__dut__DOT__m[__Vi0] = VL_RAND_RESET_I(3);
    }
