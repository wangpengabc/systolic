...
void VTblTester::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/wangpeng/test/playground_test/test_run_dir/TblTester/2021070521400018057182466412909555/TblTester.v", 79, "",
...
VL_INLINE_OPT void VTblTester::_sequent__TOP__1(VTblTester__Syms* __restrict vlSymsp) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((((0U < (IData)(vlTOPp->TblTester__DOT__cnt)) 
                          & (((7U == (7U & ((IData)(vlTOPp->TblTester__DOT__cnt) 
                                            - (IData)(1U))))
                               ? 9U : (IData)(vlTOPp->TblTester__DOT___GEN_16)) 
                             == ((7U == (IData)(vlTOPp->TblTester__DOT__cnt))
                                  ? 9U : (IData)(vlTOPp->TblTester__DOT___GEN_8)))) 
                         & (~ (((((IData)(vlTOPp->TblTester__DOT__dut_io_ri) 
                                ...
                                == ((7U == (IData)(vlTOPp->TblTester__DOT__cnt))
                                     ? 0U : (IData)(vlTOPp->TblTester__DOT___GEN_24))) 
                               | (IData)(vlTOPp->reset)))))) {
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((((0U < (IData)(vlTOPp->TblTester__DOT__cnt)) 
            ...
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/TblTester/2021070521400018057182466412909555/TblTester.v", 158, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((((0U < (IData)(vlTOPp->TblTester__DOT__cnt)) 
    ...
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY((((0U < (IData)(vlTOPp->TblTester__DOT__cnt)) 
            ...
            VL_WRITEF("[%0t] %%Error: TblTester.v:180: Assertion failed in %NTblTester\n",
                      64,VL_TIME_UNITED_Q(1),-12,vlSymsp->name());
            VL_STOP_MT("/home/wangpeng/test/playground_test/test_run_dir/TblTester/2021070521400018057182466412909555/TblTester.v", 180, "");
        }
    }
    if ((1U & (~ (IData)(vlTOPp->reset)))) {
        if (VL_UNLIKELY(((7U == (IData)(vlTOPp->TblTester__DOT__cnt)) 
                         & (~ (IData)(vlTOPp->reset))))) {
            VL_FINISH_MT("/home/wangpeng/test/playground_test/test_run_dir/TblTester/2021070521400018057182466412909555/TblTester.v", 191, "");
        }
    }
