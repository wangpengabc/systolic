...
void VTblTester::traceChgSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        if (VL_UNLIKELY(vlTOPp->__Vm_traceActivity[1U])) {
            tracep->chgCData(oldp+0,(vlTOPp->TblTester__DOT__dut_io_wi),2);
            tracep->chgCData(oldp+1,(vlTOPp->TblTester__DOT__dut_io_ri),2);
            tracep->chgCData(oldp+2,(vlTOPp->TblTester__DOT__dut_io_d),2);
            ...
            tracep->chgCData(oldp+6,(vlTOPp->TblTester__DOT__dut__DOT__m[0]),2);
            tracep->chgCData(oldp+7,(vlTOPp->TblTester__DOT__dut__DOT__m[1]),2);
            tracep->chgCData(oldp+8,(vlTOPp->TblTester__DOT__dut__DOT__m[2]),2);
            tracep->chgCData(oldp+9,(vlTOPp->TblTester__DOT__dut__DOT__m[3]),2);
            tracep->chgCData(oldp+10,(vlTOPp->TblTester__DOT__dut__DOT__m
                                      [vlTOPp->TblTester__DOT__dut_io_ri]),2);
        }
